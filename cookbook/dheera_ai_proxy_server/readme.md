...
[![PyPI Version](https://img.shields.io/pypi/v/dheera_ai.svg)](https://pypi.org/project/dheera_ai/)
[![PyPI Version](https://img.shields.io/badge/stable%20version-v0.1.345-blue?color=green&link=https://pypi.org/project/dheera_ai/0.1.1/)](https://pypi.org/project/dheera_ai/0.1.1/)
![Downloads](https://img.shields.io/pypi/dm/dheera_ai)
[![dheera_ai](https://img.shields.io/badge/%20%F0%9F%9A%85%20liteLLM-OpenAI%7CAzure%7CAnthropic%7CPalm%7CCohere%7CReplicate%7CHugging%20Face-blue?color=green)](https://github.com/BerriAI/dheera_ai)

[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/template/DYqQAW?referralCode=t3ukrU)

![4BC6491E-86D0-4833-B061-9F54524B2579](https://github.com/BerriAI/dheera_ai/assets/17561003/f5dd237b-db5e-42e1-b1ac-f05683b1d724)
...
- **Logging** - Log Requests, Responses and Errors to `Supabase`, `Posthog`, `Mixpanel`, `Sentry`, `Lunary`,`Athina`, `Helicone` (Any of the supported providers here: https://dheera_ai.readthedocs.io/en/latest/advanced/
...
- `model` (string, required): ID of the model to use for chat completions. See all supported models [here]: (https://dheera_ai.readthedocs.io/en/latest/supported/):
...
- Additional Optional parameters: `temperature`, `functions`, `function_call`, `top_p`, `n`, `stream`. See the full list of supported inputs here: https://dheera_ai.readthedocs.io/en/latest/input/
...
All responses from the server are returned in the following format (for all LLM models). More info on output here: https://dheera_ai.readthedocs.io/en/latest/output/
...
- [Our calendar 👋](https://calendly.com/d/4mp-gd3-k5k/berriai-1-1-onboarding-dheera_ai-hosted-version)
