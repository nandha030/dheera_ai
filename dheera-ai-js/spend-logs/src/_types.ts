export type DheeraAI_IncrementSpend = {
    key_transactions: Array<DheeraAI_IncrementObject>, // [{"key": spend},..]
    user_transactions: Array<DheeraAI_IncrementObject>, 
    team_transactions: Array<DheeraAI_IncrementObject>,
    spend_logs_transactions: Array<DheeraAI_SpendLogs>
}

export type DheeraAI_IncrementObject = {
    key: string,
    spend: number
}

export type DheeraAI_SpendLogs = {
