...
import {DheeraAI_SpendLogs, DheeraAI_IncrementSpend, DheeraAI_IncrementObject} from './_types'

const app = new Hono()
const prisma = new PrismaClient()
// In-memory storage for logs
let spend_logs: DheeraAI_SpendLogs[] = [];
const key_logs: DheeraAI_IncrementObject[] = [];
const user_logs: DheeraAI_IncrementObject[] = [];
const transaction_logs: DheeraAI_IncrementObject[] = [];
...
app.post('/spend/update', async (c) => {
  const incomingLogs = await c.req.json<DheeraAI_SpendLogs[]>();
