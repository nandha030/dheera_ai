...
from dheera_ai_proxy_extras._logging import logger
...
class ProxyExtrasDBManager:
    ...
    def _get_prisma_dir() -> str:
        ...
        Set os.environ["DHEERA_AI_MIGRATION_DIR"] to a custom migrations directory, to support baselining db in read-only fs.
        """
        custom_migrations_dir = os.getenv("DHEERA_AI_MIGRATION_DIR")
    ...
    def _resolve_all_migrations(
        ...
        try:
            ...
            if "Permission denied" in str(e):
                logger.warning(
                    f"Permission denied - {e}\nunable to baseline db. Set DHEERA_AI_MIGRATION_DIR environment variable to a writable directory to enable migrations."
                )
                return
            raise e
    ...
    def setup_database(use_migrate: bool = False) -> bool:
        ...
        Uses migrations from dheera_ai-proxy-extras package
                ...
                if use_migrate:
                    ...
                    try:
                        ...
                        if "P3009" in e.stderr:
                            ...
                            logger.info(
                                "Database schema is not empty, creating baseline migration. In read-only file system, please set an environment variable `DHEERA_AI_MIGRATION_DIR` to a writable directory to enable migrations. Learn more - https://docs.dheera_ai.ai/docs/proxy/prod#read-only-file-system"
                            )
