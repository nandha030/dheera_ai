...
log_level = os.getenv("DHEERA_AI_LOG", "DEBUG")
...
verbose_proxy_logger = logging.getLogger("DheeraAI Proxy")
verbose_router_logger = logging.getLogger("DheeraAI Router")
verbose_logger = logging.getLogger("DheeraAI")
