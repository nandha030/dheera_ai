...
from dheera_ai import get_secret, get_secret_str
from dheera_ai.constants import REDIS_CONNECTION_POOL_TIMEOUT, REDIS_SOCKET_TIMEOUT
...
def _get_redis_client_logic(**env_overrides):
    ...
    # dheera_ai.print_verbose(f"redis_kwargs: {redis_kwargs}")
    return redis_kwargs
