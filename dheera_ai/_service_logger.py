...
class ServiceLogging(CustomLogger):
    """
    Separate class used for monitoring health of dheera_ai-adjacent services (redis/postgres).
    """
    ...
    def __init__(self, mock_testing: bool = False) -> None:
        ...
        if "prometheus_system" in dheera_ai.service_callback:
    ...
    async def async_service_success_hook(
        ...
        for callback in dheera_ai.service_callback:
    ...
    async def async_post_call_failure_hook(
        ...
        """
        Hook to track failed dheera_ai-service calls
        """
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        """
        Hook to track latency for dheera_ai proxy llm api calls
        """
        try:
