"""
DheeraAI A2A - Wrapper for invoking A2A protocol agents.
...
- Adds DheeraAI logging via @client decorator
...
from dheera_ai.a2a_protocol.client import A2AClient
from dheera_ai.a2a_protocol.main import (
    aget_agent_card,
    asend_message,
