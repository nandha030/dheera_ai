...
class A2ACompletionBridgeTransformation:
    ...
    def openai_response_to_a2a_response(
        ...
        """
        Transform a DheeraAI ModelResponse to A2A SendMessageResponse format.
    ...
    def openai_chunk_to_a2a_chunk(
        ...
        """
        Transform a DheeraAI streaming chunk to A2A streaming format.
        ...
        Args:
            chunk: DheeraAI ModelResponse chunk
            request_id: Original A2A request ID
