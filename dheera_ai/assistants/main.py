...
def get_assistants(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        api_base = (
            optional_params.api_base or dheera_ai.api_base or get_secret("AZURE_API_BASE")
        )  # type: ignore
        ...
        raise dheera_ai.exceptions.BadRequestError(
            message="DheeraAI doesn't support {} for 'get_assistants'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
...
def create_assistants(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise dheera_ai.exceptions.BadRequestError(
            message="DheeraAI doesn't support {} for 'create_assistants'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
    ...
    if response is None:
        raise dheera_ai.exceptions.InternalServerError(
...
def delete_assistant(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise dheera_ai.exceptions.BadRequestError(
            message="DheeraAI doesn't support {} for 'delete_assistant'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                ...
                request=httpx.Request(
                    method="delete_assistant", url="https://github.com/BerriAI/dheera_ai"
                ),
            ),
        )
    if response is None:
...
def create_thread(
    ...
    **kwargs,
    ...
    ```
    from dheera_ai import create_thread
    ...
    if custom_llm_provider == "openai":
        ...
        raise dheera_ai.exceptions.BadRequestError(
            message="DheeraAI doesn't support {} for 'create_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def get_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise dheera_ai.exceptions.BadRequestError(
            message="DheeraAI doesn't support {} for 'get_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def get_messages(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise dheera_ai.exceptions.BadRequestError(
            message="DheeraAI doesn't support {} for 'get_messages'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
...
def run_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise dheera_ai.exceptions.BadRequestError(
            message="DheeraAI doesn't support {} for 'run_thread'. Only 'openai' is supported.".format(
                custom_llm_provider
            ),
            model="n/a",
            llm_provider=custom_llm_provider,
