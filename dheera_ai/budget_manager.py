...
class BudgetManager:
    def __init__(
        ...
        self.api_base = api_base or "https://api.dheera_ai.ai"
    ...
    def projected_cost(self, model: str, messages: list, user: str):
        ...
        prompt_tokens = dheera_ai.token_counter(model=model, text=text)
        prompt_cost, _ = dheera_ai.cost_per_token(
    ...
    def update_cost(
        ...
        if model and input_text and output_text:
            ...
            cost = dheera_ai.completion_cost(completion_response=completion_obj)
