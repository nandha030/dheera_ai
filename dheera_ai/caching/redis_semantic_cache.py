"""
Redis Semantic Cache implementation for DheeraAI
...
class RedisSemanticCache(BaseCache):
    ...
    DEFAULT_REDIS_INDEX_NAME: str = "dheera_ai_semantic_cache_index"
    ...
    async def _get_async_embedding(self, prompt: str, **kwargs) -> List[float]:
        ...
        Returns:
            List[float]: The embedding vector
        """
        from dheera_ai.proxy.proxy_server import llm_model_list, llm_router
