...
if TYPE_CHECKING:
    from dheera_ai import CustomStreamWrapper, DheeraAILoggingObj, ModelResponse
...
class ResponsesToCompletionBridgeHandler:
    def __init__(self):
        from .transformation import DheeraAIResponsesTransformationHandler

        super().__init__()
        self.transformation_handler = DheeraAIResponsesTransformationHandler()
    ...
    async def acompletion(
        ...
        from dheera_ai import aresponses
        from dheera_ai.dheera_ai_core_utils.streaming_handler import CustomStreamWrapper
        from dheera_ai.types.llms.openai import ResponsesAPIResponse
