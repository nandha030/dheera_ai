...
from dheera_ai.llms.base_llm.bridges.completion_transformation import (
...
from dheera_ai.types.utils import GenericStreamingChunk, ModelResponseStream

if TYPE_CHECKING:
    from openai.types.responses import ResponseInputImageParam
    from pydantic import BaseModel

    from dheera_ai import DheeraAILoggingObj, ModelResponse
    from dheera_ai.llms.base_llm.base_model_iterator import BaseModelResponseIterator
    from dheera_ai.types.llms.openai import (
...
class DheeraAIResponsesTransformationHandler(CompletionTransformationBridge):
    """
    Handler for transforming /chat/completions api requests to dheera_ai.responses requests
    """
    ...
    def transform_request(
        ...
        # Get stream parameter from dheera_ai_params if not in optional_params
        stream = optional_params.get("stream") or dheera_ai_params.get("stream", False)
        ...
        setattr(dheera_ai_logging_obj, "call_type", CallTypes.responses.value)
    ...
    def _convert_content_to_responses_format(
        ...
        from dheera_ai.types.llms.openai import ChatCompletionImageObject
