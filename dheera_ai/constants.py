...
DEFAULT_HEALTH_CHECK_PROMPT = str(
    os.getenv("DEFAULT_HEALTH_CHECK_PROMPT", "test from dheera_ai")
)
...
DEFAULT_NUM_WORKERS_DHEERA_AI_PROXY = int(
    os.getenv("DEFAULT_NUM_WORKERS_DHEERA_AI_PROXY", 1)
)
...
REDIS_UPDATE_BUFFER_KEY = "dheera_ai_spend_update_buffer"
REDIS_DAILY_SPEND_UPDATE_BUFFER_KEY = "dheera_ai_daily_spend_update_buffer"
REDIS_DAILY_TEAM_SPEND_UPDATE_BUFFER_KEY = "dheera_ai_daily_team_spend_update_buffer"
REDIS_DAILY_ORG_SPEND_UPDATE_BUFFER_KEY = "dheera_ai_daily_org_spend_update_buffer"
REDIS_DAILY_END_USER_SPEND_UPDATE_BUFFER_KEY = "dheera_ai_daily_end_user_spend_update_buffer"
REDIS_DAILY_AGENT_SPEND_UPDATE_BUFFER_KEY = "dheera_ai_daily_agent_spend_update_buffer"
REDIS_DAILY_TAG_SPEND_UPDATE_BUFFER_KEY = "dheera_ai_daily_tag_spend_update_buffer"
...
X_DHEERA_AI_DISABLE_CALLBACKS = "x-dheera_ai-disable-callbacks"
DHEERA_AI_METADATA_FIELD = "dheera_ai_metadata"
OLD_DHEERA_AI_METADATA_FIELD = "metadata"
DHEERA_AI_TRUNCATED_PAYLOAD_FIELD = "dheera_ai_truncated"

########################### DheeraAI Proxy Specific Constants ###########################
########################################################################################
...
)  # by default all dheera_ai proxy keys have a soft budget of 50.0
# makes it clear this is a rate limit error for a dheera_ai virtual key
RATE_LIMIT_ERROR_MESSAGE_FOR_VIRTUAL_KEY = "DheeraAI Virtual Key user_api_key_hash"
...
LITTELM_INTERNAL_HEALTH_SERVICE_ACCOUNT_NAME = "dheera_ai-internal-health-check"
LITTELM_CLI_SERVICE_ACCOUNT_NAME = "dheera_ai-cli"
DHEERA_AI_INTERNAL_JOBS_SERVICE_ACCOUNT_NAME = "dheera_ai_internal_jobs"

# Key Rotation Constants
DHEERA_AI_KEY_ROTATION_ENABLED = os.getenv("DHEERA_AI_KEY_ROTATION_ENABLED", "false")
DHEERA_AI_KEY_ROTATION_CHECK_INTERVAL_SECONDS = int(
    os.getenv("DHEERA_AI_KEY_ROTATION_CHECK_INTERVAL_SECONDS", 86400)
)  # 24 hours default
UI_SESSION_TOKEN_TEAM_ID = "dheera_ai-dashboard"
DHEERA_AI_PROXY_ADMIN_NAME = "default_user_id"

########################### CLI SSO AUTHENTICATION CONSTANTS ###########################
DHEERA_AI_CLI_SOURCE_IDENTIFIER = "dheera_ai-cli"
DHEERA_AI_CLI_SESSION_TOKEN_PREFIX = "dheera_ai-session-token"
...
LENGTH_OF_DHEERA_AI_GENERATED_KEY = int(os.getenv("LENGTH_OF_DHEERA_AI_GENERATED_KEY", 16))
...
SPECIAL_DHEERA_AI_AUTH_TOKEN = ["ui-token"]
