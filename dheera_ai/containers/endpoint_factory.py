...
from dheera_ai.llms.custom_httpx.container_handler import generic_container_handler
...
def create_sync_endpoint_function(endpoint_config: Dict) -> Callable:
    ...
    def endpoint_func(
        ...
        **kwargs,
        ...
        local_vars = locals()
        try:
            dheera_ai_logging_obj: DheeraAILoggingObj = kwargs.pop("dheera_ai_logging_obj")
