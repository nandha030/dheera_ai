"""
Utils used for dheera_ai.transcription() and dheera_ai.atranscription()
"""
...
from dheera_ai.types.files import get_file_mime_type_from_extension
...
def process_audio_file(audio_file: FileTypes) -> ProcessedAudioFile:
    ...
    # Determine content type using DheeraAI's file type utilities
