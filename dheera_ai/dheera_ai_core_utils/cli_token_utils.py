...
def get_dheera_ai_gateway_api_key() -> Optional[str]:
    """
    Get the stored CLI API key for use with DheeraAI SDK.
    
    This function reads the token file created by `dheera_ai-proxy login`
