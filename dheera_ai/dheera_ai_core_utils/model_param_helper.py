...
from dheera_ai.types.rerank import RerankRequest
...
class ModelParamHelper:
    ...
    def _get_all_llm_api_params() -> Set[str]:
        ...
        chat_completion_kwargs = (
            ModelParamHelper._get_dheera_ai_supported_chat_completion_kwargs()
        )
        text_completion_kwargs = (
            ModelParamHelper._get_dheera_ai_supported_text_completion_kwargs()
        )
        embedding_kwargs = ModelParamHelper._get_dheera_ai_supported_embedding_kwargs()
        transcription_kwargs = (
            ModelParamHelper._get_dheera_ai_supported_transcription_kwargs()
        )
        rerank_kwargs = ModelParamHelper._get_dheera_ai_supported_rerank_kwargs()
    ...
    @staticmethod
    def get_dheera_ai_provider_specific_params_for_chat_params() -> Set[str]:
        return set(["thinking"])

    @staticmethod
    def _get_dheera_ai_supported_chat_completion_kwargs() -> Set[str]:
        """
        Get the dheera_ai supported chat completion kwargs
        ...
        dheera_ai_provider_specific_params: Set[str] = (
            ModelParamHelper.get_dheera_ai_provider_specific_params_for_chat_params()
        )
        all_chat_completion_kwargs: Set[str] = non_streaming_params.union(
            streaming_params
        ).union(dheera_ai_provider_specific_params)
        return all_chat_completion_kwargs

    @staticmethod
    def _get_dheera_ai_supported_text_completion_kwargs() -> Set[str]:
        """
        Get the dheera_ai supported text completion kwargs
    ...
    @staticmethod
    def _get_dheera_ai_supported_rerank_kwargs() -> Set[str]:
        """
        Get the dheera_ai supported rerank kwargs
        """
        return set(RerankRequest.model_fields.keys())

    @staticmethod
    def _get_dheera_ai_supported_embedding_kwargs() -> Set[str]:
        """
        Get the dheera_ai supported embedding kwargs
    ...
    @staticmethod
    def _get_dheera_ai_supported_transcription_kwargs() -> Set[str]:
        """
        Get the dheera_ai supported transcription kwargs
