...
from dheera_ai.router_utils.batch_utils import InMemoryFile
...
if TYPE_CHECKING:
    from dheera_ai.dheera_ai_core_utils.dheera_ai_logging import Logging as LoggingClass
...
def handle_any_messages_to_chat_completion_str_messages_conversion(
    ...
    Relevant Issue: https://github.com/BerriAI/dheera_ai/issues/9494
    """
    import json
...
def get_format_from_file_id(file_id: Optional[str]) -> Optional[str]:
    ...
    unified_file_id = dheera_ai_proxy:{};unified_id,{}
...
def infer_content_type_from_url_and_content(
    ...
    Example:
        ...
        "image/png"
    """
    from dheera_ai.dheera_ai_core_utils.token_counter import get_image_type
