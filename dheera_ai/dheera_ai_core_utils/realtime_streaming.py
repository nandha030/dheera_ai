...
from dheera_ai.types.realtime import ALL_DELTA_TYPES

from .dheera_ai_logging import Logging as DheeraAILogging
...
class RealTimeStreaming:
    def __init__(
        ...
        _logged_real_time_event_types = dheera_ai.logged_real_time_event_types
