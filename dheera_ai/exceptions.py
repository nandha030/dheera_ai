...
## DheeraAI versions of the OpenAI Exception Types
...
class AuthenticationError(openai.AuthenticationError):  # type: ignore
    def __init__(
        ...
        dheera_ai_debug_info: Optional[str] = None,
        max_retries: Optional[int] = None,
        num_retries: Optional[int] = None,
    ):
        self.status_code = 401
        self.message = "dheera_ai.AuthenticationError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
        self.num_retries = num_retries
        self.response = response or httpx.Response(
            status_code=self.status_code,
            request=httpx.Request(
                method="GET", url="https://dheera_ai.ai"
            ),  # mock request object
        )
        super().__init__(
    ...
    def __str__(self):
        ...
        if self.num_retries:
            _message += f" DheeraAI Retried: {self.num_retries} times"
        if self.max_retries:
            _message += f", DheeraAI Max Retries: {self.max_retries}"
        return _message
...
class NotFoundError(openai.NotFoundError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.NotFoundError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class BadRequestError(openai.BadRequestError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.BadRequestError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.dheera_ai_debug_info = dheera_ai_debug_info
...
class ImageFetchError(BadRequestError):
    def __init__(
        ...
        super().__init__(
            ...
            response=response,
            dheera_ai_debug_info=dheera_ai_debug_info,
...
class UnprocessableEntityError(openai.UnprocessableEntityError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.UnprocessableEntityError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class Timeout(openai.APITimeoutError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.Timeout: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class PermissionDeniedError(openai.PermissionDeniedError):  # type:ignore
    def __init__(
        ...
        self.message = "dheera_ai.PermissionDeniedError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class RateLimitError(openai.RateLimitError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.RateLimitError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class ContextWindowExceededError(BadRequestError):  # type: ignore
    def __init__(
        ...
        super().__init__(
            ...
            dheera_ai_debug_info=self.dheera_ai_debug_info,
        )  # Call the base class constructor with the parameters it needs

        # set after, to make it clear the raised error is a context window exceeded error
        self.message = "dheera_ai.ContextWindowExceededError: {}".format(self.message)
...
class RejectedRequestError(BadRequestError):  # type: ignore
    def __init__(
        ...
        self.status_code = 400
        self.message = "dheera_ai.RejectedRequestError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.dheera_ai_debug_info = dheera_ai_debug_info
...
class ContentPolicyViolationError(BadRequestError):  # type: ignore
    ...
    def __init__(
        ...
        self.status_code = 400
        self.message = "dheera_ai.ContentPolicyViolationError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.dheera_ai_debug_info = dheera_ai_debug_info
        request = httpx.Request(method="POST", url="https://api.openai.com/v1")
...
class ServiceUnavailableError(openai.APIStatusError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.ServiceUnavailableError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class BadGatewayError(openai.APIStatusError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.BadGatewayError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class InternalServerError(openai.InternalServerError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.InternalServerError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class APIError(openai.APIError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.APIError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class APIConnectionError(openai.APIConnectionError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.APIConnectionError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.status_code = 500
        self.dheera_ai_debug_info = dheera_ai_debug_info
...
class APIResponseValidationError(openai.APIResponseValidationError):  # type: ignore
    def __init__(
        ...
        self.message = "dheera_ai.APIResponseValidationError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        request = httpx.Request(method="POST", url="https://api.openai.com/v1")
...
class JSONSchemaValidationError(APIResponseValidationError):
    def __init__(
        ...
        self.schema = schema
        self.model = model
        message = "dheera_ai.JSONSchemaValidationError: model={}, returned an invalid response={}, for schema={}.\nAccess raw response with `e.raw_response`".format(
...
class UnsupportedParamsError(BadRequestError):
    def __init__(
        ...
        self.status_code = 400
        self.message = "dheera_ai.UnsupportedParamsError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.dheera_ai_debug_info = dheera_ai_debug_info
...
class MockException(openai.APIError):
    ...
    def __init__(
        ...
        self.status_code = status_code
        self.message = "dheera_ai.MockException: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.dheera_ai_debug_info = dheera_ai_debug_info
        self.max_retries = max_retries
...
class DheeraAIUnknownProvider(BadRequestError):
    def __init__(self, model: str, custom_llm_provider: Optional[str] = None):
        self.message = DheeraAICommonStrings.llm_provider_not_provided.value.format(
...
class MidStreamFallbackError(ServiceUnavailableError):  # type: ignore
    def __init__(
        ...
        self.message = f"dheera_ai.MidStreamFallbackError: {message}"
        self.model = model
        self.llm_provider = llm_provider
