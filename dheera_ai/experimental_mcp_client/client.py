"""
DheeraAI Proxy uses this MCP Client to connnect to other MCP servers.
"""
...
from dheera_ai.llms.custom_httpx.http_handler import get_ssl_configuration
from dheera_ai.types.llms.custom_http import VerifyTypes
...
class MCPClient:
        ...
        try:
            if self.transport_type == MCPTransport.stdio:
                ...
                verbose_logger.debug(
                    "dheera_ai headers for streamablehttp_client: %s", headers
                )
    ...
    def _create_httpx_client_factory(self) -> Callable[..., httpx.AsyncClient]:
        """
        Create a custom httpx client factory that uses DheeraAI's SSL configuration.
        ...
        def factory(
            *,
            ...
            """Create an httpx.AsyncClient with DheeraAI's SSL configuration."""
