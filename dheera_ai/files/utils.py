...
from dheera_ai.types.llms.openai import CreateFileRequest
from dheera_ai.types.utils import ExtractedFileData


class FilesAPIUtils:
    """
    Utils for files API interface on dheera_ai
    """
    @staticmethod
