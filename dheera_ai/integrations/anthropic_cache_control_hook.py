...
Users can define
- `cache_control_injection_points` in the completion params and dheera_ai will inject the cache control directives into the messages at the specified injection points.
...
from dheera_ai.types.integrations.anthropic_cache_control_hook import (
    CacheControlInjectionPoint,
    CacheControlMessageInjectionPoint,
)
from dheera_ai.types.llms.openai import AllMessageValues, ChatCompletionCachedContent
