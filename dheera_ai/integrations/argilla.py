...
from dheera_ai.types.integrations.argilla import (
...
class ArgillaLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        if dheera_ai.argilla_transformation_object is None:
            raise Exception(
                "'dheera_ai.argilla_transformation_object' is required, to log your payload to Argilla."
            )
        self.validate_argilla_transformation_object(
            dheera_ai.argilla_transformation_object
        )
        self.argilla_transformation_object = dheera_ai.argilla_transformation_object
        ...
        _batch_size = (
            os.getenv("ARGILLA_BATCH_SIZE", None) or dheera_ai.argilla_batch_size
        )
        if _batch_size:
