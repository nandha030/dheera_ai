...
This integration enables using prompt versions from Arize Phoenix with Dheera AI's completion function.
...
```python
from dheera_ai.integrations.arize.arize_phoenix_prompt_manager import ArizePhoenixPromptManager
...
- Dheera AI Issues: https://github.com/BerriAI/dheera_ai/issues
