...
from dheera_ai.integrations.arize._utils import ArizeOTELAttributes
from dheera_ai.types.integrations.arize_phoenix import ArizePhoenixConfig
...
if TYPE_CHECKING:
    ...
    from dheera_ai.integrations.opentelemetry import OpenTelemetryConfig as _OpenTelemetryConfig
...
class ArizePhoenixLogger(OpenTelemetry):
    ...
    def get_arize_phoenix_config() -> ArizePhoenixConfig:
        ...
        project_name = os.environ.get("PHOENIX_PROJECT_NAME", "dheera_ai-project")
