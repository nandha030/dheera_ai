# Dheera AI BitBucket Prompt Management

A powerful prompt management system for Dheera AI that fetches `.prompt` files from BitBucket repositories. This enables team-based prompt management with BitBucket's built-in access control and version control capabilities.
...
### 4. Use with Dheera AI

```python
# Use with completion - the model prefix 'bitbucket/' tells Dheera AI to use BitBucket prompt management
