...
This module provides a base class for implementing custom secret managers in DheeraAI.
...
Usage:
    ...
    dheera_ai.secret_manager_client = MySecretManager()
...
from dheera_ai.secret_managers.base_secret_manager import BaseSecretManager
...
class CustomSecretManager(BaseSecretManager):
    ...
    integrations in DheeraAI. Users can extend this class to integrate their own secret
    management systems.
