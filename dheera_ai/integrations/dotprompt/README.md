...
- **🔗 Dheera AI integration**: Works seamlessly with `dheera_ai.completion()`
...
dheera_ai.set_global_prompt_directory("path/to/your/prompts")

# Use with completion - the model prefix 'dotprompt/' tells Dheera AI to use prompt management
...
Dheera AI integration class extending `PromptManagementBase`.
...
from dheera_ai.integrations.dotprompt import get_dotprompt_manager
...
The Dheera AI Dotprompt manager follows the [Dotprompt specification](https://google.github.io/dotprompt/) for maximum compatibility. When contributing:
...
This prompt management system is part of Dheera AI and follows the same license terms.