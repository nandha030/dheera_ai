...
def set_global_prompt_directory(directory: str) -> None:
    ...
    dheera_ai.global_prompt_directory = directory  # type: ignore
...
def prompt_initializer(
    ...
    """
    prompt_directory = getattr(dheera_ai_params, "prompt_directory", None)
    prompt_data = getattr(dheera_ai_params, "prompt_data", None)
    ...
    prompt_file = getattr(dheera_ai_params, "prompt_file", None)
    
    # Handle dotprompt_content from database
    dotprompt_content = getattr(dheera_ai_params, "dotprompt_content", None)
