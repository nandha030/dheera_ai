"""
Dotprompt manager that integrates with DheeraAI's prompt management system.
...
from dheera_ai.integrations.prompt_management_base import PromptManagementClient
...
class DotpromptManager(CustomPromptManagement):
    ...
    This class enables using .prompt files with the dheera_ai completion() function
    by implementing the PromptManagementBase interface.

    Usage:
        # Set global prompt directory
        dheera_ai.prompt_directory = "path/to/prompts"
    ...
    def __init__(
        ...
        self.prompt_directory = prompt_directory or dheera_ai.global_prompt_directory
        ...
        if self._prompt_manager is None:
            if (
                ...
                raise ValueError(
                    ...
                    "Set dheera_ai.global_prompt_directory, initialize with prompt_directory parameter, or provide prompt_data."
                )
    ...
    def get_chat_completion_prompt(
        ...
        from dheera_ai.integrations.prompt_management_base import PromptManagementBase
