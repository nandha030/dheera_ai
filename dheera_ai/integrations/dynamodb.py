...
class DyanmoDBLogger:
    ...
    def __init__(self):
        ...
        if dheera_ai.dynamodb_table_name is None:
            raise ValueError(
                "DheeraAI Error, trying to use DynamoDB but not table name passed. Create a table and set `dheera_ai.dynamodb_table_name=<your-table>`"
            )
        self.table_name = dheera_ai.dynamodb_table_name
