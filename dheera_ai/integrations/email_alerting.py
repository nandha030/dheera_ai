...
DHEERA_AI_LOGO_URL = "https://dheera_ai-listing.s3.amazonaws.com/dheera_ai_logo.png"
DHEERA_AI_SUPPORT_CONTACT = "support@berri.ai"
...
async def send_team_budget_alert(webhook_event: WebhookEvent) -> bool:
    ...
    <img src="{email_logo_url}" alt="DheeraAI Logo" width="150" height="50" /> <br/><br/><br/>
    ...
    email_event = {
        ...
        "subject": f"DheeraAI {event_name} for Team {team_alias}",
