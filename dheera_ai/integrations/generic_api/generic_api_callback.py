...
class GenericAPILogger(CustomBatchLogger):
    ...
    def _get_headers(self, headers: Optional[dict] = None):
        ...
        # 2. Update with dheera_ai generic headers if available
        if dheera_ai.generic_logger_headers:
            headers_dict.update(dheera_ai.generic_logger_headers)
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if dheera_ai.generic_api_use_v1 is True:
