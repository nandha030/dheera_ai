# Dheera AI gitlab Prompt Management

A powerful prompt management system for Dheera AI that fetches `.prompt` files from gitlab repositories. This enables team-based prompt management with gitlab's built-in access control and version control capabilities.
...
```python
# Use with completion - the model prefix 'gitlab/' tells Dheera AI to use gitlab prompt management
