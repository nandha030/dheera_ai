...
class HeliconeLogger:
    ...
    def add_metadata_from_header(dheera_ai_params: dict, metadata: dict) -> dict:
        ...
        if "dheera_ai_parent_otel_span" in metadata:
            metadata.pop("dheera_ai_parent_otel_span")
    ...
    def log_success(
        ...
        try:
            ...
            kwargs.get("dheera_ai_call_id", None)
            ...
            if isinstance(response_obj, dheera_ai.EmbeddingResponse) or isinstance(
            ...
            response = dheera_ai.module_level_client.post(url, headers=headers, json=data)
