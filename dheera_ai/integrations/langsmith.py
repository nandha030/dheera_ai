...
from dheera_ai.types.integrations.langsmith import *
from dheera_ai.types.utils import StandardCallbackDynamicParams, StandardLoggingPayload
...
class LangsmithLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        _batch_size = (
            os.getenv("LANGSMITH_BATCH_SIZE", None) or dheera_ai.langsmith_batch_size
        )
    ...
    def get_credentials_from_env(
        ...
        _credentials_project = (
            langsmith_project or os.getenv("LANGSMITH_PROJECT") or "dheera_ai-completion"
        )
    ...
    def _prepare_log_data(
        ...
        try:
            _dheera_ai_params = kwargs.get("dheera_ai_params", {}) or {}
            metadata = _dheera_ai_params.get("metadata", {}) or {}
            ...
            data = {
                "name": run_name,
                "run_type": "llm",  # this should always be llm, since dheera_ai always logs llm calls. Langsmith allow us to log "chain"
                "inputs": payload,
