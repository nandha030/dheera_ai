# What is this?
## On Success events log cost to OpenMeter - https://github.com/BerriAI/dheera_ai/issues/1268
...
class OpenMeterLogger(CustomLogger):
    ...
    def _common_logic(self, kwargs: dict, response_obj):
        call_id = response_obj.get("id", kwargs.get("dheera_ai_call_id"))
        ...
        return {
            "specversion": "1.0",
            "type": os.getenv("OPENMETER_EVENT_TYPE", "dheera_ai_tokens"),
            "id": call_id,
            "time": dt,
            "subject": subject,
            "source": "dheera_ai-proxy",
