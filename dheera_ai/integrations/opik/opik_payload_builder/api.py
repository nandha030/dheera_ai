...
from dheera_ai.integrations.opik import utils
...
def build_opik_payload(
    ...
    """
    Build Opik trace and span payloads from DheeraAI completion data.

    This is the main public API for creating Opik payloads. It:
    1. Extracts all necessary data from DheeraAI kwargs and response
    ...
    Args:
        kwargs: DheeraAI kwargs containing request metadata and logging data
        response_obj: DheeraAI response object containing model response
    ...
    proxy_request = dheera_ai_params.get("proxy_server_request", {}) or {}
