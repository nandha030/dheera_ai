...
from dheera_ai.types.integrations.posthog import (
...
class PostHogLogger(CustomBatchLogger):
    ...
    def _add_custom_metadata_properties(self, properties: Dict[str, Any], kwargs: Dict[str, Any]):
        ...
        dheera_ai_internal_fields = {
            ...
            "user_api_key", "user_api_end_user_max_budget", "dheera_ai_api_version",
            ...
            "user_api_key_metadata", "headers", "dheera_ai_parent_otel_span", "requester_ip_address",
        ...
        for key, value in metadata.items():
            if key not in dheera_ai_internal_fields:
    ...
    def _extract_metadata(self, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return dheera_ai_params.get("metadata", {}) or {}
