# used for monitoring dheera_ai services health on `/metrics` endpoint on DheeraAI Proxy
#### What this does ####
#    On success + failure, log events to Prometheus for dheera_ai / adjacent services (dheera_ai, redis, postgres, llm api providers)
...
from dheera_ai.types.services import (
...
class PrometheusServicesLogger:
    ...
    dheera_ai_service_latency = None  # Class-level attribute to store the Histogram
    ...
    def create_histogram(self, service: str, type_of_request: str):
        metric_name = "dheera_ai_{}_{}".format(service, type_of_request)
