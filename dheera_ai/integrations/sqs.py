...
from dheera_ai.types.integrations.base_health_check import IntegrationHealthCheckStatus
...
class SQSLogger(CustomBatchLogger, BaseAWSLLM):
    ...
    def __init__(
        ...
        try:
            verbose_logger.debug(
                f"in init sqs logger - sqs_callback_params {dheera_ai.aws_sqs_callback_params}"
            )
    ...
    def _init_sqs_params(
        ...
        dheera_ai.aws_sqs_callback_params = dheera_ai.aws_sqs_callback_params or {}

        # read in .env variables - example os.environ/AWS_BUCKET_NAME
        for key, value in dheera_ai.aws_sqs_callback_params.items():
            if isinstance(value, str) and value.startswith("os.environ/"):
                dheera_ai.aws_sqs_callback_params[key] = dheera_ai.get_secret(value)

        self.sqs_queue_url = (
                dheera_ai.aws_sqs_callback_params.get("sqs_queue_url") or sqs_queue_url
        )
        self.sqs_region_name = (
                dheera_ai.aws_sqs_callback_params.get("sqs_region_name") or sqs_region_name
        )
        self.sqs_api_version = (
                dheera_ai.aws_sqs_callback_params.get("sqs_api_version") or sqs_api_version
        )
        self.sqs_use_ssl = (
                dheera_ai.aws_sqs_callback_params.get("sqs_use_ssl", True) or sqs_use_ssl
        )
        self.sqs_verify = dheera_ai.aws_sqs_callback_params.get("sqs_verify") or sqs_verify
        self.sqs_endpoint_url = (
                dheera_ai.aws_sqs_callback_params.get("sqs_endpoint_url") or sqs_endpoint_url
        )
        self.sqs_aws_access_key_id = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_access_key_id")
                or sqs_aws_access_key_id
        )

        self.sqs_aws_secret_access_key = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_secret_access_key")
                or sqs_aws_secret_access_key
        )

        self.sqs_aws_session_token = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_session_token")
                or sqs_aws_session_token
        )

        self.sqs_aws_session_name = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_session_name") or sqs_aws_session_name
        )

        self.sqs_aws_profile_name = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_profile_name") or sqs_aws_profile_name
        )

        self.sqs_aws_role_name = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_role_name") or sqs_aws_role_name
        )

        self.sqs_aws_web_identity_token = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_web_identity_token")
                or sqs_aws_web_identity_token
        )

        self.sqs_aws_sts_endpoint = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_sts_endpoint") or sqs_aws_sts_endpoint
        )
        self.sqs_strip_base64_files = (
                dheera_ai.aws_sqs_callback_params.get("sqs_strip_base64_files", False)
                or sqs_strip_base64_files
        )

        self.sqs_aws_use_application_level_encryption = (
                dheera_ai.aws_sqs_callback_params.get("sqs_aws_use_application_level_encryption", False)
                or sqs_aws_use_application_level_encryption
        )
        self.sqs_app_encryption_key_b64 = (
                dheera_ai.aws_sqs_callback_params.get("sqs_app_encryption_key_b64")
                or sqs_app_encryption_key_b64
        )
        self.sqs_app_encryption_aad = (
                dheera_ai.aws_sqs_callback_params.get("sqs_app_encryption_aad")
        ...
        self.sqs_config = dheera_ai.aws_sqs_callback_params.get("sqs_config") or sqs_config
