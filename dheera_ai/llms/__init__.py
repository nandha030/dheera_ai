...
if TYPE_CHECKING:
    from dheera_ai.llms.base_llm.guardrail_translation.base_translation import (
        BaseTranslation,
    )
    ...
    try:
        ...
        for root, dirs, files in os.walk(llms_dir):
            ...
            if (
                ...
                # Build the module path relative to dheera_ai
                rel_path = os.path.relpath(root, os.path.dirname(llms_dir))
                module_path = "dheera_ai." + rel_path.replace(os.sep, ".")
