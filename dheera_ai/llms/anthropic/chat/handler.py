...
def make_sync_call(
    ...
    if client is None:
        client = dheera_ai.module_level_client  # re-use a module level client
...
class ModelResponseIterator:
    ...
    def _handle_accumulated_json_chunk(
        ...
        across TCP packets. See: https://github.com/BerriAI/dheera_ai/issues/17473
