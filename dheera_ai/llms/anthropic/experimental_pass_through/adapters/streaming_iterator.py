...
from dheera_ai.types.llms.anthropic import UsageDelta
    ...
    def __next__(self):
        ...
        try:
            ...
            for chunk in self.completion_stream:
                ...
                processed_chunk = DheeraAIAnthropicMessagesAdapter().translate_streaming_openai_response_to_anthropic(
                    response=chunk,
