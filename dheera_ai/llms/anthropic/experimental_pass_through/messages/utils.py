...
from dheera_ai.types.llms.anthropic import AnthropicMessagesRequestOptionalParams
...
def mock_response(
    ...
    **kwargs,
    ...
    if mock_response == "dheera_ai.InternalServerError":
        raise InternalServerError(
            message="this is a mock internal server error",
            llm_provider="anthropic",
            model=model,
        )
    elif mock_response == "dheera_ai.ContextWindowExceededError":
        raise ContextWindowExceededError(
            message="this is a mock context window exceeded error",
            llm_provider="anthropic",
            model=model,
        )
    elif mock_response == "dheera_ai.RateLimitError":
