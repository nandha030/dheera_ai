...
from dheera_ai.llms.base_llm.skills.transformation import (
    BaseSkillsAPIConfig,
    DheeraAILoggingObj,
)
...
class AnthropicSkillsConfig(BaseSkillsAPIConfig):
    ...
    def validate_environment(
        ...
        from dheera_ai.constants import ANTHROPIC_SKILLS_API_BETA_VERSION
    ...
    def transform_list_skills_request(
        ...
        api_base = AnthropicModelInfo.get_api_base(
            dheera_ai_params.api_base if dheera_ai_params else None
        )
