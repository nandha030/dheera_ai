...
import dheera_ai
from dheera_ai.exceptions import UnsupportedParamsError
from dheera_ai.llms.openai.chat.gpt_5_transformation import OpenAIGPT5Config
            ...
            if dheera_ai.drop_params is True or (
                ...
                raise UnsupportedParamsError(
                    ...
                    message=(
                        ...
                        "To drop this parameter, set `dheera_ai.drop_params=True` or for proxy:\n\n"
                        "`dheera_ai_settings:\n drop_params: true`\n"
                        "Issue: https://github.com/BerriAI/dheera_ai/issues/16704"
                    ),
                )
