...
class AzureImageEditConfig(OpenAIImageEditConfig):
    ...
    def get_complete_url(
        ...
        - api_base: Base URL, e.g.,
            ...
            OR
            "https://dheera_ai8397336933.openai.azure.com/openai/deployments/<deployment_name>/images/edits?api-version=2024-05-01-preview"
        - model: Model name (deployment name).
        - dheera_ai_params: Additional query parameters, including "api_version".
