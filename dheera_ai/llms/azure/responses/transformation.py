...
class AzureOpenAIResponsesAPIConfig(OpenAIResponsesAPIConfig):
    ...
    def validate_environment(
        self, headers: dict, model: str, dheera_ai_params: Optional[GenericDheeraAIParams]
    ) -> dict:
        return BaseAzureLLM._base_validate_azure_environment(
            headers=headers, dheera_ai_params=dheera_ai_params
        )
    ...
    def _handle_reasoning_item(self, item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Issue: https://github.com/BerriAI/dheera_ai/issues/13484
    ...
    def get_complete_url(
        ...
        - api_base: Base URL, e.g.,
            "https://dheera_ai8397336933.openai.azure.com"
            OR
            "https://dheera_ai8397336933.openai.azure.com/openai/responses?api-version=2024-05-01-preview"
        - model: Model name.
    ...
    def transform_cancel_response_api_response(
        ...
        try:
            ...
            from dheera_ai.llms.azure.chat.gpt_transformation import AzureOpenAIError
