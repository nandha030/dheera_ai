...
class AzureAIAgentsConfig(BaseConfig):
    ...
    def transform_response(
        ...
        """
        Transform the Azure Agents response to DheeraAI ModelResponse format.
        """
    ...
    def completion(
        ...
        See: https://learn.microsoft.com/en-us/azure/ai-foundry/agents/quickstart
        """
        from dheera_ai.llms.azure.common_utils import get_azure_ad_token
        from dheera_ai.llms.azure_ai.agents.handler import azure_ai_agents_handler
        ...
        if api_key is None:
            ...
            # Create a GenericDheeraAIParams with the scope override for Azure Foundry Agents
            azure_auth_params = dict(dheera_ai_params) if dheera_ai_params else {}
            azure_auth_params["azure_scope"] = "https://ai.azure.com/.default"
            api_key = get_azure_ad_token(GenericDheeraAIParams(**azure_auth_params))
