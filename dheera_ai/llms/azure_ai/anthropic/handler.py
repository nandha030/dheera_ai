    ...
    def completion(
        ...
        if acompletion is True:
            ...
            if (
                ...
                from dheera_ai.llms.anthropic.chat.handler import make_sync_call
                ...
                from dheera_ai.llms.anthropic.common_utils import (
                ...
                try:
                    ...
                    from dheera_ai.llms.anthropic.common_utils import AnthropicError
