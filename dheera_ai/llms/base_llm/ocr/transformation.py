...
class OCRPageDimensions(DheeraAIPydanticObjectBase):
...
class OCRPageImage(DheeraAIPydanticObjectBase):
...
class OCRPage(DheeraAIPydanticObjectBase):
...
class OCRUsageInfo(DheeraAIPydanticObjectBase):
...
class OCRResponse(DheeraAIPydanticObjectBase):
    """
...
class OCRRequestData(DheeraAIPydanticObjectBase):
