...
class BaseAWSLLM:
        ...
        if (
            ...
            if (
                ...
                if aws_session_name is None:
                    aws_session_name = (
                        f"dheera_ai-session-{int(datetime.now().timestamp())}"
                    )
    ...
    def _get_aws_region_name(
        ...
        if aws_region_name is None:
            ...
            if (
                ...
                and dheera_ai_aws_region_name is not None
                and isinstance(dheera_ai_aws_region_name, str)
            ):
    ...
    def _auth_with_web_identity_token(
        ...
        assume_role_params = {
            ...
            "Policy": '{"Version":"2012-10-17","Statement":[{"Sid":"BedrockDheeraAI","Effect":"Allow","Action":["bedrock:InvokeModel","bedrock:InvokeModelWithResponseStream"],"Resource":"*","Condition":{"Bool":{"aws:SecureTransport":"true"},"StringLike":{"aws:UserAgent":"dheera_ai/*"}}}]}',
        }
