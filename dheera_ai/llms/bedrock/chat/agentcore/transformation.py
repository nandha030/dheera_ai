...
from dheera_ai.llms.bedrock.chat.agentcore.sse_iterator import AgentCoreSSEStreamIterator
from dheera_ai.llms.bedrock.common_utils import BedrockError
from dheera_ai.types.llms.bedrock_agentcore import (
    AgentCoreMessage,
...
class AmazonAgentCoreConfig(BaseConfig, BaseAWSLLM):
    ...
    def _get_runtime_session_id(self, optional_params: dict) -> str:
        ...
        generated_id = f"dheera_ai-session-{str(uuid.uuid4())}"
    ...
    def transform_response(
        ...
        """
        Transform the AgentCore response to DheeraAI ModelResponse format.
