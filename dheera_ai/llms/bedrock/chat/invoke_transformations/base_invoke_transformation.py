...
from dheera_ai.llms.base_llm.chat.transformation import BaseConfig, BaseLLMException
from dheera_ai.llms.bedrock.chat.invoke_handler import make_call, make_sync_call
...
from dheera_ai.types.utils import ModelResponse, Usage
...
class AmazonInvokeConfig(BaseConfig, BaseAWSLLM):
    ...
    def transform_request(
        ...
        custom_prompt_dict: dict = dheera_ai_params.pop("custom_prompt_dict", None) or {}
        hf_model_name = dheera_ai_params.get("hf_model_name", None)
        ...
        if provider == "cohere":
            ...
            transformed_request = (
                dheera_ai.AmazonAnthropicClaudeConfig().transform_request(
                    model=model,
                    messages=messages,
                    optional_params=optional_params,
            ...
            return dheera_ai.AmazonInvokeNovaConfig().transform_request(
                model=model,
                messages=messages,
                optional_params=optional_params,
                dheera_ai_params=dheera_ai_params,
            ...
            return dheera_ai.AmazonTwelveLabsPegasusConfig().transform_request(
                model=model,
                messages=messages,
                optional_params=optional_params,
                dheera_ai_params=dheera_ai_params,
            ...
            return dheera_ai.AmazonBedrockOpenAIConfig().transform_request(
                model=model,
                messages=messages,
                optional_params=optional_params,
                dheera_ai_params=dheera_ai_params,
    ...
    def transform_response(  # noqa: PLR0915
        ...
        try:
            if provider == "cohere":
                ...
                return dheera_ai.AmazonAnthropicClaudeConfig().transform_response(
                    model=model,
                ...
                return dheera_ai.AmazonInvokeNovaConfig().transform_response(
                    model=model,
                    raw_response=raw_response,
                    model_response=model_response,
                    logging_obj=logging_obj,
                ...
                return dheera_ai.AmazonTwelveLabsPegasusConfig().transform_response(
                    model=model,
                    raw_response=raw_response,
                    model_response=model_response,
                    logging_obj=logging_obj,
                ...
                outputText = dheera_ai.AmazonMistralConfig.get_outputText(
    ...
    def get_bedrock_invoke_provider(
        ...
        if _split_model in get_args(dheera_ai.BEDROCK_INVOKE_PROVIDERS_LITERAL):
            return cast(dheera_ai.BEDROCK_INVOKE_PROVIDERS_LITERAL, _split_model)
        ...
        for provider in get_args(dheera_ai.BEDROCK_INVOKE_PROVIDERS_LITERAL):
