...
Simplified handler leveraging existing DheeraAI Bedrock infrastructure.
"""
...
from dheera_ai.llms.bedrock.count_tokens.transformation import BedrockCountTokensConfig
...
class BedrockCountTokensHandler(BedrockCountTokensConfig):
    ...
    Uses existing DheeraAI infrastructure for authentication and request handling.
    """
    ...
    async def handle_count_tokens_request(
        ...
        """
        Handle a CountTokens request using existing DheeraAI patterns.

        Args:
            request_data: The incoming request payload
            dheera_ai_params: DheeraAI configuration parameters
        ...
        try:
            ...
            # Get AWS region using existing DheeraAI function
            ...
            async_client = get_async_httpx_client(llm_provider=dheera_ai.LlmProviders.BEDROCK)
