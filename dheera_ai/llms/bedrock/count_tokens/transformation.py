...
class BedrockCountTokensConfig(BaseAWSLLM):
    ...
    def get_bedrock_count_tokens_endpoint(
        ...
        """
        Construct the AWS Bedrock CountTokens API endpoint using existing DheeraAI functions.
        ...
        """
        # Use existing DheeraAI function to get the base model ID (removes region prefix)
