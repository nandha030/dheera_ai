...
import dheera_ai
from dheera_ai.constants import BEDROCK_EMBEDDING_PROVIDERS_LITERAL
from dheera_ai.llms.cohere.embed.handler import embedding as cohere_embedding
...
from dheera_ai.types.utils import EmbeddingResponse, LlmProviders
...
class BedrockEmbedding(BaseAWSLLM):
    ...
    async def _make_async_call(
        ...
        if client is None or not isinstance(client, AsyncHTTPHandler):
            ...
            client = get_async_httpx_client(
                params=_params, llm_provider=dheera_ai.LlmProviders.BEDROCK
            )
        else:
            client = client
    ...
    def _transform_response(
        ...
        if (
            ...
            if provider == "twelvelabs":
                ...
                from dheera_ai.types.utils import Embedding, Usage
    ...
    async def _get_async_invoke_status(
        ...
        if logging_obj is not None:
            ...
            custom_curl = "\n\nGET Request Sent from DheeraAI:\n"
