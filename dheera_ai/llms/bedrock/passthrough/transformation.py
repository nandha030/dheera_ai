...
if TYPE_CHECKING:
    ...
    from dheera_ai.types.utils import CostResponseTypes
...
class BedrockPassthroughConfig(
    ...
    def get_complete_url(
        ...
        optional_params = dheera_ai_params.copy()
    ...
    def logging_non_streaming_response(
        ...
        from dheera_ai import encoding
        ...
        dheera_ai_model_response: ModelResponse = provider_chat_config.transform_response(
            model=model,
        ...
        return dheera_ai_model_response
    ...
    def handle_logging_collected_chunks(
        ...
        from dheera_ai.dheera_ai_core_utils.streaming_handler import (
            convert_generic_chunk_to_model_response_stream,
            generic_chunk_has_all_required_fields,
        )
        from dheera_ai.llms.bedrock.chat import get_bedrock_event_stream_decoder
