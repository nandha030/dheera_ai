...
from dheera_ai.types.utils import TextChoices
from dheera_ai.utils import CustomStreamWrapper, TextCompletionResponse
...
class CodestralTextCompletion:
    ...
    def process_text_completion_response(
        ...
        for choice in _original_choices:
            ...
            _choice = dheera_ai.utils.TextChoices(
    ...
    def completion(
        ...
        ## Load Config
        config = dheera_ai.CodestralTextCompletionConfig.get_config()
    ...
    async def async_completion(
        ...
        async_handler = get_async_httpx_client(
            llm_provider=dheera_ai.LlmProviders.TEXT_COMPLETION_CODESTRAL,
