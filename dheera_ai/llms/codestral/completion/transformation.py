...
from dheera_ai.types.llms.databricks import GenericStreamingChunk
...
class CodestralTextCompletionConfig(OpenAITextCompletionConfig):
    ...
    def _chunk_parser(self, chunk_data: str) -> GenericStreamingChunk:
        ...
        chunk_data = (
            dheera_ai.CustomStreamWrapper._strip_sse_data_from_chunk(chunk_data) or ""
        )
        ...
        original_chunk = dheera_ai.ModelResponse(**chunk_data_dict, stream=True)
