...
from dheera_ai.types.llms.bedrock import CohereEmbeddingRequest
...
def validate_environment(api_key, headers: dict):
    ...
    if "request-source" not in existing_keys_lower:
        headers["Request-Source"] = "unspecified:dheera_ai"
...
async def async_embedding(
    ...
    input: list,
    model_response: dheera_ai.utils.EmbeddingResponse,
    ...
    if client is None:
        client = get_async_httpx_client(
            llm_provider=dheera_ai.LlmProviders.COHERE,
