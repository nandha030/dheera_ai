...
from dheera_ai.types.llms.openai import FileTypes
from dheera_ai.types.utils import HttpHandlerRequestFields, ImageResponse, LlmProviders
from dheera_ai.utils import CustomStreamWrapper, ModelResponse, ProviderConfigManager
...
class BaseLLMAIOHTTPHandler:
    def __init__(
        ...
        transport: Optional[DheeraAIAiohttpTransport] = None,
    ...
    def _get_or_create_transport(self) -> Optional[DheeraAIAiohttpTransport]:
    ...
    def image_variations(
        ...
        if dheera_ai_params.get("async_call", False):
