...
from dheera_ai.constants import DEFAULT_DATAFORSEO_LOCATION_CODE
from dheera_ai.dheera_ai_core_utils.dheera_ai_logging import Logging as DheeraAILoggingObj
from dheera_ai.llms.base_llm.search.transformation import (
    BaseSearchConfig,
    SearchResponse,
    SearchResult,
)
...
class DataForSEOSearchConfig(BaseSearchConfig):
    ...
    def transform_search_response(
        ...
        **kwargs,
        ...
        """
        Transform DataForSEO SERP API response to DheeraAI unified SearchResponse format.
        
        DataForSEO → DheeraAI mappings:
