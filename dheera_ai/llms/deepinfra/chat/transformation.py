...
import dheera_ai
from dheera_ai.constants import MIN_NON_ZERO_TEMPERATURE
                ...
                if (
                    ...
                    if dheera_ai.drop_params is True or drop_params is True:
                        ...
                        raise dheera_ai.utils.UnsupportedParamsError(
                            message="Deepinfra doesn't support tool_choice={}. To drop unsupported openai params from the call, set `dheera_ai.drop_params = True`".format(
                                value
                            ),
                            status_code=400,
                        )
