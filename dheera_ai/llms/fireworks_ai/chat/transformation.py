...
class FireworksAIConfig(OpenAIGPTConfig):
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            if param == "tool_choice":
                if value == "required":
                    # relevant issue: https://github.com/BerriAI/dheera_ai/issues/4416
    ...
    def _transform_messages_helper(
        self, messages: List[AllMessageValues], model: str, dheera_ai_params: dict
        ...
        disable_add_transform_inline_image_block = cast(
            Optional[bool],
            dheera_ai_params.get("disable_add_transform_inline_image_block")
            or dheera_ai.disable_add_transform_inline_image_block,
        )
    ...
    def transform_request(
        ...
        messages = self._transform_messages_helper(
            messages=messages, model=model, dheera_ai_params=dheera_ai_params
        )
    ...
    def _handle_message_content_with_tool_calls(
        ...
        Relevant Issue: https://github.com/BerriAI/dheera_ai/issues/7209#issuecomment-2813208780
        """
        if (
