...
class GeminiModelInfo(BaseLLMModelInfo):
    ...
    def process_model_name(self, models: List[Dict[str, str]]) -> List[str]:
        ...
        for model in models:
            ...
            dheera_ai_model_name = "gemini/" + stripped_model_name
    ...
    def get_models(
        ...
        dheera_ai_model_names = self.process_model_name(models)
        return dheera_ai_model_names
...
class GoogleAIStudioTokenCounter(BaseTokenCounter):
    ...
    async def count_tokens(
        ...
        count_tokens_params_request = copy.deepcopy(deployment.get("dheera_ai_params", {}))
        count_tokens_params = {
            "model": model_to_use,
            "contents": contents,
        }
