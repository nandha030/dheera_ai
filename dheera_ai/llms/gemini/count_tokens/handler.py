...
if TYPE_CHECKING:
    from dheera_ai.types.google_genai.main import GenerateContentContentListUnionDict
else:
    ...
    async def acount_tokens(
        ...
        **kwargs,
        ...
        Raises:
            ...
            dheera_ai.APIError: If the API call fails
            dheera_ai.APIConnectionError: If the connection fails
