...
from dheera_ai.llms.gemini.common_utils import GeminiError, GeminiModelInfo
...
class GoogleAIStudioInteractionsConfig(BaseInteractionsAPIConfig):
    ...
    def get_complete_url(
        ...
        api_key = GeminiModelInfo.get_api_key(dheera_ai_params.get("api_key"))
    ...
    def transform_get_interaction_request(
        ...
        api_key = GeminiModelInfo.get_api_key(dheera_ai_params.api_key)
        if not api_key:
