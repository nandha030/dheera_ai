...
from dheera_ai.types.llms.gemini import (
...
from dheera_ai.types.realtime import (
    ALL_DELTA_TYPES,
    RealtimeModalityResponseTransformOutput,
    RealtimeResponseTransformInput,
    RealtimeResponseTypedDict,
)
from dheera_ai.utils import get_empty_usage
...
class GeminiRealtimeConfig(BaseRealtimeConfig):
    ...
    def transform_response_done_event(
        ...
        responses_api_usage = DheeraAICompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(
    ...
    def transform_realtime_response(
        ...
        logging_session_id = logging_obj.dheera_ai_trace_id
