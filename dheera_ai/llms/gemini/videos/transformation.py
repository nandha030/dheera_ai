...
import dheera_ai
from dheera_ai.types.llms.gemini import GeminiLongRunningOperationResponse, GeminiVideoGenerationInstance, GeminiVideoGenerationParameters, GeminiVideoGenerationRequest
...
class GeminiVideoConfig(BaseVideoConfig):
    ...
    def validate_environment(
        ...
        if dheera_ai_params and dheera_ai_params.api_key:
