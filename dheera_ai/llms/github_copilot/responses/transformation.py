...
class GithubCopilotResponsesAPIConfig(OpenAIResponsesAPIConfig):
    ...
    def validate_environment(
        ...
        try:
            ...
            input_param = self._get_input_from_params(dheera_ai_params)
    ...
    def _get_input_from_params(
        self, dheera_ai_params: Optional[GenericDheeraAIParams]
    ) -> Optional[Union[str, ResponseInputParam]]:
        """
        Extract input parameter from dheera_ai_params.
        ...
        # Try to get input from dheera_ai_params
        # This might be in different locations depending on how DheeraAI structures it
        if hasattr(dheera_ai_params, "input"):
            return dheera_ai_params.input
