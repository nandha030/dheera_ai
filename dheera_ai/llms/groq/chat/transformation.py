...
from dheera_ai.llms.openai.common_utils import OpenAIError
...
class GroqChatConfig(OpenAILikeChatConfig):
    ...
    def _transform_messages(
        ...
        for idx, message in enumerate(messages):
            """
            1. Don't pass 'null' function_call assistant message to groq - https://github.com/BerriAI/dheera_ai/issues/5839
            """
    ...
    def map_openai_params(
        ...
        if _response_format is not None and isinstance(_response_format, dict):
            ...
            if json_schema is not None:
                ...
                if not dheera_ai.supports_response_schema(
                    ...
                    if "tools" in non_default_params:
                        raise dheera_ai.BadRequestError(
                            ...
                            "DheeraAI uses a tool-calling workaround for structured outputs on this model, "
