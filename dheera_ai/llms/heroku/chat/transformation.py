...
class HerokuChatConfig(OpenAIGPTConfig):
    ...
    def get_complete_url(self, api_base: Optional[str], api_key: Optional[str], model: str, optional_params: dict, dheera_ai_params: dict, stream: Optional[bool] = None) -> str:
