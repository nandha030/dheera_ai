...
class HuggingFaceEmbeddingConfig(BaseConfig):
    ...
    hf_task: Optional[hf_tasks] = (
        None  # dheera_ai-specific param, used to know the api spec to use when calling huggingface api
    )
    ...
    def transform_request(
        ...
        task = dheera_ai_params.get("task", None)
        ## VALIDATE API FORMAT
        ...
        ## Load Config
        config = dheera_ai.HuggingFaceEmbeddingConfig.get_config()
