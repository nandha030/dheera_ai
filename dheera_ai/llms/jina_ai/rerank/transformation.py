...
from dheera_ai.types.rerank import (
...
class JinaAIRerankConfig(BaseRerankConfig):
    ...
    def transform_rerank_response(
        ...
        # Transform Jina AI's response format to match DheeraAI's expected format
        # Jina AI returns: {"index": 0, "relevance_score": 0.72, "document": "hello"}
        # DheeraAI expects: {"index": 0, "relevance_score": 0.72, "document": {"text": "hello"}}
        transformed_results = []
