...
from dheera_ai.types.llms.mistral import MistralThinkingBlock, MistralToolCallMessage
...
class MistralConfig(OpenAIGPTConfig):
    ...
    def _transform_messages(
        ...
        - if `name` is passed, then drop it for mistral API: https://github.com/BerriAI/dheera_ai/issues/6696
    ...
    def _clean_tool_schema_for_mistral(cls, tools: list) -> list:
        ...
        from dheera_ai.utils import _remove_json_schema_refs
