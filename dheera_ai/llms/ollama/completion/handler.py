...
def _process_ollama_embedding_response(
    ...
    model_response.usage = dheera_ai.Usage(
...
async def ollama_aembeddings(
    ...
    response = await dheera_ai.module_level_aclient.post(url=api_base, json=data)
...
def ollama_embeddings(
    ...
    response = dheera_ai.module_level_client.post(url=api_base, json=data)
    response_json = response.json()
