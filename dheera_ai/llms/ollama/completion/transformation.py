...
class OllamaConfig(BaseConfig):
    ...
    def get_api_key() -> Optional[str]:
        """Get API key from environment variables or dheera_ai configuration"""
        import os
    ...
    def transform_response(
        ...
        if request_data.get("format", "") == "json":
            ...
            if not response_text or not response_text.strip():
                ...
                message = dheera_ai.Message(content="")
    ...
    def transform_request(
        ...
        custom_prompt_dict = (
            dheera_ai_params.get("custom_prompt_dict") or dheera_ai.custom_prompt_dict
        )

        text_completion_request = dheera_ai_params.get("text_completion")
