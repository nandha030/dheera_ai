    ...
    def map_openai_params(
        ...
        if reasoning_effort is not None and reasoning_effort == "xhigh":
            if not (
                ...
                if dheera_ai.drop_params or drop_params:
        ...
        # Relevant issue: https://github.com/BerriAI/dheera_ai/issues/13381
        ################################################################
        ...
        if "temperature" in non_default_params:
            ...
            if temperature_value is not None:
                ...
                if is_gpt_5_1 and (reasoning_effort == "none" or reasoning_effort is None):
                    ...
                    optional_params["temperature"] = temperature_value
                elif dheera_ai.drop_params or drop_params:
                    pass
                else:
                    raise dheera_ai.utils.UnsupportedParamsError(
                        message=(
                            ...
                            "To drop unsupported params set `dheera_ai.drop_params = True`"
