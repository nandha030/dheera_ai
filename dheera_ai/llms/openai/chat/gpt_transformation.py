...
from dheera_ai.dheera_ai_core_utils.prompt_templates.common_utils import get_tool_call_names
from dheera_ai.dheera_ai_core_utils.prompt_templates.image_handling import (
...
if TYPE_CHECKING:
    ...
    from dheera_ai.types.llms.openai import ChatCompletionToolParam
...
class OpenAIGPTConfig(BaseLLMModelInfo, BaseConfig):
    ...
    def get_supported_openai_params(self, model: str) -> list:
        ...
        if (
            model_for_check in dheera_ai.open_ai_chat_completion_models
        ) or model_for_check in dheera_ai.open_ai_text_completion_models:
    ...
    def _apply_common_transform_content_item(
        ...
        dheera_ai_specific_params = {"format"}
            ...
            if isinstance(content_item["image_url"], str):
                ...
                new_image_url_obj = ChatCompletionImageUrlObject(
                    **{  # type: ignore
                        ...
                        if k not in dheera_ai_specific_params
                    }
                )
    ...
    async def async_transform_request(
        ...
        if self.__class__._is_base_class:
            ...
            return self.transform_request(
                model, messages, optional_params, dheera_ai_params, headers
            )
    ...
    def get_models(
        ...
        response = dheera_ai.module_level_client.get(
