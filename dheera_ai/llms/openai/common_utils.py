...
class BaseOpenAILLM:
    ...
    def get_cached_openai_client(
        ...
        _cached_client = dheera_ai.in_memory_llm_clients_cache.get_cache(_cache_key)
    ...
    def get_openai_client_cache_key(
        ...
        DHEERA_AI_CLIENT_SPECIFIC_PARAMS = [
            "timeout",
            "max_retries",
            "organization",
            "api_base",
    ...
    def _get_async_http_client(
        ...
        if dheera_ai.aclient_session is not None:
            return dheera_ai.aclient_session
    ...
    def _get_sync_http_client() -> Optional[httpx.Client]:
        if dheera_ai.client_session is not None:
            return dheera_ai.client_session
