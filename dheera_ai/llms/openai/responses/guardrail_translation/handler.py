...
if TYPE_CHECKING:
    ...
    from dheera_ai.types.llms.openai import ResponseInputParam
    from dheera_ai.types.utils import ResponsesAPIResponse
...
class OpenAIResponsesHandler(BaseTranslation):
    ...
    async def process_input_messages(
        ...
        structured_messages = (
            DheeraAICompletionResponsesConfig.transform_responses_api_input_to_messages(
                input=input_data,
    ...
    def _extract_and_transform_tools(
        ...
        Uses the DheeraAI transformation function to convert Responses API tools
    ...
    async def process_output_response(
        ...
        Args:
            response: DheeraAI ResponsesAPIResponse object
            guardrail_to_apply: The guardrail instance to apply
            dheera_ai_logging_obj: Optional logging object
        ...
        if texts_to_check or tool_calls_to_check:
            ...
            if user_metadata:
                request_data["dheera_ai_metadata"] = user_metadata
    ...
    async def process_output_streaming_response(
        ...
        if final_chunk.get("type") == "response.output_item.done":
            ...
            model_response_choices = DheeraAIResponsesTransformationHandler._convert_response_output_to_choices(
    ...
    def _extract_output_text_and_images(
        ...
        if isinstance(output_item, OutputFunctionToolCall):
            if tool_calls_to_check is not None:
                tool_call_dict = DheeraAICompletionResponsesConfig.convert_response_function_tool_call_to_chat_completion_tool_call(
