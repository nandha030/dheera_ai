...
from dheera_ai.llms.databricks.streaming_utils import ModelResponseIterator
...
from dheera_ai.types.utils import CustomStreamingDecoder, ModelResponse
from dheera_ai.utils import CustomStreamWrapper, ProviderConfigManager
...
def make_sync_call(
    ...
    if client is None:
        client = dheera_ai.module_level_client  # Create a new client if none provided
