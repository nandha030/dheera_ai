...
from dheera_ai.types.llms.openai import AllMessageValues, ChatCompletionToolParam
from dheera_ai.types.llms.openrouter import OpenRouterErrorMessage
...
class OpenrouterConfig(OpenAIGPTConfig):
    def get_supported_openai_params(self, model: str) -> list:
        ...
        try:
            if dheera_ai.supports_reasoning(
                model=model, custom_llm_provider="openrouter"
            ) or dheera_ai.supports_reasoning(model=model):
        ...
        try:
            ...
            if "usage" in response_json and response_json["usage"]:
                ...
                if response_cost is not None:
                    ...
                    model_response._hidden_params["additional_headers"]["llm_provider-x-dheera_ai-response-cost"] = float(response_cost)
        except Exception:
