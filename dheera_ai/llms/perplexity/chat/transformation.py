...
from dheera_ai.types.llms.openai import ChatCompletionAnnotationURLCitation
...
class PerplexityChatConfig(OpenAIGPTConfig):
    ...
    def get_supported_openai_params(self, model: str) -> list:
        ...
        try:
            if dheera_ai.supports_web_search(
                model=model, custom_llm_provider=self.custom_llm_provider
            ):
    ...
    def _enhance_usage_with_perplexity_fields(
        ...
        and add them to the usage object using standard DheeraAI fields.
        """
