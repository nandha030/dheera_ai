...
import dheera_ai
from dheera_ai.constants import REPLICATE_POLLING_DELAY_SECONDS
...
from dheera_ai.utils import CustomStreamWrapper, ModelResponse
...
def completion(
    ...
    if "stream" in optional_params and optional_params["stream"] is True:
        ...
        for retry in range(dheera_ai.DEFAULT_REPLICATE_POLLING_RETRIES):
            time.sleep(
                dheera_ai.DEFAULT_REPLICATE_POLLING_DELAY_SECONDS + 2 * retry
            ...
            if (
                ...
                continue
            return dheera_ai.ReplicateConfig().transform_response(
                model=model,
...
async def async_completion(
    ...
    async_handler = get_async_httpx_client(
        llm_provider=dheera_ai.LlmProviders.REPLICATE,
        params={"timeout": 600.0},
    )
