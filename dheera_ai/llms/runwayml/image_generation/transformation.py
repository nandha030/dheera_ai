...
class RunwayMLImageGenerationConfig(BaseImageGenerationConfig):
    ...
    async def _poll_task_async(
        ...
        client = get_async_httpx_client(llm_provider=dheera_ai.LlmProviders.RUNWAYML)
        start_time = time.time()
    ...
    def transform_image_generation_response(
        ...
        """
        Transform the image generation response to the dheera_ai image response.
    ...
    async def async_transform_image_generation_response(
        ...
        """
        Async transform the image generation response to the dheera_ai image response.
