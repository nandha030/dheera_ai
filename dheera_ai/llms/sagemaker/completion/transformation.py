...
class SagemakerConfig(BaseConfig):
    ...
    def transform_request(
        ...
        custom_prompt_dict = (
            dheera_ai_params.get("custom_prompt_dict", None) or dheera_ai.custom_prompt_dict
        )
    ...
    def transform_response(
        ...
        try:
            ...
            raise SagemakerError(
                message=f"DheeraAI Error: Unable to parse sagemaker RAW RESPONSE {json.dumps(completion_response)}",
                status_code=500,
            )
