...
DheeraAI supports the re rank API format, no paramter transformation occurs
"""
...
from dheera_ai.llms.together_ai.rerank.transformation import TogetherAIRerankConfig
from dheera_ai.types.rerank import RerankRequest, RerankResponse
...
class TogetherAIRerank(BaseLLM):
    ...
    async def async_rerank(  # New async method
        ...
        client = get_async_httpx_client(
            llm_provider=dheera_ai.LlmProviders.TOGETHER_AI
        )  # Use async client
