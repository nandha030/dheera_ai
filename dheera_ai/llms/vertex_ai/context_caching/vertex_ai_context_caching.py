...
import dheera_ai
from dheera_ai.caching.caching import Cache, DheeraAICacheType
...
from dheera_ai.llms.openai.openai import AllMessageValues
    ...
    async def async_check_and_create_cache(
        ...
        if client is None or not isinstance(client, AsyncHTTPHandler):
            client = get_async_httpx_client(
                params={"timeout": timeout}, llm_provider=dheera_ai.LlmProviders.VERTEX_AI
            )
        else:
            client = client
