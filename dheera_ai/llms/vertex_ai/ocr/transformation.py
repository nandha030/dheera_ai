...
from dheera_ai.llms.base_llm.ocr.transformation import DocumentType, OCRRequestData
...
class VertexAIOCRConfig(MistralOCRConfig):
    ...
    def validate_environment(
        ...
        **kwargs,
        ...
        vertex_project = VertexBase.safe_get_vertex_ai_project(dheera_ai_params=dheera_ai_params)
        vertex_credentials = VertexBase.safe_get_vertex_ai_credentials(dheera_ai_params=dheera_ai_params)
    ...
    def get_complete_url(
        ...
        **kwargs,
        ...
        Args:
            ...
            dheera_ai_params: DheeraAI parameters containing vertex_project, vertex_location
        ...
        vertex_project = VertexBase.safe_get_vertex_ai_project(dheera_ai_params=dheera_ai_params)
        vertex_location = VertexBase.safe_get_vertex_ai_location(dheera_ai_params=dheera_ai_params)
