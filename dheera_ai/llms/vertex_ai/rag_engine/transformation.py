...
Handles transforming DheeraAI's unified formats to Vertex AI RAG Engine API format.
"""
...
class VertexAIRAGTransformation(VertexBase):
    ...
    def transform_chunking_strategy_to_vertex_format(
        ...
        """
        Transform DheeraAI's unified chunking_strategy to Vertex AI RAG format.

        DheeraAI format (RAGChunkingStrategy):
            {
                "chunk_size": 1000,
                "chunk_overlap": 200,
                "separators": ["\n\n", "\n", " ", ""]
    ...
    def build_import_rag_files_request(
        ...
        Args:
            ...
            chunking_strategy: DheeraAI unified chunking config
