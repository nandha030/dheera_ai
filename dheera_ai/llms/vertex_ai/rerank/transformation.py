...
from dheera_ai.types.rerank import RerankResponse, RerankResponseMeta, RerankBilledUnits, RerankResponseResult
...
class VertexAIRerankConfig(BaseRerankConfig, VertexBase):
    ...
    def get_complete_url(
        ...
        # Fallback to environment or dheera_ai config
        project_id = (
            vertex_project
        ...
        if not project_id:
            raise ValueError(
                "Vertex AI project ID is required. Please set 'VERTEXAI_PROJECT', 'dheera_ai.vertex_project', or pass 'vertex_project' parameter"
            )
    ...
    def validate_environment(
        ...
        dheera_ai_params = optional_params.copy() if optional_params else {}
