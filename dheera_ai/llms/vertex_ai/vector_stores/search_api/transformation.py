...
class VertexSearchAPIVectorStoreConfig(BaseVectorStoreConfig, VertexBase):
    ...
    def get_auth_credentials(
        ...
        vertex_credentials = self.get_vertex_ai_credentials(dict(dheera_ai_params))
        vertex_project = self.get_vertex_ai_project(dict(dheera_ai_params))
    ...
    def validate_environment(
        ...
        auth_headers = self.get_auth_credentials(dheera_ai_params.model_dump())
    ...
    def get_complete_url(
        ...
        collection_id = (
            dheera_ai_params.get("vertex_collection_id") or "default_collection"
        )
        datastore_id = dheera_ai_params.get("vector_store_id")
        if not datastore_id:
    ...
    def transform_search_vector_store_response(
        ...
        try:
            ...
            return VectorStoreSearchResponse(
                ...
                search_query=dheera_ai_logging_obj.model_call_details.get("query", ""),
                data=search_results,
            )
