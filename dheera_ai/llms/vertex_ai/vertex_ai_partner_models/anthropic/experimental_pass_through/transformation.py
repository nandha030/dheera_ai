...
from dheera_ai.types.llms.anthropic import ANTHROPIC_BETA_HEADER_VALUES, ANTHROPIC_HOSTED_TOOLS
...
class VertexAIPartnerModelsAnthropicMessagesConfig(AnthropicMessagesConfig, VertexBase):
    def validate_anthropic_messages_environment(
        ...
        if "Authorization" not in headers:
            vertex_ai_project = VertexBase.get_vertex_ai_project(dheera_ai_params)
            vertex_credentials = VertexBase.get_vertex_ai_credentials(dheera_ai_params)
            vertex_ai_location = VertexBase.get_vertex_ai_location(dheera_ai_params)
