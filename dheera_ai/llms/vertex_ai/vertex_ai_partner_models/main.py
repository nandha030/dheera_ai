...
class VertexAIPartnerModels(VertexBase):
    ...
    def completion(
        ...
        try:
            ...
            from dheera_ai.llms.anthropic.chat import AnthropicChatCompletion
            from dheera_ai.llms.codestral.completion.handler import (
                CodestralTextCompletion,
            )
            from dheera_ai.llms.openai_like.chat.handler import OpenAILikeChatHandler
        ...
        try:
            ...
            if "codestral" in model and dheera_ai_params.get("text_completion") is True:
    ...
    async def count_tokens(
        ...
        Args:
            ...
            dheera_ai_params: DheeraAI parameters dict
        ...
        try:
            ...
            # Prepare dheera_ai_params with credentials
            _dheera_ai_params = dheera_ai_params.copy()
            if vertex_project:
                _dheera_ai_params["vertex_project"] = vertex_project
            if vertex_location:
                _dheera_ai_params["vertex_location"] = vertex_location
            if vertex_credentials:
                _dheera_ai_params["vertex_credentials"] = vertex_credentials
