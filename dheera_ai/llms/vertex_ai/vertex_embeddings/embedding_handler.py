...
from dheera_ai.llms.vertex_ai.vertex_ai_non_gemini import VertexAIError
...
class VertexEmbedding(VertexBase):
    ...
    def embedding(
        ...
        vertex_request: VertexEmbeddingRequest = (
            dheera_ai.vertexAITextEmbeddingConfig.transform_openai_request_to_vertex_embedding_request(
        ...
        model_response = (
            dheera_ai.vertexAITextEmbeddingConfig.transform_vertex_response_to_openai(
