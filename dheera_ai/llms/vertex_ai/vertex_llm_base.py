...
from dheera_ai.types.llms.vertex_ai import VERTEX_CREDENTIALS_TYPES, VertexPartnerProvider
...
class VertexBase:
    ...
    def _check_custom_proxy(
        ...
        """
        for cloudflare ai gateway - https://github.com/BerriAI/dheera_ai/issues/4317
    ...
    @staticmethod
    def get_vertex_ai_project(dheera_ai_params: dict) -> Optional[str]:
        return (
            dheera_ai_params.pop("vertex_project", None)
            or dheera_ai_params.pop("vertex_ai_project", None)
            or dheera_ai.vertex_project
            or get_secret_str("VERTEXAI_PROJECT")
        )

    @staticmethod
    def get_vertex_ai_credentials(dheera_ai_params: dict) -> Optional[str]:
        return (
            dheera_ai_params.pop("vertex_credentials", None)
            or dheera_ai_params.pop("vertex_ai_credentials", None)
            or get_secret_str("VERTEXAI_CREDENTIALS")
        )

    @staticmethod
    def get_vertex_ai_location(dheera_ai_params: dict) -> Optional[str]:
        return (
            dheera_ai_params.pop("vertex_location", None)
            or dheera_ai_params.pop("vertex_ai_location", None)
    ...
    @staticmethod
    def safe_get_vertex_ai_project(dheera_ai_params: dict) -> Optional[str]:
        """
        Safely get Vertex AI project without mutating the dheera_ai_params dict.

        Unlike get_vertex_ai_project(), this does NOT pop values from the dict,
        making it safe to call multiple times with the same dheera_ai_params.

        Args:
            dheera_ai_params: Dictionary containing Vertex AI parameters

        Returns:
            Vertex AI project ID or None
        """
        return (
            dheera_ai_params.get("vertex_project")
            or dheera_ai_params.get("vertex_ai_project")
            or dheera_ai.vertex_project
            or get_secret_str("VERTEXAI_PROJECT")
        )

    @staticmethod
    def safe_get_vertex_ai_credentials(dheera_ai_params: dict) -> Optional[str]:
        """
        Safely get Vertex AI credentials without mutating the dheera_ai_params dict.
        ...
        """
        return (
            dheera_ai_params.get("vertex_credentials")
            or dheera_ai_params.get("vertex_ai_credentials")
            or get_secret_str("VERTEXAI_CREDENTIALS")
        )

    @staticmethod
    def safe_get_vertex_ai_location(dheera_ai_params: dict) -> Optional[str]:
        """
        Safely get Vertex AI location without mutating the dheera_ai_params dict.
        ...
        """
        return (
            dheera_ai_params.get("vertex_location")
            or dheera_ai_params.get("vertex_ai_location")
            or dheera_ai.vertex_location
            or get_secret_str("VERTEXAI_LOCATION")
            or get_secret_str("VERTEX_LOCATION")
        )
