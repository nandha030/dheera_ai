...
from dheera_ai.constants import DEFAULT_GOOGLE_VIDEO_DURATION_SECONDS
...
from dheera_ai.types.videos.main import VideoCreateOptionalRequestParams, VideoObject
...
if TYPE_CHECKING:
    ...
    from dheera_ai.llms.base_llm.chat.transformation import (
...
class VertexAIVideoConfig(BaseVideoConfig, VertexBase):
    ...
    def validate_environment(
        ...
        dheera_ai_params: Optional[Union[GenericDheeraAIParams, dict]] = None,
    ) -> dict:
        """
        ...
        # Use safe_get_* methods that don't mutate dheera_ai_params dict
        # Ensure dheera_ai_params is a dict for type checking
        params_dict: Dict[str, Any] = cast(Dict[str, Any], dheera_ai_params) if dheera_ai_params is not None else {}
        
        vertex_project = VertexBase.safe_get_vertex_ai_project(dheera_ai_params=params_dict)
        vertex_credentials = VertexBase.safe_get_vertex_ai_credentials(dheera_ai_params=params_dict)
    ...
    def get_complete_url(
        ...
        """
        vertex_project = VertexBase.safe_get_vertex_ai_project(dheera_ai_params)
        vertex_location = VertexBase.safe_get_vertex_ai_location(dheera_ai_params)
    ...
    def transform_video_content_request(
        ...
        """
        return self.transform_video_status_retrieve_request(video_id, api_base, dheera_ai_params, headers)
    ...
    def get_error_class(
        ...
        from dheera_ai.llms.vertex_ai.common_utils import VertexAIError
