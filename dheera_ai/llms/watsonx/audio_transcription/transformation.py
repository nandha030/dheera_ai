...
import dheera_ai
from dheera_ai.dheera_ai_core_utils.audio_utils.utils import process_audio_file
from dheera_ai.types.llms.openai import (
    AllMessageValues,
    OpenAIAudioTranscriptionOptionalParams,
)
from dheera_ai.types.llms.watsonx import WatsonXAudioTranscriptionRequestBody
...
class IBMWatsonXAudioTranscriptionConfig(
    ...
    def get_complete_url(
        ...
        api_version = optional_params.get(
            "api_version", None
        ) or dheera_ai.WATSONX_DEFAULT_API_VERSION
