...
from dheera_ai.dheera_ai_core_utils.prompt_templates import factory as ptf
...
from dheera_ai.types.llms.watsonx import WatsonXAPIParams, WatsonXCredentials
...
async def _aconvert_watsonx_messages_core(
    ...
    from dheera_ai.types.llms.watsonx import WatsonXModelPattern
...
class IBMWatsonXMixin:
    ...
    def _add_api_version_to_url(self, url: str, api_version: Optional[str]) -> str:
        api_version = api_version or dheera_ai.WATSONX_DEFAULT_API_VERSION
