...
from dheera_ai.types.llms.openai import AllMessageValues, ChatCompletionUsageBlock
from dheera_ai.types.llms.watsonx import WatsonXAIEndpoint
from dheera_ai.types.utils import GenericStreamingChunk, ModelResponse, Usage
from dheera_ai.utils import map_finish_reason
...
class IBMWatsonXAIConfig(IBMWatsonXMixin, BaseConfig):
    ...
    max_new_tokens: Optional[int] = None  # dheera_ai.max_tokens
    ...
    async def atransform_request(self, model: str, messages: List[AllMessageValues], optional_params: Dict, dheera_ai_params: Dict, headers: Dict) -> Dict:
        """Async version of transform_request"""
        from dheera_ai.llms.watsonx.common_utils import (
    ...
    def transform_request(self, model: str, messages: List[AllMessageValues], optional_params: Dict, dheera_ai_params: Dict, headers: Dict) -> Dict:
