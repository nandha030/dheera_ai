...
from dheera_ai.passthrough.utils import CommonUtils
...
def llm_passthrough_route(
    ...
    **kwargs,
    ...
    dheera_ai_logging_obj.stream = is_streaming_request
    ...
    try:
        if _is_async:
            ...
            if (
                ...
                return _sync_streaming(response, dheera_ai_logging_obj, provider_config)
            else:
...
def _sync_streaming(
    ...
    from dheera_ai.utils import executor
    ...
    try:
        ...
        executor.submit(
            dheera_ai_logging_obj.flush_passthrough_collected_chunks,
            raw_bytes=raw_bytes,
            provider_config=provider_config,
        )
    except Exception as e:
...
async def _async_streaming(
    ...
    try:
        ...
        asyncio.create_task(
            dheera_ai_logging_obj.async_flush_passthrough_collected_chunks(
                raw_bytes=raw_bytes,
                provider_config=provider_config,
            )
        )
