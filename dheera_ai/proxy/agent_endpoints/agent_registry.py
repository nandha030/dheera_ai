...
from dheera_ai.types.agents import AgentConfig, AgentResponse, PatchAgentRequest
...
class AgentRegistry:
    ...
    async def add_agent_to_db(
        ...
        try:
            ...
            # Serialize dheera_ai_params
            dheera_ai_params_obj: Any = agent.get("dheera_ai_params", {})
    ...
    async def patch_agent_in_db(
        ...
        try:
            ...
            if augment_agent.get("dheera_ai_params"):
                update_data["dheera_ai_params"] = safe_dumps(
                    augment_agent.get("dheera_ai_params")
                )
