...
def chat(
    ...
    Examples:
        ...
        dheera_ai-proxy chat gpt-4
        
        # Chat without specifying model (will show model selection)
        dheera_ai-proxy chat
        
        # Chat with custom settings
        dheera_ai-proxy chat gpt-4 --temperature 0.9 --system "You are a helpful coding assistant"
    """
    console = Console()
    ...
    console.print(Panel.fit(
        f"[bold blue]DheeraAI Interactive Chat[/bold blue]\n"
