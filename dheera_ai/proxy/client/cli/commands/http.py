...
@click.group()
def http():
    """Make HTTP requests to the DheeraAI proxy server"""
    pass
...
def request(
    ...
    Examples:
        dheera_ai http request GET /models
        dheera_ai http request POST /chat/completions -j '{"model": "gpt-4", "messages": [{"role": "user", "content": "Hello"}]}'
        dheera_ai http request GET /health/test_connection -H "X-Custom-Header:value"
    """
