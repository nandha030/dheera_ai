...
@click.group()
def keys():
    """Manage API keys for the DheeraAI proxy server"""
    pass
...
@click.option(
    "--source-base-url", required=True, help="Base URL of the source DheeraAI proxy server to import keys from"
)
...
def import_keys(
    ...
    """Import API keys from another DheeraAI instance"""
