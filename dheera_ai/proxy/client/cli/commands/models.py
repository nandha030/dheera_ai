...
def _get_model_info_obj_from_yaml(model: dict[str, Any]) -> ModelYamlInfo:
    ...
    model_params: dict[str, Any] = model["dheera_ai_params"]
...
@click.group()
def models() -> None:
    """Manage models on your DheeraAI proxy server"""
    pass
    ...
    if output_format == "json":
        ...
        column_configs: dict[str, dict[str, Any]] = {
            ...
            "upstream_model": {
                ...
                "style": "green",
                "get_value": lambda m: str(m.get("dheera_ai_params", {}).get("model", "")),
            },
            "credential_name": {
                "header": "Credential Name",
                "style": "yellow",
                "get_value": lambda m: str(m.get("dheera_ai_params", {}).get("dheera_ai_credential_name", "")),
            },
            "created_at": {
                "header": "Created At",
                "style": "magenta",
...
def _filter_model(model, model_regex, access_group_regex):
    ...
    model_params = model.get("dheera_ai_params")
...
@click.option(
    ...
    default=None,
    help="Only import models where dheera_ai_params.model matches the given regex.",
)
@click.option(
