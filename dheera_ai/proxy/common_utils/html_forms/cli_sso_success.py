from dheera_ai.proxy.common_utils.banner import DHEERA_AI_BANNER
...
def render_cli_sso_success_page() -> str:
    ...
    <head>
        <meta charset="UTF-8">
        <title>CLI Authentication Successful - DheeraAI</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="banner">{DHEERA_AI_BANNER}</div>
            ...
            <div class="success-box">
                ...
                <p>Your DheeraAI CLI has been successfully authenticated and is ready to use.</p>
            </div>
            ...
            <div class="instructions">
                ...
                <p>You can now use DheeraAI CLI commands with your authenticated session.</p>
            </div>
