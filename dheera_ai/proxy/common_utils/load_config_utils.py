...
def get_file_contents_from_s3(bucket_name, object_key):
    try:
        ...
        from dheera_ai.main import bedrock_converse_chat_completion
        ...
        # this is most likely if a user is not using the dheera_ai docker container
...
# # Example usage
# bucket_name = 'dheera_ai-proxy'
# object_key = 'dheera_ai_proxy_config.yaml'
