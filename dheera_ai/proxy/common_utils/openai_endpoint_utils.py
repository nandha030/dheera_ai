...
def remove_sensitive_info_from_deployment(
    ...
    """
    deployment_dict["dheera_ai_params"].pop("api_key", None)
    deployment_dict["dheera_ai_params"].pop("client_secret", None)
    deployment_dict["dheera_ai_params"].pop("vertex_credentials", None)
    deployment_dict["dheera_ai_params"].pop("aws_access_key_id", None)
    deployment_dict["dheera_ai_params"].pop("aws_secret_access_key", None)

    deployment_dict["dheera_ai_params"] = SENSITIVE_DATA_MASKER.mask_dict(
        deployment_dict["dheera_ai_params"], excluded_keys=excluded_keys
    )
