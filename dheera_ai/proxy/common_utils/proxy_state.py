...
Example: `spend_logs_row_count` is used to store the number of rows in the `DheeraAI_SpendLogs` table.
"""

from typing import Any, Literal

from dheera_ai.proxy._types import ProxyStateVariables
