...
from dheera_ai.proxy.utils import handle_exception_on_proxy, jsonify_object
from dheera_ai.types.utils import CreateCredentialItem, CredentialItem
...
async def delete_credential(
    ...
    try:
        ...
        ## DELETE FROM LITELLM ##
        dheera_ai.credential_list = [
            cred
            for cred in dheera_ai.credential_list
