...
class MyCustomHandler(CustomLogger):
    def __init__(self):
        ...
        print_verbose(f"{blue_color_code}Initialized DheeraAI custom logger")
        try:
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        response_cost = dheera_ai.completion_cost(completion_response=response_obj)
...
# need to set dheera_ai.callbacks = [customHandler] # on the proxy

# dheera_ai.success_callback = [async_on_succes_logger]
