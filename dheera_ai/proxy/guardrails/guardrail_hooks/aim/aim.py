...
class AimGuardrail(CustomGuardrail):
        ...
        return (
            {
                ...
                "x-aim-dheera_ai-hook": hook,
                # Used by Aim to track DheeraAI version and provide backward compatibility.
                "x-aim-dheera_ai-version": dheera_ai_version,
            }
            # Used by Aim to track together single call input and output
            | ({"x-aim-call-id": dheera_ai_call_id} if dheera_ai_call_id else {})
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        from dheera_ai.types.proxy.guardrails.guardrail_hooks.aim import (
