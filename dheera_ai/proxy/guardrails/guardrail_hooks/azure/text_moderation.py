#!/usr/bin/env python3
"""
Azure Text Moderation Native Guardrail Integrationfor DheeraAI
"""
...
if TYPE_CHECKING:
    ...
    from dheera_ai.types.proxy.guardrails.guardrail_hooks.azure.azure_text_moderation import (
    ...
    from dheera_ai.types.utils import EmbeddingResponse, ImageResponse, ModelResponse


class AzureContentSafetyTextModerationGuardrail(AzureGuardrailBase, CustomGuardrail):
    """
    DheeraAI Built-in Guardrail for Azure Content Safety Guardrail (Prompt Shield).
