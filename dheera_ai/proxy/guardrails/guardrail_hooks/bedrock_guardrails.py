...
from dheera_ai.exceptions import GuardrailInterventionNormalStringError
...
class BedrockGuardrail(CustomGuardrail, BaseAWSLLM):
    ...
    def convert_to_bedrock_format(
        ...
        """
        Convert the dheera_ai messages/response to the bedrock request format.
    ...
    async def make_bedrock_api_request(
        ...
        source: Literal["INPUT", "OUTPUT"],
        messages: Optional[List[AllMessageValues]] = None,
        response: Optional[Union[Any, dheera_ai.ModelResponse]] = None,
    ...
    def _apply_masking_to_model_response(
        self, response: dheera_ai.ModelResponse, masked_texts: List[str]
    ) -> None:
        """
