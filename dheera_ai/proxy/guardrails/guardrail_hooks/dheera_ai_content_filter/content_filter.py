"""
Content Filter Guardrail for DheeraAI.
...
class ContentFilterGuardrail(CustomGuardrail):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.guardrail_provider = "dheera_ai_content_filter"
    ...
    def get_config_model():
        from dheera_ai.types.proxy.guardrails.guardrail_hooks.dheera_ai_content_filter import (
