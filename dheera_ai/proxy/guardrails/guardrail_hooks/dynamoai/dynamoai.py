...
from dheera_ai.types.proxy.guardrails.guardrail_hooks.dynamoai import (
    DynamoAIProcessedResult,
    DynamoAIRequest,
    DynamoAIResponse,
)
from dheera_ai.types.utils import CallTypesLiteral, GuardrailStatus, ModelResponseStream
...
class DynamoAIGuardrails(CustomGuardrail):
    """
    DynamoAI Guardrails integration for DheeraAI.
    ...
    def __init__(
        self,
        guardrail_name: str = "dheera_ai_test",
