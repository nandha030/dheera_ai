...
This integration provides support for IBM's FMS Guardrails detectors in Dheera AI. It supports both direct detector server calls and calls via the FMS Guardrails Orchestrator.
...
```python
from dheera_ai.proxy.guardrails.guardrail_hooks.ibm_guardrails import IBMGuardrailDetector
...
- [Dheera AI Guardrails Documentation](https://docs.dheera_ai.ai/docs/proxy/guardrails)
