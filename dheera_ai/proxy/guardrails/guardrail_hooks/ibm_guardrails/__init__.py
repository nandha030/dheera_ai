...
from dheera_ai.types.proxy.guardrails.guardrail_hooks.ibm import IBMDetectorOptionalParams
...
def initialize_guardrail(dheera_ai_params: "LitellmParams", guardrail: "Guardrail"):
    ...
    verify_ssl = getattr(dheera_ai_params, "verify_ssl", True)

    # Get optional params
    optional_params = getattr(dheera_ai_params, "optional_params", IBMDetectorOptionalParams())
    ...
    is_detector_server = dheera_ai_params.is_detector_server
    if is_detector_server is None:
        is_detector_server = True

    ibm_guardrail = IBMGuardrailDetector(
        guardrail_name=guardrail_name,
        auth_token=dheera_ai_params.auth_token,
        base_url=dheera_ai_params.base_url,
        detector_id=dheera_ai_params.detector_id,
    ...
    dheera_ai.logging_callback_manager.add_dheera_ai_callback(ibm_guardrail)
