# +-------------------------------------------------------------+
#
#           Noma Security Guardrail Integration for DheeraAI
#                       https://noma.security
#
# +-------------------------------------------------------------+
...
class NomaGuardrail(CustomGuardrail):
    """
    Noma Security Guardrail for DheeraAI
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._responses_transform_handler = DheeraAIResponsesTransformationHandler()
        ...
        self.default_application_id = "dheera_ai"
    ...
    async def _process_llm_response_check(
        ...
        if not isinstance(response, dheera_ai.ModelResponse):
            return None

        content = None
        for choice in response.choices:
            if isinstance(choice, dheera_ai.Choices) and choice.message.content:
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        from dheera_ai.types.proxy.guardrails.guardrail_hooks.noma import (
