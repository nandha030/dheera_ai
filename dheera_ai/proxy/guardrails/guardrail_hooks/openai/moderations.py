#!/usr/bin/env python3
"""
OpenAI Moderation Guardrail Integration for DheeraAI
"""
...
if TYPE_CHECKING:
    ...
    from dheera_ai.types.llms.openai import AllMessageValues, OpenAIModerationResponse
...
class OpenAIModerationGuardrail(OpenAIGuardrailBase, CustomGuardrail):
    """
    DheeraAI Built-in Guardrail for OpenAI Content Moderation.
    ...
    def get_config_model() -> Optional[Type["GuardrailConfigModel"]]:
        ...
        """
        from dheera_ai.types.proxy.guardrails.guardrail_hooks.openai.openai_moderation import (
