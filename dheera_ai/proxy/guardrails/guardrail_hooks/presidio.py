...
# |   https://github.com/BerriAI/dheera_ai/issues/  |
# +-----------------------------------------------+
#
...
import dheera_ai  # noqa: E401
from dheera_ai import get_secret
from dheera_ai._logging import verbose_proxy_logger
from dheera_ai.types.utils import GenericGuardrailAPIInputs
...
from dheera_ai.types.proxy.guardrails.guardrail_hooks.presidio import (
    PresidioAnalyzeRequest,
    PresidioAnalyzeResponseItem,
)
from dheera_ai.types.utils import GuardrailStatus
...
class _OPTIONAL_PresidioPIIMasking(CustomGuardrail):
    ...
    def validate_environment(
        ...
        self.presidio_anonymizer_api_base: Optional[
            str
        ] = presidio_anonymizer_api_base or dheera_ai.get_secret(
    ...
    async def async_post_call_success_hook(  # type: ignore
        ...
        if self.output_parse_pii is False and dheera_ai.output_parse_pii is False:
            return response
    ...
    def update_in_memory_dheera_ai_params(self, dheera_ai_params: LitellmParams) -> None:
        ...
        """
        super().update_in_memory_dheera_ai_params(dheera_ai_params)
        if dheera_ai_params.pii_entities_config:
            self.pii_entities_config = dheera_ai_params.pii_entities_config
        if dheera_ai_params.presidio_score_thresholds:
            self.presidio_score_thresholds = dheera_ai_params.presidio_score_thresholds
