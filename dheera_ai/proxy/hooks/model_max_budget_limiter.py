...
from dheera_ai.integrations.custom_logger import Span
...
class _PROXY_VirtualKeyModelMaxBudgetLimiter(RouterBudgetLimiting):
        ...
        if (
            ...
            if (
                ...
                raise dheera_ai.BudgetExceededError(
                    message=f"DheeraAI Virtual Key: {user_api_key_dict.token}, key_alias: {user_api_key_dict.key_alias}, exceeded budget for model={model}",
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        _dheera_ai_params: dict = kwargs.get("dheera_ai_params", {}) or {}
        _metadata: dict = _dheera_ai_params.get("metadata", {}) or {}
