...
from dheera_ai.constants import DYNAMIC_RATE_LIMIT_ERROR_THRESHOLD_PER_MINUTE
from dheera_ai.integrations.custom_logger import CustomLogger
from dheera_ai.proxy._types import UserAPIKeyAuth
from dheera_ai.proxy.auth.auth_utils import get_model_rate_limit_from_metadata
from dheera_ai.types.llms.openai import BaseDheeraAIOpenAIResponseObject
...
class _PROXY_MaxParallelRequestsHandler_v3(CustomLogger):
    def __init__(
        ...
        self.window_size = int(os.getenv("DHEERA_AI_RATE_LIMIT_WINDOW_SIZE", 60))
        ...
        try:
            ...
            for deployment in model_list:
                ...
                failure_count = get_deployment_failures_for_current_minute(
                    dheera_ai_router_instance=llm_router,
    ...
    async def async_pre_call_hook(
        ...
        if descriptors:
            ...
            if response["overall_code"] == "OVER_LIMIT":
                ...
                data["dheera_ai_proxy_rate_limit_response"] = response
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            # 'metadata' and 'dheera_ai_metadata' fields from dheera_ai_params
            ...
            if isinstance(response_obj, ModelResponse) or isinstance(
                response_obj, BaseDheeraAIOpenAIResponseObject
            ):
    ...
    async def async_post_call_success_hook(
        ...
        try:
            ...
            dheera_ai_proxy_rate_limit_response = cast(
                Optional[RateLimitResponse],
                data.get("dheera_ai_proxy_rate_limit_response", None),
            )

            if dheera_ai_proxy_rate_limit_response is not None:
                ...
                if _hidden_params is not None and (
                    ...
                    for status in dheera_ai_proxy_rate_limit_response["statuses"]:
