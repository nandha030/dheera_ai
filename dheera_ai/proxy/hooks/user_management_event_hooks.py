"""
Hooks that are triggered when a dheera_ai user event occurs
"""
...
class UserManagementEventHooks:
    ...
    async def async_user_created_hook(
        ...
        """
        This hook is called when a new user is created on dheera_ai
    ...
    async def async_send_user_invitation_email(
        ...
        event = WebhookEvent(
            ...
            event_message="Welcome to DheeraAI Proxy",
        ...
        if use_enterprise_email_hooks:
            initialized_email_loggers = dheera_ai.logging_callback_manager.get_custom_loggers_for_type(
    ...
    async def create_internal_user_audit_log(
        ...
        """
        if not dheera_ai.store_audit_logs:
            return
