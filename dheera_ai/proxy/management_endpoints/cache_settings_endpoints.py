...
from dheera_ai.types.management_endpoints import (
    ...
    async def init_cache_settings_in_db(prisma_client, proxy_config):
        ...
        try:
            ...
            verbose_proxy_logger.exception(
                "dheera_ai.proxy.management_endpoints.cache_settings_endpoints.py::CacheSettingsManager::init_cache_settings_in_db - {}".format(
                    str(e)
                )
            )
...
async def update_cache_settings(
    ...
    2. Saves to DheeraAI_CacheConfig table
