...
class ScimTransformations:
    ...
    @staticmethod
    async def transform_dheera_ai_user_to_scim_user(
        user: Union[DheeraAI_UserTable, NewUserResponse],
    ) -> SCIMUser:
    ...
    @staticmethod
    def _get_scim_user_name(user: Union[DheeraAI_UserTable, NewUserResponse]) -> str:
        """
    ...
    @staticmethod
    def _get_scim_family_name(user: Union[DheeraAI_UserTable, NewUserResponse]) -> str:
        """
        SCIM requires a family name with length > 0
        """
        metadata = user.metadata or {}
        if "scim_metadata" in metadata:
            scim_metadata: DheeraAI_UserScimMetadata = DheeraAI_UserScimMetadata(
    ...
    @staticmethod
    def _get_scim_given_name(user: Union[DheeraAI_UserTable, NewUserResponse]) -> str:
        """
    ...
    @staticmethod
    async def transform_dheera_ai_team_to_scim_group(
        team: Union[DheeraAI_TeamTable, dict],
    ) -> SCIMGroup:
        from dheera_ai.proxy.proxy_server import prisma_client
