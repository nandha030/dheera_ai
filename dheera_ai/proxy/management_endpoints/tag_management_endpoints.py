...
from dheera_ai.proxy.management_helpers.utils import handle_budget_for_entity
from dheera_ai.types.tag_management import (
    DheeraAI_DailyTagSpendTable,
    TagConfig,
    TagDeleteRequest,
    TagInfoRequest,
    TagNewRequest,
...
async def get_deployments_by_model(
    ...
    return [
        Deployment(
            ...
            dheera_ai_params=DheeraAI_Params(**deployment["dheera_ai_params"]),  # type: ignore
...
async def _add_tag_to_deployment(deployment: "Deployment", tag: str):
    ...
    dheera_ai_params = deployment.dheera_ai_params
    if "tags" not in dheera_ai_params:
        dheera_ai_params["tags"] = []
...
async def info_tag(
    ...
    try:
        ...
        for tag_record in tag_records:
            ...
            if hasattr(tag_record, "dheera_ai_budget_table") and tag_record.dheera_ai_budget_table:
                tag_dict["dheera_ai_budget_table"] = tag_record.dheera_ai_budget_table
...
async def list_tags(
    ...
    try:
        ...
        dynamic_tags_list = [
            DheeraAI_DailyTagSpendTable(**dynamic_tag.model_dump())
