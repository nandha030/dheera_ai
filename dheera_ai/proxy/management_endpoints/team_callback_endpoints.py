...
async def add_team_callbacks(
    ...
    try:
        ...
        verbose_proxy_logger.exception(
            "dheera_ai.proxy.proxy_server.add_team_callbacks(): Exception occured - {}".format(
                str(e)
            )
        )
        raise ProxyException(
...
async def disable_team_logging(
    ...
    try:
        ...
        verbose_proxy_logger.error(
            f"dheera_ai.proxy.proxy_server.disable_team_logging(): Exception occurred - {str(e)}"
        )
...
async def get_team_callbacks(
    ...
    try:
        ...
        verbose_proxy_logger.error(
            "dheera_ai.proxy.proxy_server.get_team_callbacks(): Exception occurred - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
