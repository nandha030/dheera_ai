...
async def get_distinct_user_agent_tags(
    ...
    try:
        ...
        FROM "DheeraAI_DailyTagSpend" dts
...
async def get_daily_active_users(
    ...
    try:
        ...
        FROM "DheeraAI_DailyTagSpend" dts
        INNER JOIN "DheeraAI_VerificationToken" vt ON dts.api_key = vt.token
        {where_clause}
...
async def get_tag_summary(
    ...
    try:
        ...
        FROM "DheeraAI_DailyTagSpend" dts
        LEFT JOIN "DheeraAI_VerificationToken" vt ON dts.api_key = vt.token
        {where_clause}
        GROUP BY dts.tag
