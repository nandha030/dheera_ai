...
async def handle_update_object_permission_common(
    ...
    4. Upserts to the DheeraAI_ObjectPermissionTable
    ...
    # We need to update the entity at the object_permission_id level in the DheeraAI_ObjectPermissionTable
    #########################################################
...
async def _set_object_permission(
    ...
    """
    Creates the DheeraAI_ObjectPermissionTable record for the key/team.
