...
import dheera_ai
from dheera_ai import CreateFileRequest, get_secret_str
...
from dheera_ai.proxy.utils import ProxyLogging, is_known_model
...
async def route_create_file(
    ...
    if model is not None:
        ...
        response = await dheera_ai.acreate_file(
    ...
    if (
        dheera_ai.enable_loadbalancing_on_batch_endpoints is True
        and is_router_model
        ...
        response = await dheera_ai.acreate_file(**_create_file_request, custom_llm_provider=custom_llm_provider)  # type: ignore
...
async def create_file(  # noqa: PLR0915
    ...
    dheera_ai_metadata: Optional[str] = Form(default=None),
    ...
    try:
        ...
        # Add dheera_ai_metadata to data if provided (from form field)
        if dheera_ai_metadata is not None:
            data["dheera_ai_metadata"] = dheera_ai_metadata
        ...
        if dheera_ai.enable_loadbalancing_on_batch_endpoints is True:
        ...
        verbose_proxy_logger.exception(
            "dheera_ai.proxy.proxy_server.create_file(): Exception occured - {}".format(
                str(e)
            )
        )
...
async def get_file_content(  # noqa: PLR0915
    ...
    try:
        ...
        ## check if file_id is a dheera_ai managed file
        ...
        if is_base64_unified_file_id:
            ...
            if should_route:
                ...
                response = await dheera_ai.afile_content(
        ...
        verbose_proxy_logger.exception(
            "dheera_ai.proxy.proxy_server.retrieve_file_content(): Exception occured - {}".format(
                str(e)
            )
        )
...
async def get_file(
    ...
    try:
        ...
        if should_route:
            ...
            response = await dheera_ai.afile_retrieve(**data)  # type: ignore
        ...
        ## EXISTING: check if file_id is a dheera_ai managed file
            ...
            response = await dheera_ai.afile_retrieve(
        ...
        verbose_proxy_logger.error(
            "dheera_ai.proxy.proxy_server.retrieve_file(): Exception occured - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
...
async def delete_file(
    ...
    try:
        ...
        if should_route:
            ...
            response = await dheera_ai.afile_delete(**data)  # type: ignore
        ...
        ## EXISTING: check if file_id is a dheera_ai managed file
            ...
            response = await dheera_ai.afile_delete(
                custom_llm_provider=custom_llm_provider, file_id=file_id, **data  # type: ignore
            )
        ...
        verbose_proxy_logger.exception(
            "dheera_ai.proxy.proxy_server.delete_file(): Exception occured - {}".format(
                str(e)
            )
        )
        if isinstance(e, HTTPException):
...
async def list_files(
    ...
    try:
        ...
        if should_route:
            ...
            response = await dheera_ai.afile_list(
                custom_llm_provider=credentials["custom_llm_provider"],  # type: ignore
                purpose=purpose,
                **data  # type: ignore
            )
        ...
        verbose_proxy_logger.error(
            "dheera_ai.proxy.proxy_server.list_files(): Exception occured - {}".format(
                str(e)
            )
        )
        verbose_proxy_logger.debug(traceback.format_exc())
