...
from dheera_ai.types.utils import LlmProviders, ModelResponse, TextCompletionResponse
...
class BasePassthroughLoggingHandler(ABC):
    ...
    def passthrough_chat_handler(
        ...
        **kwargs,
        ...
        dheera_ai_model_response: ModelResponse = provider_config.transform_response(
