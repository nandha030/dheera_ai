...
class GeminiPassthroughLoggingHandler:
    ...
    def gemini_passthrough_handler(
        ...
        **kwargs,
        ...
        if "predictLongRunning" in url_route:
            ...
            dheera_ai_video_response = gemini_video_config.transform_video_create_response(
                model=model,
        ...
        if "generateContent" in url_route:
            ...
            instance_of_gemini_llm = dheera_ai.GoogleAIStudioGeminiConfig()
            dheera_ai_model_response: ModelResponse = instance_of_gemini_llm.transform_response(
                model=model,
    ...
    def _handle_logging_gemini_collected_chunks(
        ...
        """
        Takes raw chunks from Gemini passthrough endpoint and logs them in dheera_ai callbacks
    ...
    def _build_complete_streaming_response(
        ...
        complete_streaming_response = dheera_ai.stream_chunk_builder(chunks=all_openai_chunks)
