...
from dheera_ai.types.utils import LlmProviders, ModelResponse, Usage
...
class VertexAILivePassthroughLoggingHandler(BasePassthroughLoggingHandler):
    ...
    def _create_usage_object_from_metadata(
        ...
        """
        Create a DheeraAI Usage object from Live API usage metadata.
    ...
    def vertex_ai_live_passthrough_handler(
        ...
        **kwargs,
        ...
        Args:
            websocket_messages: List of WebSocket messages from the Live API
            logging_obj: DheeraAI logging object
        ...
        try:
            ...
            # Create Usage object for standard DheeraAI logging
