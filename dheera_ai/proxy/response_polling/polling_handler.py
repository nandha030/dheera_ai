...
from dheera_ai.types.llms.openai import ResponsesAPIResponse, ResponsesAPIStatus


class ResponsePollingHandler:
    """Handles polling-based responses with Redis cache"""
    
    CACHE_KEY_PREFIX = "dheera_ai:polling:response:"
    POLLING_ID_PREFIX = "dheera_ai_poll_"  # Clear prefix to identify polling IDs
...
def should_use_polling_for_request(
    ...
    Args:
        ...
        llm_router: DheeraAI router instance for looking up model deployments
