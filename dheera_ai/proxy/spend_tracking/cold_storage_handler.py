...
class ColdStorageHandler:
    ...
    async def get_proxy_server_request_from_cold_storage_with_object_key(
        ...
        custom_logger: Optional[CustomLogger] = dheera_ai.logging_callback_manager.get_active_custom_logger_for_callback_name(custom_logger_name)
    ...
    def _select_custom_logger_for_cold_storage(
        ...
        cold_storage_custom_logger: Optional[_custom_logger_compatible_callbacks_literal] = dheera_ai.cold_storage_custom_logger
