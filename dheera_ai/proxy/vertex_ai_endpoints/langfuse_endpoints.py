...
"""
1. Create pass-through endpoints for any DHEERA_AI_BASE_URL/langfuse/<endpoint> map to LANGFUSE_BASE_URL/<endpoint>
"""
...
from dheera_ai.proxy.dheera_ai_pre_call_utils import _get_dynamic_logging_metadata
...
async def langfuse_proxy_route(
    ...
    langfuse_public_key = dynamic_langfuse_public_key or dheera_ai.utils.get_secret(
        secret_name="LANGFUSE_PUBLIC_KEY"
    )
    langfuse_secret_key = dynamic_langfuse_secret_key or dheera_ai.utils.get_secret(
