...
from dheera_ai.proxy.image_endpoints.endpoints import batch_to_bytesio
...
async def video_status(
    ...
    # This allows the router to automatically inject dheera_ai_params from the model config
