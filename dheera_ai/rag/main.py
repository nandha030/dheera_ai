...
from dheera_ai.rag.ingestion.gemini_ingestion import GeminiRAGIngestion
...
async def _execute_ingest_pipeline(
    ...
    Args:
        ...
        router: Optional DheeraAI router for load balancing
        ...
        response = await dheera_ai.aingest(
            ingest_options={
                "vector_store": {
                    ...
                    "dheera_ai_credential_name": "my-openai-creds",  # optional
                }
            },
