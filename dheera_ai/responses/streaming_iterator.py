...
from dheera_ai.dheera_ai_core_utils.core_helpers import process_response_headers
...
class BaseResponsesAPIStreamingIterator:
    ...
    def __init__(
        ...
        # set request kwargs
        self.dheera_ai_metadata = dheera_ai_metadata
        self.custom_llm_provider = custom_llm_provider

        # set hidden params for response headers (e.g., x-dheera_ai-model-id)
        # This matches ths stream wrapper in dheera_ai/dheera_ai_core_utils/streaming_handler.py
        ...
        _model_info: Dict = dheera_ai_metadata.get("model_info", {}) if dheera_ai_metadata else {}
        self._hidden_params = {
    ...
    def _process_chunk(self, chunk) -> Optional[ResponsesAPIStreamingResponse]:
        ...
        try:
            ...
            if isinstance(parsed_chunk, dict):
                ...
                # if "response" in parsed_chunk, then encode dheera_ai specific information like custom_llm_provider
