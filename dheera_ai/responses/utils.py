...
from dheera_ai.types.responses.main import DecodedResponseId
...
class ResponsesAPIRequestUtils:
    ...
    def get_optional_params_responses_api(
        ...
        """
        from dheera_ai.utils import _apply_openai_param_overrides
        ...
        ResponsesAPIRequestUtils._check_valid_arg(
            ...
            drop_params=dheera_ai.drop_params,
    ...
    def get_requested_response_api_optional_param(
        ...
        """
        from dheera_ai.utils import PreProcessNonDefaultParams
        ...
        # decode previous_response_id if it's a dheera_ai encoded id
    ...
    def _update_responses_api_response_id_with_model_id(
        ...
        model_info: Dict[str, Any] = dheera_ai_metadata.get("model_info", {}) or {}
    ...
    def _build_responses_api_response_id(
        ...
        assembled_id: str = str(
            SpecialEnums.DHEERA_AI_MANAGED_RESPONSE_COMPLETE_STR.value
    ...
    def _decode_responses_api_response_id(
        ...
        try:
            ...
            # Format: dheera_ai:custom_llm_provider:{};model_id:{};response_id:{}
            custom_llm_provider = None
            model_id = None
    ...
    def decode_previous_response_id_to_original_previous_response_id(
        ...
        Why?
            - DheeraAI encodes the `custom_llm_provider` and `model_id` into the `previous_response_id` this helps with maintaining session consistency when load balancing multiple deployments of the same model.
            - We cannot send the dheera_ai encoded b64 to the upstream llm api, hence we decode it to the original `previous_response_id`
