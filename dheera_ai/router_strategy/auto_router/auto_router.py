...
class AutoRouter(CustomLogger):
    ...
    def __init__(
        ...
        Args:
            ...
            dheera_ai_router_instance: The instance of the DheeraAI Router.
        """
        ...
        self.dheera_ai_router_instance: "Router" = dheera_ai_router_instance
    ...
    async def async_pre_routing_hook(
        ...
        from dheera_ai.router_strategy.auto_router.dheera_ai_encoder import (
            DheeraAIRouterEncoder,
        )
        from dheera_ai.types.router import PreRoutingHookResponse
        if messages is None:
        ...
        if self.routelayer is None:
            ...
            self.routelayer = SemanticRouter(
                    ...
                    encoder=DheeraAIRouterEncoder(
                        dheera_ai_router_instance=self.dheera_ai_router_instance,
