...
#   - use dheera_ai.input_callbacks to log when a request is just about to be made to a model - {"deployment-id": traffic}
#   - use dheera_ai.success + failure callbacks to log when a request completed
