...
from dheera_ai.dheera_ai_core_utils.core_helpers import safe_divide_seconds
from dheera_ai.dheera_ai_core_utils.core_helpers import _get_parent_otel_span_from_kwargs
from dheera_ai.types.utils import DheeraAIPydanticObjectBase
...
class LowestLatencyLoggingHandler(CustomLogger):
    ...
    def log_success_event(  # noqa: PLR0915
        ...
        try:
            ...
            if kwargs["dheera_ai_params"].get(metadata_field) is None:
                pass
            else:
                model_group = kwargs["dheera_ai_params"][metadata_field].get(
                    "model_group", None
                )
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if isinstance(_exception, dheera_ai.Timeout):
                if kwargs["dheera_ai_params"].get(metadata_field) is None:
                    pass
                else:
                    model_group = kwargs["dheera_ai_params"][metadata_field].get(
    ...
    async def async_log_success_event(  # noqa: PLR0915
        ...
        try:
            ...
            verbose_logger.exception(
                "dheera_ai.router_strategy.lowest_latency.py::async_log_success_event(): Exception occured - {}".format(
                    str(e)
                )
            )
            pass
