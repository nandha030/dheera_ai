...
class LowestTPMLoggingHandler(CustomLogger):
    ...
    def log_success_event(self, kwargs, response_obj, start_time, end_time):
        try:
            ...
            """
            if "dheera_ai_params" not in kwargs or kwargs["dheera_ai_params"] is None:
                return
            ...
            verbose_router_logger.error(
                "dheera_ai.router_strategy.lowest_tpm_rpm.py::async_log_success_event(): Exception occured - {}".format(
                    str(e)
                )
            )
