...
async def get_deployments_for_tag(
    ...
    metadata_variable_name: Literal["metadata", "dheera_ai_metadata"] = "metadata",
):
    """
    ...
    if metadata_variable_name in request_kwargs:
        ...
        if request_tags:
            ...
            for deployment in healthy_deployments:
                ...
                deployment_tags = deployment_dheera_ai_params.get("tags")
    ...
    for deployment in healthy_deployments:
        if "default" in deployment.get("dheera_ai_params", {}).get("tags", []):
...
def _get_tags_from_request_kwargs(
    ...
    elif "dheera_ai_params" in request_kwargs:
        dheera_ai_params = request_kwargs["dheera_ai_params"] or {}
        _metadata = dheera_ai_params.get(metadata_variable_name, {}) or {}
