...
from dheera_ai.types.llms.openai import FileTypes, OpenAIFilesPurpose
...
def _get_router_metadata_variable_name(function_name: Optional[str]) -> str:
    ...
    """
    ROUTER_METHODS_USING_DHEERA_AI_METADATA = set(
        [
            "batch",
            "generic_api_call",
            "_acreate_batch",
    ...
    if function_name and any(
        method in function_name for method in ROUTER_METHODS_USING_DHEERA_AI_METADATA
    ):
