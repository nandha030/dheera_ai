...
class PatternMatchRouter:
    ...
    def _return_pattern_matched_deployments(
        ...
        for deployment in deployments:
            ...
            new_deployment["dheera_ai_params"][
                "model"
            ] = PatternMatchRouter.set_deployment_model_name(
                matched_pattern=matched_pattern,
                dheera_ai_deployment_dheera_ai_model=deployment["dheera_ai_params"]["model"],
            )
    ...
    def set_deployment_model_name(
        ...
        dheera_ai_deployment_dheera_ai_model: str,
    ) -> str:
        """
        ...
        if "*" not in dheera_ai_deployment_dheera_ai_model:
            return dheera_ai_deployment_dheera_ai_model

        wildcard_count = dheera_ai_deployment_dheera_ai_model.count("*")
        ...
        # Replace the corresponding wildcards in the dheera_ai model pattern with extracted segments
        for segment in dynamic_segments:
            dheera_ai_deployment_dheera_ai_model = dheera_ai_deployment_dheera_ai_model.replace(
                "*", segment, 1
            )
