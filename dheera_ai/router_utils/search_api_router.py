...
class SearchAPIRouter:
    """
    Static utility class for routing search API calls through the DheeraAI router.
    ...
    async def update_router_search_tools(router_instance: Any, search_tools: list):
        ...
        """
        try:
            from dheera_ai.types.router import SearchToolTypedDict
            ...
            for tool in search_tools:
                ...
                router_search_tool: SearchToolTypedDict = {  # type: ignore
                    ...
                    "dheera_ai_params": tool.get("dheera_ai_params", {}),
    ...
    async def async_search_with_fallbacks(
        ...
        **kwargs,
        ...
        Args:
            router_instance: The Router instance
            original_function: The original dheera_ai.asearch function
        ...
        try:
            ...
            router_instance._update_kwargs_before_fallbacks(
                model=search_tool_name, kwargs=kwargs, metadata_variable_name="dheera_ai_metadata"
            )
            ...
            asyncio.create_task(
                send_llm_exception_alert(
                    dheera_ai_router_instance=router_instance,
    ...
    async def async_search_with_fallbacks_helper(
        ...
        **kwargs,
        ...
        Args:
            ...
            original_generic_function: The original dheera_ai.asearch function
        ...
        try:
            ...
            # Extract search provider and other params from dheera_ai_params
            dheera_ai_params = selected_tool.get("dheera_ai_params", {})
            search_provider = dheera_ai_params.get("search_provider")
            api_key = dheera_ai_params.get("api_key")
            api_base = dheera_ai_params.get("api_base")
            
            if not search_provider:
                raise ValueError(f"search_provider not found in dheera_ai_params for search tool '{search_tool_name}'")
