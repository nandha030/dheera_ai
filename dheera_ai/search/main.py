"""
Main Search function for DheeraAI.
"""
import asyncio
import contextvars
...
from dheera_ai.utils import ProviderConfigManager, client, filter_out_dheera_ai_params
...
def search(
    ...
    **kwargs,
    ...
    try:
        ...
        # Filter out internal DheeraAI parameters from kwargs
        filtered_kwargs = filter_out_dheera_ai_params(kwargs=kwargs)
