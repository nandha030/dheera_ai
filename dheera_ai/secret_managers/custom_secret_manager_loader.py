...
def load_custom_secret_manager(config_file_path: Optional[str] = None) -> None:
    ...
    if dheera_ai._key_management_settings is None:
        raise ValueError(
    ...
    custom_secret_manager_path = getattr(
        dheera_ai._key_management_settings, "custom_secret_manager", None
    )
    ...
    dheera_ai.secret_manager_client = _secret_manager_instance
