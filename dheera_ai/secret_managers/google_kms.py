...
Relevant issue: https://github.com/BerriAI/dheera_ai/issues/1235
...
def load_google_kms(use_google_kms: Optional[bool]):
    ...
    try:
        ...
        dheera_ai._key_management_system = KeyManagementSystem.GOOGLE_KMS
        dheera_ai._google_kms_resource_name = os.getenv("GOOGLE_KMS_RESOURCE_NAME")
