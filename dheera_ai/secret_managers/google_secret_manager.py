...
from dheera_ai.constants import SECRET_MANAGER_REFRESH_INTERVAL
from dheera_ai.integrations.gcs_bucket.gcs_bucket_base import GCSBucketBase
from dheera_ai.llms.custom_httpx.http_handler import _get_httpx_client
from dheera_ai.proxy._types import CommonProxyErrors, KeyManagementSystem
...
class GoogleSecretManager(GCSBucketBase):
    def __init__(
        ...
        dheera_ai.secret_manager_client = self
        dheera_ai._key_management_system = KeyManagementSystem.GOOGLE_SECRET_MANAGER
