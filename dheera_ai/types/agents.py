...
from dheera_ai.types.llms.base import DheeraAIPydanticObjectBase
...
class AgentConfig(TypedDict, total=False):
    ...
    dheera_ai_params: Dict[str, Any]  # allow for any future dheera_ai params
...
class DheeraAISendMessageResponse(DheeraAIPydanticObjectBase):
    """
    DheeraAI wrapper for A2A SendMessageResponse.

    Wraps the a2a SDK's SendMessageResponse with DheeraAI's _hidden_params
    ...
    # DheeraAI usage tracking
    usage: Optional[Dict[str, Any]] = None

    model_config = {"extra": "allow"}

    # DheeraAI private attributes for logging/cost tracking
    ...
    def from_a2a_response(
        ...
        """
        Create a DheeraAISendMessageResponse from an a2a SDK SendMessageResponse.

        Args:
            response: The a2a SDK SendMessageResponse

        Returns:
            DheeraAISendMessageResponse with _hidden_params support
        """
    ...
    @classmethod
    def from_dict(cls, response_dict: Dict[str, Any]) -> "DheeraAISendMessageResponse":
        """
        Create a DheeraAISendMessageResponse from a dict.
