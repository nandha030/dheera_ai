...
if TYPE_CHECKING:
    ...
    class GenerateContentResponse(GoogleGenAIGenerateContentResponse, BaseDheeraAIOpenAIResponseObject): # type: ignore[misc]
        _hidden_params: dict = {}
        pass
else:
    ...
    class GenerateContentResponse(BaseDheeraAIOpenAIResponseObject): # type: ignore[misc]
        def __init__(self, **kwargs):  # type: ignore
            super().__init__(**kwargs)
