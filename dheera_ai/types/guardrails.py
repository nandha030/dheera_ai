...
from dheera_ai.types.llms.openai import AllMessageValues, ChatCompletionToolCallChunk, ChatCompletionToolParam
from dheera_ai.types.llms.openai import (
    AllMessageValues,
    ChatCompletionToolCallChunk,
    ChatCompletionToolParam,
)
from dheera_ai.types.proxy.guardrails.guardrail_hooks.enkryptai import (
    EnkryptAIGuardrailConfigs,
)
from dheera_ai.types.proxy.guardrails.guardrail_hooks.grayswan import (
    GraySwanGuardrailConfigModel,
)
from dheera_ai.types.proxy.guardrails.guardrail_hooks.ibm import (
    IBMGuardrailsBaseConfigModel,
)
from dheera_ai.types.proxy.guardrails.guardrail_hooks.tool_permission import (
    ToolPermissionGuardrailConfigModel,
)

"""
Pydantic object defining how to set guardrails on dheera_ai proxy
...
class SupportedGuardrailIntegrations(Enum):
    ...
    DHEERA_AI_CONTENT_FILTER = "dheera_ai_content_filter"
    ONYX = "onyx"
...
class PresidioPresidioConfigModelUserInterface(BaseModel):
    """Configuration parameters for the Presidio PII masking guardrail on DheeraAI UI"""
    ...
    output_parse_pii: Optional[bool] = Field(
        default=None,
        description="When True, DheeraAI will replace the masked text with the original text in the response",
...
class NomaGuardrailConfigModel(BaseModel):
    ...
    application_id: Optional[str] = Field(
        default=None,
        description="Application ID for Noma Security. Defaults to 'dheera_ai' if not provided",
    )
...
class Guardrail(TypedDict, total=False):
    ...
    dheera_ai_params: Required[LitellmParams]
...
class GuardrailInfoResponse(BaseModel):
    ...
    guardrail_name: str
    dheera_ai_params: Optional[BaseLitellmParams] = None
