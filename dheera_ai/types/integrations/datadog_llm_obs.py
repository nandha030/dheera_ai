...
from dheera_ai.types.integrations.custom_logger import StandardCustomLoggerInitParams
...
class DatadogLLMObsInitParams(StandardCustomLoggerInitParams):
    """
    Params for initializing a DatadogLLMObs logger on dheera_ai
    """
...
class DDLLMObsLatencyMetrics(TypedDict, total=False):
    ...
    dheera_ai_overhead_time_ms: float
