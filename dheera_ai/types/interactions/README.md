...
datamodel-codegen \
    ...
    --output dheera_ai/types/interactions/generated.py \
    --output-model-type pydantic_v2.BaseModel \
    --target-python-version 3.9
```

Then add the Dheera AI-specific types at the bottom of the generated file:
...
**Response Types:**
- `InteractionsAPIResponse` - Dheera AI response wrapper
