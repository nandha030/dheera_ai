...
# ============================================================
# DheeraAI-specific types (added manually after generation)
# ============================================================
# 
...
class InteractionsAPIResponse(BaseDheeraAIOpenAIResponseObject):
    """
    Response from the Interactions API.
    
    Wraps the API response with DheeraAI-specific hidden params.
    """
...
class InteractionsAPIStreamingResponse(BaseDheeraAIOpenAIResponseObject):
    """
...
class DeleteInteractionResult(BaseDheeraAIOpenAIResponseObject):
...
class CancelInteractionResult(BaseDheeraAIOpenAIResponseObject):
