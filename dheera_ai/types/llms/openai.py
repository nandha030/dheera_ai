...
from dheera_ai.types.llms.base import BaseDheeraAIOpenAIResponseObject
...
class DheeraAIBatchCreateRequest(CreateBatchRequest, total=False):
    model: str
...
):  # dheera_ai wrapper on top of openai object for handling cached content
...
class ChatCompletionRequest(TypedDict, total=False):
    ...
    functions: List
    user: str
    metadata: dict  # dheera_ai specific param
...
class DheeraAIFineTuningJobCreate(FineTuningJobCreate):
...
class OutputTokensDetails(BaseDheeraAIOpenAIResponseObject):
...
class InputTokensDetails(BaseDheeraAIOpenAIResponseObject):
...
class ResponseAPIUsage(BaseDheeraAIOpenAIResponseObject):
    input_tokens: int
...
class ResponsesAPIResponse(BaseDheeraAIOpenAIResponseObject):
    id: str
    created_at: int
...
class ResponseCreatedEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_CREATED]
    response: ResponsesAPIResponse


class ResponseInProgressEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_IN_PROGRESS]
    response: ResponsesAPIResponse


class ResponseCompletedEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_COMPLETED]
    response: ResponsesAPIResponse
    _hidden_params: dict = PrivateAttr(default_factory=dict)


class ResponseFailedEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_FAILED]
    response: ResponsesAPIResponse


class ResponseIncompleteEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_INCOMPLETE]
    response: ResponsesAPIResponse


class ResponsePartAddedEvent(BaseDheeraAIOpenAIResponseObject):
...
class ReasoningSummaryTextDeltaEvent(BaseDheeraAIOpenAIResponseObject):
...
class OutputItemAddedEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_ADDED]
    output_index: int
    item: Optional[BaseDheeraAIOpenAIResponseObject]


class OutputItemDoneEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_DONE]
    output_index: int
    sequence_number: int = 1
    item: BaseDheeraAIOpenAIResponseObject
...
class ContentPartAddedEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.CONTENT_PART_ADDED]
    item_id: str
    output_index: int
    content_index: int
    part: BaseDheeraAIOpenAIResponseObject


class ContentPartDonePartOutputText(BaseDheeraAIOpenAIResponseObject):
    type: Literal["output_text"]
    text: str
    annotations: List[BaseDheeraAIOpenAIResponseObject]
    logprobs: Optional[List[OpenAIChatCompletionLogprobsContent]]


class ContentPartDonePartRefusal(BaseDheeraAIOpenAIResponseObject):
    type: Literal["refusal"]
    refusal: str


class ContentPartDonePartReasoningText(BaseDheeraAIOpenAIResponseObject):
...
class ContentPartDoneEvent(BaseDheeraAIOpenAIResponseObject):
...
class OutputTextDeltaEvent(BaseDheeraAIOpenAIResponseObject):
...
class OutputTextAnnotationAddedEvent(BaseDheeraAIOpenAIResponseObject):
...
class OutputTextDoneEvent(BaseDheeraAIOpenAIResponseObject):
...
class RefusalDeltaEvent(BaseDheeraAIOpenAIResponseObject):
...
class RefusalDoneEvent(BaseDheeraAIOpenAIResponseObject):
...
class FunctionCallArgumentsDeltaEvent(BaseDheeraAIOpenAIResponseObject):
...
class FunctionCallArgumentsDoneEvent(BaseDheeraAIOpenAIResponseObject):
...
class FileSearchCallInProgressEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class FileSearchCallSearchingEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class FileSearchCallCompletedEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class WebSearchCallInProgressEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class WebSearchCallSearchingEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class WebSearchCallCompletedEvent(BaseDheeraAIOpenAIResponseObject):
...
class MCPListToolsInProgressEvent(BaseDheeraAIOpenAIResponseObject):
...
class MCPListToolsCompletedEvent(BaseDheeraAIOpenAIResponseObject):
...
class MCPListToolsFailedEvent(BaseDheeraAIOpenAIResponseObject):
...
# MCP Call Events
class MCPCallInProgressEvent(BaseDheeraAIOpenAIResponseObject):
...
class MCPCallArgumentsDeltaEvent(BaseDheeraAIOpenAIResponseObject):
...
class MCPCallArgumentsDoneEvent(BaseDheeraAIOpenAIResponseObject):
...
class MCPCallCompletedEvent(BaseDheeraAIOpenAIResponseObject):
...
class MCPCallFailedEvent(BaseDheeraAIOpenAIResponseObject):
...
class ImageGenerationPartialImageEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.IMAGE_GENERATION_PARTIAL_IMAGE]
    partial_image_index: int
    b64_json: str


class ErrorEventError(BaseDheeraAIOpenAIResponseObject):
...
class ErrorEvent(BaseDheeraAIOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.ERROR]
    sequence_number: int
    error: ErrorEventError


class GenericEvent(BaseDheeraAIOpenAIResponseObject):
    type: str
...
ResponsesAPIStreamingResponse = Annotated[
    Union[
        ...
        ErrorEvent,
        GenericEvent,
        BaseDheeraAIOpenAIResponseObject,
    ],
    Discriminator("type"),
]
...
class OpenAIModerationResult(BaseDheeraAIOpenAIResponseObject):
...
class OpenAIModerationResponse(BaseDheeraAIOpenAIResponseObject):
    """
