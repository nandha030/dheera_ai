...
class DheeraAI_UpperboundKeyGenerateParams(DheeraAIPydanticObjectBase):
    """
...
class AccessControl_UI_AccessMode(DheeraAIPydanticObjectBase):
...
class SSOConfig(DheeraAIPydanticObjectBase):
    """
...
class DefaultTeamSSOParams(DheeraAIPydanticObjectBase):
    """
    Default parameters to apply when a new team is automatically created by DheeraAI via SSO Groups
    """
