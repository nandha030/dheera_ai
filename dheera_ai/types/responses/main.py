...
class GenericResponseOutputItemContentAnnotation(BaseDheeraAIOpenAIResponseObject):
...
class OutputText(BaseDheeraAIOpenAIResponseObject):
...
class OutputFunctionToolCall(BaseDheeraAIOpenAIResponseObject):
...
class OutputImageGenerationCall(BaseDheeraAIOpenAIResponseObject):
...
class GenericResponseOutputItem(BaseDheeraAIOpenAIResponseObject):
    """
...
class DeleteResponseResult(BaseDheeraAIOpenAIResponseObject):
    """
