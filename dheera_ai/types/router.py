"""
dheera_ai.Router Types - includes RouterConfig, UpdateRouterConfig, ModelInfo etc
"""
...
from .utils import CustomPricingDheeraAIParams, ModelResponse
...
class ModelConfig(BaseModel):
    model_name: str
    dheera_ai_params: Union[CompletionRequest, EmbeddingRequest]
    tpm: int
    rpm: int
...
class RouterConfig(BaseModel):
    ...
    default_dheera_ai_params: Optional[Dict[str, str]] = {}
...
class CredentialDheeraAIParams(BaseModel):
...
class GenericDheeraAIParams(CredentialDheeraAIParams, CustomPricingDheeraAIParams):
    """
    DheeraAI Params without 'model' arg (used across completion / assistants api)
    """
    ...
    dheera_ai_credential_name: Optional[str] = None
    ...
    use_dheera_ai_proxy: Optional[bool] = False
    ...
    def __init__(
        ...
        # Pass through params
        use_in_pass_through: Optional[bool] = False,
        # Dynamic param to force using dheera_ai proxy
        use_dheera_ai_proxy: Optional[bool] = False,
        ...
        **params,
        ...
        # We need to keep max_retries in args since it's a parameter of GenericDheeraAIParams
        args["max_retries"] = (
...
class DheeraAI_Params(GenericDheeraAIParams):
    """
    DheeraAI Params with 'model' requirement - used for completions
    """
    ...
    def __init__(
        ...
        # set a max-size of file that can be passed to dheera_ai proxy
        max_file_size_mb: Optional[float] = None,
...
class updateDheeraAIParams(GenericDheeraAIParams):
    # This class is used to update the DheeraAI_Params
...
class updateDeployment(BaseModel):
    ...
    dheera_ai_params: Optional[updateDheeraAIParams] = None
    model_info: Optional[ModelInfo] = None

    model_config = ConfigDict(protected_namespaces=())


class DheeraAIParamsTypedDict(TypedDict, total=False):
    model: str
...
class DeploymentTypedDict(TypedDict, total=False):
    ...
    dheera_ai_params: Required[DheeraAIParamsTypedDict]
    model_info: dict
    ...
    def __init__(
        ...
        **params,
        ...
        for (
            ...
            field = getattr(dheera_ai_params, key, None)
...
class SearchToolDheeraAIParams(TypedDict, total=False):
    """
    DheeraAI params for search tools.
...
class DheeraAI_RouterFileObject(TypedDict, total=False):
    """
    Tracking the dheera_ai params hash, used for mapping the file id to the right model
    """

    dheera_ai_params_sensitive_credential_hash: str
