...
class KeyManagementSettings(DheeraAIPydanticObjectBase):
    hosted_keys: Optional[List] = None
    store_virtual_keys: Optional[bool] = False
    """
    If True, virtual keys created by dheera_ai will be stored in the secret manager
    """
    prefix_for_stored_virtual_keys: str = "dheera_ai/"
    """
