...
class DheeraAI_VectorStoreConfig(TypedDict, total=False):
...
class DheeraAI_ManagedVectorStore(TypedDict, total=False):
    """DheeraAI managed vector store object - this is is the object stored in the database"""
...
class DheeraAI_ManagedVectorStoreListResponse(TypedDict, total=False):
    """Response format for listing vector stores"""

    object: Literal["list"]  # Always "list"
    data: List[DheeraAI_ManagedVectorStore]
...
class IndexCreateDheeraAIParams(BaseModel):
...
class IndexCreateRequest(BaseModel):
    index_name: str
    dheera_ai_params: IndexCreateDheeraAIParams
...
class DheeraAI_ManagedVectorStoreIndex(BaseModel):
    """DheeraAI managed vector store index object - this is is the object stored in the database"""
