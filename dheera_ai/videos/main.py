...
import dheera_ai
from dheera_ai.constants import DEFAULT_VIDEO_ENDPOINT_MODEL
...
from dheera_ai.types.utils import CallTypes, FileTypes
from dheera_ai.types.videos.main import (
    VideoCreateOptionalRequestParams,
    VideoObject,
)
from dheera_ai.types.videos.utils import decode_video_id_with_provider
...
def video_generation(  # noqa: PLR0915
    ...
    **kwargs,
    ...
    try:
        ...
        dheera_ai_logging_obj.call_type = CallTypes.create_video.value
...
def video_remix(  # noqa: PLR0915
    ...
    **kwargs,
    ...
    try:
        ...
        dheera_ai_logging_obj.call_type = CallTypes.video_remix.value
...
def video_list(  # noqa: PLR0915
    ...
    **kwargs,
    ...
    try:
        ...
        dheera_ai_logging_obj.call_type = CallTypes.video_list.value
...
def video_status(  # noqa: PLR0915
    ...
    **kwargs,
    ...
    Example:
        ...
        # Get video status
        video_status = dheera_ai.video_status(
            video_id="video_123"
        )
    ...
    try:
        ...
        dheera_ai_logging_obj.call_type = CallTypes.video_retrieve.value
