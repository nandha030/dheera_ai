...
```python
dheera_ai.callbacks = ["openmeter"] # logs cost + usage of successful calls to openmeter
```
...
# set openmeter as a callback, dheera_ai will send the data to openmeter
dheera_ai.callbacks = ["openmeter"] 
