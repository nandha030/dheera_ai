...
DHEERA_AI_VIRTUAL_KEY = "sk-1234" # <your-virtual-key>
DHEERA_AI_PROXY_BASE_URL = "http://0.0.0.0:4000/assemblyai" # <your-proxy-base-url>/assemblyai

aai.settings.api_key = f"Bearer {DHEERA_AI_VIRTUAL_KEY}"
aai.settings.base_url = DHEERA_AI_PROXY_BASE_URL
...
If you want to send your request to the Assembly AI EU endpoint, you can do so by setting the `DHEERA_AI_PROXY_BASE_URL` to `<your-proxy-base-url>/eu.assemblyai`
...
DHEERA_AI_VIRTUAL_KEY = "sk-1234" # <your-virtual-key>
DHEERA_AI_PROXY_BASE_URL = "http://0.0.0.0:4000/eu.assemblyai" # <your-proxy-base-url>/eu.assemblyai
