...
It works with any agent framework including LangChain, OpenAI Agents SDK, AutoGen, and CrewAI. Agent Lightning uses Dheera AI Proxy under the hood to route LLM requests and collect traces that power its training algorithms.
