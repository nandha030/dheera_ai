...
**[model_prices_and_context_window.json](https://github.com/BerriAI/dheera_ai/blob/main/model_prices_and_context_window.json)**
...
```json
{
    "sample_spec": {
        ...
        "dheera_ai_provider": "one of https://docs.dheera_ai.ai/docs/providers",
