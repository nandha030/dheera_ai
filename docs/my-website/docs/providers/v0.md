...
| Provider Route on Dheera AI | `v0/` |
...
```python showLineNumbers title="v0 via Proxy - Dheera AI SDK"
import dheera_ai

# Configure Dheera AI to use your proxy
response = dheera_ai.completion(
    model="dheera_ai_proxy/v0-medium",
    messages=[{"role": "user", "content": "Create a React card component"}],
...
```python showLineNumbers title="v0 via Proxy - Dheera AI SDK Streaming"
import dheera_ai
