...
- `v1.x.x.rc`: These are releases which pass ci/cd + [manual review](https://github.com/BerriAI/dheera_ai/discussions/8495#discussioncomment-12180711).
...
Follow our release notes [here](https://github.com/BerriAI/dheera_ai/releases).


## FAQ

### Is there a release schedule for Dheera AI stable release?
