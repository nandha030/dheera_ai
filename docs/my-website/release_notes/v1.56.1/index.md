...
**[Start here](https://docs.dheera_ai.ai/docs/proxy/rate_limit_tiers)**
...
Dheera AI was double logging dheera_ai_request span. This is now fixed.

[Relevant PR](https://github.com/BerriAI/dheera_ai/pull/7435)
...
**Start Here:**
- [Setup Finetuning](https://docs.dheera_ai.ai/docs/fine_tuning)
- [Setup Logging](https://docs.dheera_ai.ai/docs/proxy/logging#datadog)
...
[See guardrails spec for more details](https://docs.dheera_ai.ai/docs/proxy/guardrails/custom_guardrail#-pass-additional-parameters-to-guardrail)
