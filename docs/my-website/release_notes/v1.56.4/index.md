...
New Speech to Text support for Deepgram models. [**Start Here**](https://docs.dheera_ai.ai/docs/providers/deepgram)
...
- (Security fix) Upgrade to `fastapi==0.115.5` https://github.com/BerriAI/dheera_ai/pull/7447

## Bug Fixes

- Add health check support for realtime models [Here](https://docs.dheera_ai.ai/docs/proxy/health#realtime-models)
- Health check error with audio_transcription model https://github.com/BerriAI/dheera_ai/issues/5999
