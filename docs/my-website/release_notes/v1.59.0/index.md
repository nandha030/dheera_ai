...
Once this flag is enabled, your `messages` and `responses` will be stored in the `Dheera AI_Spend_Logs` table.
...
Added `messages` and `responses` to the `Dheera AI_Spend_Logs` table.
