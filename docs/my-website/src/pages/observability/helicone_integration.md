...
- Set helicone as your base url via: `dheera_ai.api_url` 
- Pass in helicone request headers via: `dheera_ai.headers` 
...
dheera_ai.api_base = "https://oai.hconeai.com/v1"
dheera_ai.headers = {"Helicone-Auth": f"Bearer {os.getenv('HELICONE_API_KEY')}"}
