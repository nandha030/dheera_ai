...
from dheera_ai_enterprise.types.proxy.audit_logging_endpoints import (
    AuditLogResponse,
...
async def get_audit_logs(
    ...
    audit_logs = await prisma_client.db.dheera_ai_auditlog.find_many(
    ...
    total_count = await prisma_client.db.dheera_ai_auditlog.count(where=where_conditions)
...
async def get_audit_log_by_id(
    ...
    audit_log = await prisma_client.db.dheera_ai_auditlog.find_unique(where={"id": id})
