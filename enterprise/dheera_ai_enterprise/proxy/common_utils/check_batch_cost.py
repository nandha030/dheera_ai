"""
Polls DheeraAI_ManagedObjectTable to check if the batch job is complete, and if the cost has been tracked.
"""
...
class CheckBatchCost:
    ...
    async def check_batch_cost(self):
        ...
        - if so, return True
        """
        from dheera_ai_enterprise.proxy.hooks.managed_files import (
            _PROXY_DheeraAIManagedFiles,
        )
        ...
        jobs = await self.prisma_client.db.dheera_ai_managedobjecttable.find_many(
            where={
                "status": "validating",
                "file_purpose": "batch",
            }
        ...
        for job in jobs:
            ...
            managed_files_obj = cast(
                Optional[_PROXY_DheeraAIManagedFiles],
            ...
            if (
                ...
                if deployment_info is None:
                    ...
                    continue
                custom_llm_provider = deployment_info.dheera_ai_params.custom_llm_provider
                dheera_ai_model_name = deployment_info.dheera_ai_params.model
            ...
            if len(completed_jobs) > 0:
                ...
                await self.prisma_client.db.dheera_ai_managedobjecttable.update_many(
