...
from dheera_ai.proxy.management_endpoints.internal_user_endpoints import user_api_key_auth
...
async def available_enterprise_users(
    ...
    """
    from dheera_ai.proxy._types import CommonProxyErrors, EnterpriseLicenseData
    ...
    # Count number of rows in DheeraAI_UserTable
    user_count = await prisma_client.db.dheera_ai_usertable.count()
    team_count = await prisma_client.db.dheera_ai_teamtable.count()
