...
from dheera_ai.types.utils import Embedding
from dheera_ai.main import bedrock_embedding, embedding, EmbeddingResponse, Usage
...
def test_bedrock_embedding_cohere_app_profile(model: str):
    with patch("dheera_ai.llms.bedrock.embed.embedding.cohere_embedding") as mock_cohere_embedding:
