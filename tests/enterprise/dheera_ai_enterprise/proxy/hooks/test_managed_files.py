...
def test_get_file_ids_from_messages():
    proxy_managed_files = _PROXY_DheeraAIManagedFiles(
...
async def test_async_pre_call_hook_batch_retrieve():
    ...
    prisma_client.db.dheera_ai_managedobjecttable.find_first.return_value = return_value
    proxy_managed_files = _PROXY_DheeraAIManagedFiles(
...
#     proxy_managed_files = _PROXY_DheeraAIManagedFiles(DualCache())
...
async def test_async_post_call_success_hook_for_unified_finetuning_job():
    ...
    provider_ft_job = DheeraAIFineTuningJob(
    ...
    assert isinstance(response, DheeraAIFineTuningJob)
...
async def test_can_user_call_unified_file_id(call_type):
    ...
    return_value = MagicMock()
    return_value.created_by = "123"
    prisma_client.db.dheera_ai_managedfiletable.find_first.return_value = return_value
    proxy_managed_files = _PROXY_DheeraAIManagedFiles(
...
async def test_router_acreate_batch_only_selects_from_file_id_mapping(monkeypatch):
    ...
    with patch.object(
        dheera_ai, "acreate_batch", return_value=AsyncMock()
...
async def test_output_file_id_for_batch_retrieve():
    ...
    batch._hidden_params = {
        "dheera_ai_call_id": "dcd789e0-c0ad-4244-9564-4e611448d650",
        "api_base": "https://api.openai.com",
        "model_id": "12345679",
        "response_cost": 0.0,
        "additional_headers": {},
        "dheera_ai_model_name": "gpt-4o",
        "unified_batch_id": "dheera_ai_proxy;model_id:12345679;llm_batch_id:batch_685c5e5d63988190b85bdb2147ba131d",
    }
    proxy_managed_files = _PROXY_DheeraAIManagedFiles(
    ...
    assert not cast(DheeraAIBatch, response).output_file_id.startswith("file-")
...
async def test_async_post_call_success_hook_twice_assert_no_unique_violation():
    ...
    with patch('asyncio.create_task') as mock_create_task:
        ...
        if tasks:
            ...
            assert isinstance(response, DheeraAIBatch)
            assert _is_base64_encoded_unified_file_id(response.id)
...
def test_update_responses_input_with_unified_file_id():
    ...
    # This decodes to: dheera_ai_proxy:application/pdf;unified_id,6c0b5890-8914-48e0-b8f4-0ae5ed3c14a5;target_model_names,gpt-4o;llm_output_file_id,file-ECBPW7ML9g7XHdwGgUPZaM;llm_output_file_model_id,e26453f9e76e7993680d0068d98c1f4cc205bbad0967a33c664893568ca743c2
