"""
Uses dheera_ai.Router, ensures router.completion and router.acompletion pass BaseLLMChatTest
"""
...
class TestRouterLLMTranslation(BaseLLMChatTest):
    ...
    def completion_function(self):
        return self.dheera_ai_router.completion

    @property
    def async_completion_function(self):
        return self.dheera_ai_router.acompletion
