...
#     response = await dheera_ai.aembedding(model="ollama/mistral", input=input)
#     print(response)
...
#     dheera_ai.set_verbose = True
#     input = "The food was delicious and the waiter..."
#     response = dheera_ai.embedding(model="ollama/mistral", input=input)
#     print(response)
...
#             }
#         ]
#         response = dheera_ai.completion(model="ollama/mistral",
#                                              messages=messages,
#                                              functions=functions,
#                                              stream=True)
...
#     try:
#         dheera_ai.set_verbose = False
#         response = await dheera_ai.acompletion(model="ollama/mistral-openorca",
...
#     params = {
#         "messages": prepare_messages_for_chat("What is dheera_ai? tell me 10 things about it who is sihaan.write an essay"),
#         "api_base": "http://localhost:11434",
#         "model": "ollama/llama2",
#         "stream": True,
#     }
