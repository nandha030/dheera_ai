...
DHEERA_AI_BASE_URL = "http://0.0.0.0:4000"
DHEERA_AI_PROXY_API_KEY = "sk-1234"

client = openai.OpenAI(api_key=DHEERA_AI_PROXY_API_KEY, base_url=DHEERA_AI_BASE_URL)
...
create_cache = httpx_client.post(
    url=f"{DHEERA_AI_BASE_URL}/vertex-ai/cachedContents",
    headers={"Authorization": f"Bearer {DHEERA_AI_PROXY_API_KEY}"},
    json={
