...
def test_qdrant_semantic_cache_initialization(monkeypatch):
    ...
    with patch("dheera_ai.llms.custom_httpx.http_handler._get_httpx_client") as mock_sync_client, \
         patch("dheera_ai.llms.custom_httpx.http_handler.get_async_httpx_client") as mock_async_client:
        ...
        from dheera_ai.caching.qdrant_semantic_cache import QdrantSemanticCache
