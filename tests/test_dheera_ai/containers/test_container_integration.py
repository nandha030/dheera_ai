...
import dheera_ai
from dheera_ai.types.containers.main import ContainerObject, ContainerListResponse, DeleteContainerResult
from dheera_ai.containers.main import (
...
class TestContainerIntegration:
    ...
    @patch('dheera_ai.llms.custom_httpx.llm_http_handler.HTTPHandler')
    def test_container_create_full_flow(self, mock_http_handler):
        ...
        with patch('dheera_ai.llms.custom_httpx.llm_http_handler._get_httpx_client') as mock_get_client:
    ...
    @pytest.mark.asyncio
    @patch('dheera_ai.llms.custom_httpx.llm_http_handler.AsyncHTTPHandler')
    async def test_async_container_create_full_flow(self, mock_async_http_handler):
        ...
        with patch('dheera_ai.llms.custom_httpx.llm_http_handler.get_async_httpx_client') as mock_get_async_client:
    ...
    def test_container_workflow_simulation(self):
        ...
        with patch('dheera_ai.containers.main.base_llm_http_handler') as mock_handler:
    ...
    def test_error_handling_integration(self):
        ...
        with patch('dheera_ai.containers.main.base_llm_http_handler') as mock_handler:
            ...
            mock_handler.container_create_handler.side_effect = dheera_ai.APIError(
                status_code=400,
