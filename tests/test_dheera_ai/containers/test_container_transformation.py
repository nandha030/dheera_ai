...
class TestOpenAIContainerTransformation:
    ...
    def setup_method(self):
        ...
        self.logging_obj = DheeraAILogging(
            model="",
            messages=[],
            stream=False,
    ...
    def test_map_openai_params_basic(self):
        ...
        from dheera_ai.types.containers.main import ContainerCreateOptionalRequestParams
    ...
    def test_container_create_response_includes_cost(self):
        ...
        assert "llm_provider-x-dheera_ai-response-cost" in container._hidden_params["additional_headers"]
        ...
        actual_cost = container._hidden_params["additional_headers"]["llm_provider-x-dheera_ai-response-cost"]
