...
from dheera_ai.types.mcp import MCPStdioConfig, MCPTransport
...
class TestMCPClient:
    ...
    @pytest.mark.asyncio
    @patch("dheera_ai.experimental_mcp_client.client.stdio_client")
    ...
    async def test_mcp_client_ssl_configuration_from_env(
        ...
        # Mock the session
        with patch(
            "dheera_ai.experimental_mcp_client.client.ClientSession"
        ) as mock_session:
            mock_session_instance = MagicMock()
    ...
    @pytest.mark.asyncio
    @patch("dheera_ai.experimental_mcp_client.client.sse_client")
