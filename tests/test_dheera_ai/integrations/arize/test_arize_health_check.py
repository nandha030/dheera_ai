...
class TestArizeIntegrationWithProxy:
    """Test Arize integration with DheeraAI completion requests."""
    ...
    async def test_arize_logging_with_completion(self):
        ...
        with patch.dict(os.environ, {
            ...
            original_callbacks = dheera_ai.success_callback.copy() if dheera_ai.success_callback else []
            
            try:
                # Add ArizeLogger to callbacks
                dheera_ai.success_callback = [arize_logger]
                ...
                dheera_ai.success_callback = original_callbacks
