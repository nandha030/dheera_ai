...
import dheera_ai
from dheera_ai.integrations._types.open_inference import (
    MessageAttributes,
    SpanAttributes,
    ToolCallAttributes,
)
...
from dheera_ai.types.utils import Choices, StandardCallbackDynamicParams
...
def test_arize_set_attributes_responses_api():
    ...
    """
    from unittest.mock import MagicMock
    from dheera_ai.types.llms.openai import ResponsesAPIResponse, ResponseAPIUsage, OutputTokensDetails
...
async def test_arize_dynamic_params():
    ...
    dheera_ai.callbacks = [test_arize_logger]
