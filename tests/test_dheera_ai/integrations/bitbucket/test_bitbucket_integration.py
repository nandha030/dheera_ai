...
def test_bitbucket_prompt_integration_with_dheera_ai(mock_client_class):
    """Test BitBucket prompt integration with DheeraAI completion."""
...
User: {{user_message}}"""
    ...
    assert dheera_ai.global_bitbucket_config == bitbucket_config
