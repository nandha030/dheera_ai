...
from dheera_ai.integrations.bitbucket.bitbucket_client import BitBucketClient
...
@patch("dheera_ai.integrations.bitbucket.bitbucket_prompt_manager.BitBucketClient")
...
def test_bitbucket_prompt_manager_pre_call_hook():
    ...
    # Should have updated dheera_ai_params
...
def test_bitbucket_prompt_manager_pre_call_hook_no_prompt_id():
    ...
    assert result_params == dheera_ai_params
