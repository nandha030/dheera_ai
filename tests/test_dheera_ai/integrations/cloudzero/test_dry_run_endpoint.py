...
class TestCloudZeroDryRunEndpoint:
    ...
    async def test_dry_run_export_usage_data_returns_data(self):
        ...
        mock_cbf_data = pl.DataFrame({
            ...
            'resource/account': ['dheera_ai', 'dheera_ai'],
        ...
        with patch('dheera_ai.integrations.cloudzero.database.DheeraAIDatabase') as mock_db_class, \
             patch('dheera_ai.integrations.cloudzero.transform.CBFTransformer') as mock_transformer_class:
