...
from dheera_ai.integrations.gitlab.gitlab_prompt_manager import GitLabPromptManager
...
def test_gitlab_prompt_manager_config_validation_via_client_ctor():
    ...
    """
    with patch(
            "dheera_ai.integrations.gitlab.gitlab_prompt_manager.GitLabClient",
...
User: {{user_message}}"""
    ...
    dheera_ai_params = {"api_key": "keep-me"}
