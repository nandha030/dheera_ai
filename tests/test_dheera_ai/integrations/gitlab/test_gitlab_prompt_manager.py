...
from dheera_ai.integrations.gitlab.gitlab_client import GitLabClient
...
@patch("dheera_ai.llms.custom_httpx.http_handler.HTTPHandler.get")
...
@patch("dheera_ai.integrations.gitlab.gitlab_prompt_manager.GitLabClient")
...
def test_gitlab_prompt_manager_pre_call_hook_no_prompt_id():
    ...
    msgs, params = mgr.pre_call_hook(user_id="u", messages=original, dheera_ai_params={}, prompt_id=None)
...
@patch("dheera_ai.integrations.gitlab.gitlab_prompt_manager.GitLabPromptManager")
