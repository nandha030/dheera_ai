...
from dheera_ai.integrations.deepeval.api import Endpoints, HttpMethods
from dheera_ai.integrations.deepeval.deepeval import DeepEvalLogger
from dheera_ai.integrations.deepeval.types import SpanApiType, TraceSpanApiStatus
...
class TestDeepEvalLogger(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api_patcher = patch("dheera_ai.integrations.deepeval.deepeval.Api")
    ...
    def _common_assertions(
        ...
        expected_name = (
            "dheera_ai_success_callback"
            if expected_status == TraceSpanApiStatus.SUCCESS
            else "dheera_ai_failure_callback"
        )
