...
import dheera_ai
from dheera_ai.integrations.langfuse import langfuse as langfuse_module
...
class TestLangfuseUsageDetails(unittest.TestCase):
    ...
    def test_log_langfuse_v2_handles_null_usage_values(self):
        ...
        with patch(
            "dheera_ai.integrations.langfuse.langfuse._add_prompt_to_generation_params",
            ...
            kwargs = {
                ...
                "dheera_ai_params": {"metadata": {}},
                "optional_params": {},
                "dheera_ai_call_id": "test-call-id-null-usage",
...
def test_max_langfuse_clients_limit():
    ...
    with patch.object(langfuse_module, "MAX_LANGFUSE_INITIALIZED_CLIENTS", 2):
        # Reset the counter
        dheera_ai.initialized_langfuse_clients = 0
        ...
        assert dheera_ai.initialized_langfuse_clients == 1
        ...
        assert dheera_ai.initialized_langfuse_clients == 2
