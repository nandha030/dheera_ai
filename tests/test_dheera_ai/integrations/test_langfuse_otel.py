...
from dheera_ai.types.integrations.langfuse_otel import LangfuseOtelConfig
...
class TestLangfuseOtelIntegration:
    ...
    def test_set_langfuse_otel_attributes(self):
        ...
        from dheera_ai.integrations.langfuse.langfuse_otel_attributes import (
        ...
        with patch('dheera_ai.integrations.arize._utils.set_attributes') as mock_set_attributes:
    ...
    def test_set_langfuse_environment_attribute(self):
        ...
        with patch.dict(os.environ, {'LANGFUSE_TRACING_ENVIRONMENT': test_env}):
            with patch('dheera_ai.integrations.arize._utils.safe_set_attribute') as mock_safe_set_attribute:
    ...
    def test_extract_langfuse_metadata_basic(self):
        """Ensure metadata is correctly pulled from dheera_ai_params."""
        metadata_in = {"generation_name": "my-gen", "custom": "data"}
        kwargs = {"dheera_ai_params": {"metadata": metadata_in}}
    ...
    def test_extract_langfuse_metadata_with_header_enrichment(self, monkeypatch):
        ...
        stub_module = types.ModuleType("dheera_ai.integrations.langfuse.langfuse")
        class StubLFLogger:
            @staticmethod
            def add_metadata_from_header(dheera_ai_params, metadata):
        ...
        sys.modules["dheera_ai.integrations.langfuse.langfuse"] = stub_module  # type: ignore

        kwargs = {"dheera_ai_params": {"metadata": {"foo": "bar"}}}
        extracted = LangfuseOtelLogger._extract_langfuse_metadata(kwargs)
    ...
    def test_set_langfuse_specific_attributes_metadata(self):
        ...
        kwargs = {"dheera_ai_params": {"metadata": metadata}}
        ...
        with patch('dheera_ai.integrations.arize._utils.safe_set_attribute') as mock_safe_set_attribute:
            ...
            from dheera_ai.types.integrations.langfuse_otel import LangfuseSpanAttributes
            expected = {
...
class TestLangfuseOtelResponsesAPI:
    ...
    def test_langfuse_otel_with_responses_api(self):
        ...
        kwargs = {
            ...
            "model": "gpt-4o",
            "optional_params": {},
            "dheera_ai_params": {"metadata": test_metadata}
        }
    ...
    def test_responses_api_metadata_extraction(self):
        ...
        import sys
        if "dheera_ai.integrations.langfuse.langfuse" in sys.modules:
            original_module = sys.modules["dheera_ai.integrations.langfuse.langfuse"]
