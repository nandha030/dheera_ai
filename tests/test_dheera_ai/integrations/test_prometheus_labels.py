...
def test_user_email_in_required_metrics():
    ...
    - dheera_ai_proxy_total_requests_metric (already had it)
    - dheera_ai_proxy_failed_requests_metric (added)
    - dheera_ai_input_tokens_metric (added)
    - dheera_ai_output_tokens_metric (added)
    - dheera_ai_requests_metric (already had it)
    - dheera_ai_spend_metric (added)
    """
...
def test_prometheus_metric_labels_structure():
    ...
    from dheera_ai.types.integrations.prometheus import DEFINED_PROMETHEUS_METRICS
