...
class TestS3V2UnitTests:
    ...
    def test_s3_v2_source_code_analysis(self):
        ...
        from dheera_ai.integrations import s3_v2
    ...
    @patch('dheera_ai.integrations.s3_v2.CustomBatchLogger.periodic_flush')
    def test_s3_v2_endpoint_url(self, mock_periodic_flush, mock_create_task):
        ...
        expected_minio_url = "https://minio.example.com:9000/dheera_ai-logs/2025-09-14/test-key.json"
        ...
        with patch('dheera_ai.integrations.s3_v2._get_httpx_client', return_value=mock_sync_client):
...
async def test_s3_verify_false_handling():
    ...
    with patch('asyncio.create_task'):
        with patch('dheera_ai.integrations.s3_v2.get_async_httpx_client') as mock_get_client:
    ...
    # Clean up
    dheera_ai.s3_callback_params = None
...
def test_s3_object_key_prefix_combinations(
    ...
    """
    with patch("dheera_ai.integrations.s3_v2.get_s3_object_key") as mock_get_key:
