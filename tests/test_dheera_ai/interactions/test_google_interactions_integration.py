...
Tests the dheera_ai.interactions.create() and related methods against the Google AI Studio API.

Per OpenAPI spec: https://ai.google.dev/static/api/interactions.openapi.json

Run with: pytest tests/test_dheera_ai/interactions/test_google_interactions_integration.py -v
"""
...
import dheera_ai
import dheera_ai.interactions as interactions
...
class TestGoogleInteractionsCreate:
    """Tests for creating interactions via dheera_ai.interactions.create()."""
