...
from dheera_ai.types.utils import CacheCreationTokenDetails, Usage
...
def test_reasoning_tokens_no_price_set():
    ...
    model_cost_map = dheera_ai.model_cost[model]
    usage = Usage(
...
def test_image_tokens_with_custom_pricing():
    ...
    with patch(
        "dheera_ai.dheera_ai_core_utils.llm_cost_calc.utils.get_model_info",
...
def test_calculate_cost_component_with_string_values():
    ...
    from dheera_ai.dheera_ai_core_utils.llm_cost_calc.utils import calculate_cost_component
...
def test_gemini_image_generation_cost_with_zero_text_tokens():
    ...
    https://github.com/BerriAI/dheera_ai/issues/17410
    """
    os.environ["DHEERA_AI_LOCAL_MODEL_COST_MAP"] = "True"
    dheera_ai.model_cost = dheera_ai.get_model_cost_map(url="")
