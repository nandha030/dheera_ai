...
from dheera_ai.types.llms.openai import FileSearchTool, WebSearchOptions
from dheera_ai.types.utils import ModelInfo, ModelResponse, StandardBuiltInToolsParams
...
def test_web_search_cost_low():
    ...
    model_info = dheera_ai.get_model_info("gpt-4o-search-preview")
...
def test_get_cost_for_anthropic_web_search():
    ...
    """
    from dheera_ai.types.utils import ServerToolUse, Usage
...
def test_get_cost_for_gemini_web_search(model):
    ...
    Test that the cost for a web search is 0.00 when no response object is provided
    """
    from dheera_ai.types.utils import PromptTokensDetailsWrapper, Usage
...
def test_get_cost_for_vertex_ai_gemini_web_search(model, custom_llm_provider):
    ...
    This tests the fix for: https://github.com/BerriAI/dheera_ai/issues/XXXXX
    ...
    """
    from dheera_ai.types.utils import PromptTokensDetailsWrapper, Usage, Choices, Message
