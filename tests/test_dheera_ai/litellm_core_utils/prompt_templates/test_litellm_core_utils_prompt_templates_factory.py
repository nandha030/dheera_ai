...
def test_convert_gemini_messages():
    """
    Handle 'content' not being present in the message - https://github.com/BerriAI/dheera_ai/issues/13169
    """
    from dheera_ai.dheera_ai_core_utils.prompt_templates.factory import (
        convert_to_gemini_tool_call_result,
    )
    from dheera_ai.types.llms.openai import ChatCompletionToolMessage
