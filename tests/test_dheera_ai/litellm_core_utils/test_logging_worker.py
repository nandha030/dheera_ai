...
from dheera_ai.constants import LOGGING_WORKER_AGGRESSIVE_CLEAR_COOLDOWN_SECONDS
from dheera_ai.dheera_ai_core_utils.logging_worker import LoggingWorker
...
class TestLoggingWorker:
    ...
    async def test_worker_handles_cancellation_gracefully(self, logging_worker):
        ...
        with patch(
            "dheera_ai.dheera_ai_core_utils.logging_worker.verbose_logger"
        ) as mock_logger:
            # Start the worker
            logging_worker.start()
