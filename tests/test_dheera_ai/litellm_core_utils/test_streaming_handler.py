...
async def test_streaming_with_usage_and_logging(sync_mode: bool):
    ...
    dheera_ai.success_callback = [mock_callback]
    dheera_ai._async_success_callback = [mock_callback]
...
async def test_streaming_completion_start_time(logging_obj: Logging):
    ...
    mock_callback = MockCallback()
    dheera_ai.success_callback = [mock_callback, "langfuse"]
...
def test_is_chunk_non_empty_with_empty_tool_calls(
    ...
    Regression test for https://github.com/BerriAI/dheera_ai/issues/17425
...
def test_is_chunk_non_empty_with_valid_tool_calls(
    ...
    Companion test for https://github.com/BerriAI/dheera_ai/issues/17425
