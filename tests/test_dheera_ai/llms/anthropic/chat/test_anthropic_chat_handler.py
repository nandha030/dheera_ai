...
def test_partial_json_chunk_accumulation():
    ...
    This tests the fix for https://github.com/BerriAI/dheera_ai/issues/17473
...
def test_web_search_tool_result_no_extra_tool_calls():
    ...
    This tests the fix for https://github.com/BerriAI/dheera_ai/issues/17254
...
def test_web_search_tool_result_captured_in_provider_specific_fields():
    ...
    This tests the fix for https://github.com/BerriAI/dheera_ai/issues/17737
