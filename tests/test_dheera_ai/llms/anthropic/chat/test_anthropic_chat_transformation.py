...
def test_calculate_usage():
    ...
    Fixes https://github.com/BerriAI/dheera_ai/issues/9812
    """
    config = AnthropicConfig()
...
def test_calculate_usage_nulls(usage_object, expected_usage):
    ...
    Fixes https://github.com/BerriAI/dheera_ai/issues/11920
    """
    config = AnthropicConfig()
...
def test_web_search_tool_transformation():
    from dheera_ai.types.llms.openai import OpenAIWebSearchOptions
...
def test_anthropic_memory_tool_auto_adds_beta_header():
    """
    Tests that DheeraAI automatically adds the required 'anthropic-beta' header
...
def test_get_max_tokens_for_model_claude_35():
    ...
    Fixes: https://github.com/BerriAI/dheera_ai/issues/8835
    """
    config = AnthropicConfig()
