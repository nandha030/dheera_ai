...
from dheera_ai.types.llms.openai import ChatCompletionAssistantToolCall
...
def test_translate_streaming_openai_chunk_to_anthropic_content_block():
    ...
    (
        block_type,
        content_block_start,
    ) = DheeraAIAnthropicMessagesAdapter()._translate_streaming_openai_chunk_to_anthropic_content_block(
        choices=choices
    )
...
def test_translate_anthropic_messages_to_openai_thinking_blocks():
    ...
    adapter = DheeraAIAnthropicMessagesAdapter()
...
def test_translate_streaming_openai_chunk_to_anthropic_with_partial_json():
    ...
    (
        type_of_content,
        content_block_delta,
    ) = DheeraAIAnthropicMessagesAdapter()._translate_streaming_openai_chunk_to_anthropic(
        choices=choices
    )
