...
import dheera_ai
from dheera_ai.llms.azure.text_to_speech.transformation import AzureAVATextToSpeechConfig
...
def test_dheera_ai_speech_with_ssml_passthrough(mock_post):
    """
    Test that dheera_ai.speech passes SSML through to Azure AVA without transformation
    """
    raw_ssml = """<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xml:lang='en-US'>
    <voice name='en-US-JennyNeural'>
        <prosody rate='fast' pitch='high'>
