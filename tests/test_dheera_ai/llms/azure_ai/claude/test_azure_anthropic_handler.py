...
from dheera_ai.llms.azure_ai.anthropic.handler import AzureAnthropicChatCompletion
...
class TestAzureAnthropicChatCompletion:
    ...
    @patch("dheera_ai.utils.ProviderConfigManager")
    @patch("dheera_ai.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
    ...
    @patch("dheera_ai.llms.anthropic.chat.handler.make_sync_call")
    @patch("dheera_ai.utils.ProviderConfigManager")
    @patch("dheera_ai.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
    ...
    @patch("dheera_ai.llms.custom_httpx.http_handler._get_httpx_client")
    @patch("dheera_ai.utils.ProviderConfigManager")
    @patch("dheera_ai.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
