...
class TestAzureAnthropicMessagesConfig:
    ...
    def test_validate_anthropic_messages_environment_with_dict_dheera_ai_params(self):
        """Test validate_anthropic_messages_environment with dict dheera_ai_params"""
        config = AzureAnthropicMessagesConfig()
        headers = {}
    ...
    def test_get_complete_url_raises_error_when_api_base_missing(self):
        ...
        with patch("dheera_ai.secret_managers.main.get_secret_str", return_value=None):
