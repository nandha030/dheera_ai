...
import dheera_ai
from dheera_ai import ModelResponse, RateLimitError, completion
from dheera_ai.llms.bedrock.chat.converse_transformation import AmazonConverseConfig
from dheera_ai.types.llms.bedrock import ConverseTokenUsageBlock
...
def test_get_supported_openai_params_bedrock_converse():
    ...
    Note: This test is critical for routing, if we ever remove `dheera_ai.BEDROCK_CONVERSE_MODELS`, 
    please update this test to read `bedrock_converse` models from the model cost map.
    """
    for model in dheera_ai.BEDROCK_CONVERSE_MODELS:
...
def test_empty_assistant_message_handling():
    ...
    original_modify_params = dheera_ai.modify_params
    ...
    try:
        ...
        dheera_ai.modify_params = original_modify_params
