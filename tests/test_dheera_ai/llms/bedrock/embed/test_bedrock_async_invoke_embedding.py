...
# Test data
test_input = "Hello world from dheera_ai async invoke"
...
class TestBedrockAsyncInvokeEmbedding:
    ...
    def test_async_invoke_response_transformation_twelvelabs(self):
        ...
        from dheera_ai.llms.bedrock.embed.twelvelabs_marengo_transformation import TwelveLabsMarengoEmbeddingConfig
