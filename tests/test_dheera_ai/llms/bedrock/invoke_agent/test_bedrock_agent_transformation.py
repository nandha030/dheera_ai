...
from dheera_ai.types.llms.bedrock_invoke_agents import (
    InvokeAgentEvent,
    InvokeAgentEventHeaders,
    InvokeAgentUsage,
)
from dheera_ai.types.utils import Message, ModelResponse, Usage
...
class TestAmazonInvokeAgentConfig:
    ...
    @patch(
        "dheera_ai.llms.bedrock.chat.invoke_agent.transformation.convert_content_list_to_str"
    )
    def test_transform_request(self, mock_convert, config, sample_messages):
        ...
        result = config.transform_request(
            model, sample_messages, optional_params, dheera_ai_params, headers
        )
    ...
    def test_get_complete_url(self, mock_region, mock_endpoint, mock_convert, config):
        ...
        result = config.get_complete_url(
            api_base, api_key, model, optional_params, dheera_ai_params
        )
