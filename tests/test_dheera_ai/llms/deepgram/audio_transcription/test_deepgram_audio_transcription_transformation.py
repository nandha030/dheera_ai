...
from dheera_ai.llms.deepgram.audio_transcription.transformation import (
    DeepgramAudioTranscriptionConfig,
)
from dheera_ai.types.utils import TranscriptionResponse


@pytest.fixture
def test_bytes():
    return b"dheera_ai", b"dheera_ai"
