...
Source: dheera_ai/llms/github_copilot/responses/transformation.py
"""
import sys
import os
...
from dheera_ai.llms.github_copilot.responses.transformation import (
...
class TestGithubCopilotResponsesAPITransformation:
    ...
    @patch("dheera_ai.llms.github_copilot.responses.transformation.Authenticator")
    def test_github_copilot_responses_endpoint_url(self, mock_authenticator_class):
        ...
        custom_url = config.get_complete_url(
            api_base="https://custom.githubcopilot.com", dheera_ai_params={}
        )
        ...
        url_with_slash = config.get_complete_url(
            api_base="https://api.githubcopilot.com/", dheera_ai_params={}
        )
    ...
    def test_validate_environment_default_headers(self, mock_authenticator_class):
        ...
        headers = config.validate_environment(
            headers={}, model="gpt-5.1-codex", dheera_ai_params={}
        )
    ...
    def test_validate_environment_user_headers_override(self, mock_authenticator_class):
        ...
        headers = config.validate_environment(
            headers=custom_headers, model="gpt-5.1-codex", dheera_ai_params={}
        )
    ...
    def test_validate_environment_with_vision_header(self, mock_authenticator_class):
        ...
        # Create mock dheera_ai_params with input attribute
        mock_dheera_ai_params = MagicMock()
        mock_dheera_ai_params.input = [
            {
                "role": "user",
                "content": [{"type": "input_image", "data": "base64..."}],
            }
        ...
        headers = config.validate_environment(
            headers={}, model="gpt-5.1-codex", dheera_ai_params=mock_dheera_ai_params
        )
