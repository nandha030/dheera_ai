"""
Tests for OpenAI GPT transformation (dheera_ai/llms/openai/chat/gpt_transformation.py)
"""
...
class TestOpenAIGPTConfig:
    ...
    def test_user_param_supported_for_responses_api_models(self):
        ...
        Regression test for: https://github.com/BerriAI/dheera_ai/issues/17633
...
class TestGetOptionalParamsIntegration:
    """Integration tests using dheera_ai.get_optional_params()"""
