...
import dheera_ai
from dheera_ai.cost_calculator import completion_cost, cost_per_token
from dheera_ai.llms.perplexity.cost_calculator import cost_per_token as perplexity_cost_per_token
from dheera_ai.types.utils import Usage, PromptTokensDetailsWrapper
...
class TestPerplexityCostCalculator:
    ...
    def test_missing_model_info_fields(self):
        ...
        with patch('dheera_ai.llms.perplexity.cost_calculator.get_model_info') as mock_get_model_info:
    ...
    def test_integration_with_main_cost_calculator(self):
        """Test integration with the main DheeraAI cost calculator."""
        usage = Usage(
            prompt_tokens=100,
            completion_tokens=50,
            total_tokens=150,
    ...
    def test_uses_perplexity_provided_cost_when_available(self):
        ...
        request_cost (fixed per-request fee) that DheeraAI cannot calculate.
        """
