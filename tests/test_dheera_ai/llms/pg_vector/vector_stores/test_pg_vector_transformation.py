...
This test file mirrors dheera_ai/llms/pg_vector/vector_stores/transformation.py
...
from dheera_ai.llms.pg_vector.vector_stores.transformation import PGVectorStoreConfig
...
class TestPGVectorStoreConfig:
    ...
    def test_validate_environment_with_api_key_in_params(self):
        """
        Test that validate_environment works when api_key is provided in dheera_ai_params.
        
        This test validates that API key from params is correctly set in headers.
        """
        config = PGVectorStoreConfig()
        dheera_ai_params = GenericDheeraAIParams(api_key="test_pg_vector_key_123")
        headers = {}
        
        result_headers = config.validate_environment(headers, dheera_ai_params)
    ...
    def test_validate_environment_missing_api_key(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            config.validate_environment(headers, dheera_ai_params)
    ...
    def test_get_complete_url_with_api_base(self):
        ...
        result_url = config.get_complete_url(api_base, dheera_ai_params)
    ...
    def test_get_complete_url_missing_api_base(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            config.get_complete_url(None, dheera_ai_params)
    ...
    def test_environment_variable_support(self):
        ...
        with patch.dict(os.environ, {'PG_VECTOR_API_KEY': 'env_api_key_123'}):
            dheera_ai_params = GenericDheeraAIParams()  # No API key in params
        ...
        with patch.dict(os.environ, {'PG_VECTOR_API_KEY': 'env_key'}):
            dheera_ai_params = GenericDheeraAIParams(api_key="param_key")
    ...
    def test_pg_vector_search_request_construction(self, mock_post):
        ...
        try:
            ...
            # Call dheera_ai vector store search
            ...
            try:
                response = dheera_ai.vector_stores.search(
                    ...
                    mock_response=None  # Explicitly disable DheeraAI's automatic mocking
                )
