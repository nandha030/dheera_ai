...
from dheera_ai.llms.recraft.image_generation.transformation import (
    RecraftImageGenerationConfig,
)
from dheera_ai.types.llms.openai import OpenAIImageGenerationOptionalParams
...
class TestRecraftImageGenerationTransformation:
    ...
    @patch("dheera_ai.llms.recraft.image_generation.transformation.get_secret_str")
