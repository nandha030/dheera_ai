...
from dheera_ai.llms.sagemaker.common_utils import AWSEventStreamDecoder
from dheera_ai.llms.sagemaker.completion.transformation import SagemakerConfig
...
async def test_aiter_bytes_unicode_decode_error():
    ...
    Relevant issue: https://github.com/BerriAI/dheera_ai/issues/9165
    """
