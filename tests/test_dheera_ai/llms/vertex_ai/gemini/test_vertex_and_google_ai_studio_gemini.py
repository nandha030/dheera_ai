...
import dheera_ai
from dheera_ai import ModelResponse, completion
from dheera_ai.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini import (
    VertexGeminiConfig,
)
from dheera_ai.types.llms.vertex_ai import UsageMetadata
from dheera_ai.types.utils import ChoiceLogprobs, Usage
...
def test_vertex_ai_thinking_output_part():
    ...
    from dheera_ai.types.llms.vertex_ai import HttpxPartType
...
def test_streaming_chunk_includes_reasoning_tokens():
    ...
    iterator = ModelResponseIterator(
        streaming_response=[], sync_stream=True, logging_obj=dheera_ai_logging
    )
...
def test_vertex_ai_usage_metadata_response_token_count():
    """For Gemini Live API"""
    from dheera_ai.types.utils import PromptTokensDetailsWrapper
...
def test_vertex_ai_map_tool_with_anyof():
    """
    Related issue: https://github.com/BerriAI/dheera_ai/issues/11164

    Ensure if anyof is present, only the anyof field and its contents are kept - otherwise VertexAI will throw an error - https://github.com/BerriAI/dheera_ai/issues/11164
    """
    v = VertexGeminiConfig()
    optional_params = {}
    value = [
...
def test_vertex_ai_annotation_streaming_events():
    ...
    from dheera_ai.types.llms.openai import ChatCompletionAnnotation
...
def test_gemini_3_image_models_no_thinking_config():
    ...
    Related issue: https://github.com/BerriAI/dheera_ai/issues/17013
...
def test_partial_json_chunk_after_first_chunk():
    ...
    - https://github.com/BerriAI/dheera_ai/issues/16562
    - https://github.com/BerriAI/dheera_ai/issues/16037
    - https://github.com/BerriAI/dheera_ai/issues/14747
    - https://github.com/BerriAI/dheera_ai/issues/10410
    - https://github.com/BerriAI/dheera_ai/issues/5650
