...
Maps to: dheera_ai/llms/vertex_ai/vertex_gemma_models/transformation.py
"""
...
def _reset_dheera_ai_http_client_cache():
...
class TestVertexGemmaCompletion:
    """Test completion flow for Vertex AI Gemma models using dheera_ai.acompletion()"""

    @pytest.mark.asyncio
    async def test_acompletion_basic_request(self):
        """
        Test dheera_ai.acompletion() with Vertex AI Gemma model
        ...
        Expected DheeraAI Response: Standard OpenAI format
        """
        ...
        with patch(
            "dheera_ai.llms.custom_httpx.http_handler.AsyncHTTPHandler"
        ) as mock_http_handler, patch(
            "dheera_ai.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini.VertexLLM._ensure_access_token",
            ...
            # Validate DheeraAI Response (OpenAI format)
    ...
    async def test_acompletion_error_handling(self):
        """
        Test dheera_ai.acompletion() error handling when Vertex returns invalid response
        ...
        with patch(
            ...
            # Should raise exception (wrapped as APIConnectionError by DheeraAI)
    ...
    async def test_acompletion_fake_streaming(self):
        ...
        with patch(
            ...
            # Call dheera_ai.acompletion() with stream=True
            response = await dheera_ai.acompletion(
                model="vertex_ai/gemma/gemma-3-12b-it-1222199011122",
