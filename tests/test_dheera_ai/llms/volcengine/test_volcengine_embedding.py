"""
Integration tests for Volcengine embedding following DheeraAI testing patterns
...
class TestVolcEngineEmbedding(BaseLLMEmbeddingTest):
    """Test Volcengine embedding integration following DheeraAI patterns"""
    
    def get_custom_llm_provider(self) -> dheera_ai.LlmProviders:
        return dheera_ai.LlmProviders.VOLCENGINE
    ...
    async def test_basic_embedding(self, sync_mode):
        ...
        with patch("dheera_ai.embedding") as mock_embedding, patch("dheera_ai.aembedding") as mock_aembedding:
