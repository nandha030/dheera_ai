...
Validates that dheera_ai.transcription transforms requests correctly for WatsonX.
"""
...
class TestWatsonXAudioTranscription:
    """Tests for WatsonX audio transcription via dheera_ai.transcription."""

    @pytest.mark.asyncio
    async def test_watsonx_transcription_url_and_headers(self):
        """
        Test that dheera_ai.transcription sends request to correct WatsonX URL with proper headers.
        """
        captured_request = {}
        ...
        with patch("dheera_ai.llms.custom_httpx.http_handler.AsyncHTTPHandler.post", new=mock_post):
            try:
    ...
    async def test_watsonx_transcription_request_body(self):
        """
        Test that dheera_ai.transcription sends correct request body for WatsonX.
    ...
    async def test_watsonx_transcription_only_user_params_sent(self):
        ...
        DheeraAI should NOT add extra params like response_format if user didn't specify them.
        """
        captured_request = {}
