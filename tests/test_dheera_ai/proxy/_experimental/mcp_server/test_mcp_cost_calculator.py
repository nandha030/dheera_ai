...
from dheera_ai.proxy._experimental.mcp_server.cost_calculator import MCPCostCalculator


class TestMCPCostCalculator:
    def test_calculate_mcp_tool_call_cost_none_logging_obj(self):
        """Test that when dheera_ai_logging_obj is None, it returns 0.0"""
    ...
    def test_calculate_mcp_tool_call_cost_with_tool_specific_cost(self):
        ...
        # Mock the dheera_ai_logging_obj
    ...
    def test_calculate_mcp_tool_call_cost_no_cost_configuration(self):
        ...
        # Mock the dheera_ai_logging_obj with minimal metadata
        mock_logging_obj = MagicMock()
        mock_logging_obj.model_call_details = {
            "mcp_tool_call_metadata": {
                "name": "some_tool",
    ...
    def test_calculate_mcp_tool_call_cost_empty_metadata(self):
        ...
        # Mock the dheera_ai_logging_obj with empty model_call_details
        mock_logging_obj = MagicMock()
        mock_logging_obj.model_call_details = {}
