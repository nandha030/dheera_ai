...
# Add the parent directory to the path so we can import dheera_ai
sys.path.insert(0, "../../../../../")
...
from dheera_ai.proxy._types import DheeraAI_MCPServerTable, MCPTransport
from dheera_ai.types.mcp import MCPAuth
from dheera_ai.types.mcp_server.mcp_server_manager import MCPOAuthMetadata, MCPServer
...
class TestMCPServerManager:
    ...
    async def test_add_update_server_stdio(self):
        ...
        stdio_server = DheeraAI_MCPServerTable(
    ...
    async def test_fetch_oauth_metadata_from_resource_returns_servers_and_scopes(self):
        ...
        with patch(
            "dheera_ai.proxy._experimental.mcp_server.mcp_server_manager.get_async_httpx_client",
    ...
    async def test_rest_endpoint_filters_by_allowed_tools(self):
        ...
        from dheera_ai.proxy._experimental.mcp_server import rest_endpoints
    ...
    async def test_add_db_mcp_server_to_registry(self):
        ...
        manager = MCPServerManager()
        server = DheeraAI_MCPServerTable(
            **{
    ...
    async def test_get_allowed_mcp_servers_with_user_api_key_auth(self):
        ...
        dheera_ai_metadata from responses API.
        """
