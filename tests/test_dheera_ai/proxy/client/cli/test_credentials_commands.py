...
from dheera_ai.proxy.client.cli.main import cli
...
def mock_credentials_client(monkeypatch):
    ...
    monkeypatch.setattr(
        "dheera_ai.proxy.client.credentials.CredentialsManagementClient",
        mock_client,
    )
    monkeypatch.setattr(
        "dheera_ai.proxy.client.cli.commands.credentials.CredentialsManagementClient",
        mock_client,
    )
    return mock_client
