...
from dheera_ai.proxy.client.credentials import CredentialsManagementClient
from dheera_ai.proxy.client.exceptions import UnauthorizedError
from dheera_ai.proxy.credential_endpoints.endpoints import CredentialHelperUtils
...
def test_encrypt_credential_values_does_not_mutate_original(monkeypatch):
    ...
    monkeypatch.setenv("DHEERA_AI_SALT_KEY", "test-key")
