...
class TestCustomOpenAPISpec:
    ...
    @patch('dheera_ai.proxy.common_utils.custom_openapi_spec.CustomOpenAPISpec.add_request_schema')
    def test_add_chat_completion_request_schema(self, mock_add_schema, base_openapi_schema):
        ...
        with patch('dheera_ai.proxy._types.ProxyChatCompletionRequest') as mock_model:
    ...
    def test_add_embedding_request_schema(self, mock_add_schema, base_openapi_schema):
        ...
        with patch('dheera_ai.types.embedding.EmbeddingRequest') as mock_model:
    ...
    def test_add_responses_api_request_schema(self, mock_add_schema, base_openapi_schema):
        ...
        with patch('dheera_ai.types.llms.openai.ResponsesAPIRequestParams') as mock_model:
