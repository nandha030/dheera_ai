...
def test_get_tags_from_request_body_with_dheera_ai_metadata_tags():
    """
    Test that tags are correctly extracted from request body when using dheera_ai_metadata.
    """
    request_body = {
        "model": "gpt-4",
        "dheera_ai_metadata": {
...
def test_get_tags_from_request_body_with_dict_tags():
    ...
    request_body = {
        ...
        "metadata": {
            "tags": {
                "dheera_ai_id": "dheera_ai_ratelimit_test",
...
def test_get_tags_from_request_body_with_null_metadata():
    ...
    This is a regression test for https://github.com/BerriAI/dheera_ai/issues/17263
