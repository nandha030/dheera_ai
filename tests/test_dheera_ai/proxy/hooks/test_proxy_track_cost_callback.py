...
async def test_async_post_call_failure_hook():
    ...
    with patch(
        "dheera_ai.proxy.db.db_spend_update_writer.DBSpendUpdateWriter.update_database",
        ...
        assert "dheera_ai_params" in call_args["kwargs"]
        assert call_args["kwargs"]["dheera_ai_params"]["proxy_server_request"] == {
            "request_id": "test_request_id"
        }
        metadata = call_args["kwargs"]["dheera_ai_params"]["metadata"]
