...
from dheera_ai.proxy._types import DheeraAI_TeamTable, DheeraAI_UserTable, Member
...
def mock_prisma_client():
    ...
    mock_db.dheera_ai_teamtable.find_unique = mock_find_unique
...
class TestScimTransformations:
    ...
    @pytest.mark.asyncio
    async def test_transform_dheera_ai_team_to_scim_group(
