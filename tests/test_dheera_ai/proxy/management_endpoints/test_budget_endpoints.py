...
from dheera_ai.proxy._types import UserAPIKeyAuth, LitellmUserRoles, CommonProxyErrors

import dheera_ai.proxy.management_endpoints.budget_management_endpoints as bm
...
def client_and_mocks(monkeypatch):
    ...
    mock_prisma.db = types.SimpleNamespace(
        dheera_ai_budgettable = mock_table,
        dheera_ai_dailyspend   = mock_table,
    )
