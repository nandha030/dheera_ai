...
from dheera_ai.proxy.management_endpoints.callback_management_endpoints import router
...
class TestCallbackManagementEndpoints:
    ...
    def test_alist_callbacks_with_langfuse_logger(self):
        ...
        with patch('dheera_ai.integrations.langfuse.langfuse.Langfuse') as mock_langfuse:
            ...
            dheera_ai.success_callback.append("langfuse")
            dheera_ai._async_success_callback.append("langfuse")
    ...
    def test_alist_callbacks_with_datadog_logger(self):
        ...
        dheera_ai.success_callback.append("datadog")
        dheera_ai.failure_callback.append("datadog")
        dheera_ai.callbacks.append("datadog")
    ...
    def test_alist_callbacks_mixed_callback_types(self):
        ...
        dheera_ai.success_callback.append("langfuse")
        dheera_ai.failure_callback.append("datadog")
        dheera_ai.callbacks.append("prometheus")
