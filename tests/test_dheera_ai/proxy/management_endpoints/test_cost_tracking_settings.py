...
import dheera_ai
from dheera_ai.proxy.management_endpoints.cost_tracking_settings import router
...
class TestCostTrackingSettings:
    ...
    async def test_get_cost_discount_config_empty(self):
        ...
        mock_proxy_config = AsyncMock()
        mock_proxy_config.get_config = AsyncMock(
            return_value={"dheera_ai_settings": {}}
        )
    ...
    async def test_update_cost_discount_config_success(self):
        ...
        with patch(
            ...
            "dheera_ai.proxy.proxy_server.store_model_in_db",
            mock_store_model_in_db,
        ), patch.object(dheera_ai, "cost_discount_config", {}):
            # Make request
            ...
            # Verify dheera_ai.cost_discount_config was updated
            assert dheera_ai.cost_discount_config == test_discount_config
