...
from dheera_ai.proxy.management_endpoints.ui_sso import MicrosoftSSOHandler
from dheera_ai.proxy.management_endpoints.types import get_dheera_ai_user_role
...
def test_maps_internal_user_role():
    ...
    chosen = None
    for r in roles:
        mapped = get_dheera_ai_user_role(r)
