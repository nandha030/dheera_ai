...
def setup_mock_prisma_client(
    ...
    mcp_servers: List[DheeraAI_MCPServerTable],
):
    """Helper to set up a mock prisma client with proper async behavior"""
    mock_prisma_client.db = MagicMock()
    mock_prisma_client.db.dheera_ai_teamtable = AsyncMock()
    mock_prisma_client.db.dheera_ai_teamtable.find_many = AsyncMock(
        return_value=team_records
    )
    mock_prisma_client.db.dheera_ai_mcpservertable = AsyncMock()
    mock_prisma_client.db.dheera_ai_mcpservertable.find_many = AsyncMock(
...
class TestListMCPServers:
    ...
    async def test_list_mcp_servers_config_yaml_only(self):
        ...
        with patch(
            ...
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints._user_has_admin_view",
            return_value=True,
        ), patch(
    ...
    async def test_fetch_single_mcp_server_redacts_credentials(self):
        ...
        with patch(
            ...
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.health_check_server",
...
class TestMCPHealthCheckEndpoints:
    ...
    async def test_health_check_mcp_server_unauthorized(self):
        ...
        with patch(
            ...
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.get_all_mcp_servers_for_user",
...
class TestTemporaryMCPSessionEndpoints:
    ...
    def test_cache_temporary_mcp_server_stores_entry_with_ttl(self):
        ...
        with patch(
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints._temporary_mcp_servers",
            {},
        ) as cache:
    ...
    def test_get_cached_temporary_mcp_server_or_404(self):
        ...
        with patch(
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.get_cached_temporary_mcp_server",
            return_value=server,
        ) as get_cached:
    ...
    async def test_add_session_mcp_server_caches_and_redacts_credentials(self):
        ...
        with patch(
            ...
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints._cache_temporary_mcp_server",
            MagicMock(),
        ) as cache_mock:
    ...
    async def test_mcp_authorize_proxies_to_discoverable_endpoint(self):
        ...
        with patch(
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints._get_cached_temporary_mcp_server_or_404",
            return_value=server,
        ) as get_server, patch(
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.authorize_with_server",
    ...
    async def test_mcp_token_proxies_to_exchange_endpoint(self):
        ...
        with patch(
            ...
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.exchange_token_with_server",
    ...
    async def test_mcp_register_proxies_request_body(self):
        ...
        with patch(
            ...
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints._read_request_body",
            AsyncMock(return_value=request_body),
        ) as read_body, patch(
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.register_client_with_server",
...
class TestUpdateMCPServer:
    ...
    async def test_update_mcp_server_respects_extra_headers(self):
        ...
        mock_prisma_client.db = MagicMock()
        mock_prisma_client.db.dheera_ai_mcpservertable = AsyncMock()
        mock_prisma_client.db.dheera_ai_mcpservertable.find_unique = AsyncMock(
            return_value=existing_server
        )
        mock_prisma_client.db.dheera_ai_mcpservertable.update = AsyncMock(
        ...
        with patch(
            ...
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.add_update_server",
            AsyncMock(),
        ), patch(
            "dheera_ai.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.reload_servers_from_database",
            AsyncMock(),
        ):
            # Import and call the function
            from dheera_ai.proxy.management_endpoints.mcp_management_endpoints import (
