...
async def test_set_object_permission():
    ...
    mock_prisma_client.db.dheera_ai_objectpermissiontable.create = AsyncMock(
    ...
    mock_prisma_client.db.dheera_ai_objectpermissiontable.create.assert_called_once()
    
    # Verify the data passed to create excludes None values and object_permission_id
    call_args = mock_prisma_client.db.dheera_ai_objectpermissiontable.create.call_args
