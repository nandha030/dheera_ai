...
from dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.anthropic_passthrough_logging_handler import (
...
class TestAzureAnthropicCostCalculation:
    ...
    def _create_mock_logging_obj(
        ...
        mock_logging_obj.model_call_details = mock_model_call_details
        mock_logging_obj.dheera_ai_call_id = "test-call-id"
        return mock_logging_obj
    ...
    def test_cost_calculation_with_azure_ai_custom_llm_provider(
        ...
        AnthropicPassthroughLoggingHandler._create_anthropic_response_logging_payload(
            dheera_ai_model_response=mock_response,
...
class TestAnthropicBatchPassthroughCostTracking:
    ...
    @patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.anthropic_passthrough_logging_handler.AnthropicPassthroughLoggingHandler._store_batch_managed_object')
    @patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.anthropic_passthrough_logging_handler.AnthropicPassthroughLoggingHandler.get_actual_model_id_from_router')
    @patch('dheera_ai.llms.anthropic.batches.transformation.AnthropicBatchesConfig')
    def test_batch_creation_handler_success(
        ...
        mock_batch_response = DheeraAIBatch(
            id="msgbatch_01Wj7gkQk7gn4MpAKR8ZEDU2",
            object="batch",
    ...
    def test_batch_creation_handler_model_extraction_from_nested_request(
        ...
        from dheera_ai.llms.anthropic.batches.transformation import AnthropicBatchesConfig
        from dheera_ai.types.utils import DheeraAIBatch
