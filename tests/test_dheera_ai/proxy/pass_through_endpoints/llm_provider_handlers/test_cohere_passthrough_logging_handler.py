...
from dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.cohere_passthrough_logging_handler import (
...
class TestCoherePassthroughLoggingHandler:
    ...
    @patch(
        "dheera_ai.dheera_ai_core_utils.dheera_ai_logging.get_standard_logging_object_payload"
    )
    @patch("dheera_ai.llms.cohere.embed.v1_transformation.CohereEmbeddingConfig._transform_response")
