...
class TestVertexAIBatchPassthroughHandler:
    ...
    def mock_httpx_response(self):
        ...
        mock_response.json.return_value = {
            ...
            "displayName": "dheera_ai-vertex-batch-test",
    ...
    def mock_logging_obj(self):
        """Mock logging object"""
        mock = Mock()
        mock.dheera_ai_call_id = "test-call-id-123"
    ...
    def test_batch_prediction_jobs_handler_success(self, mock_httpx_response, mock_logging_obj):
        ...
        with patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.verbose_proxy_logger') as mock_logger:
            with patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.VertexPassthroughLoggingHandler.get_actual_model_id_from_router') as mock_get_model_id:
                with patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.VertexPassthroughLoggingHandler._store_batch_managed_object') as mock_store:
                    with patch('dheera_ai.llms.vertex_ai.batches.transformation.VertexAIBatchTransformation') as mock_transformation:
    ...
    def test_get_actual_model_id_from_router_with_router(self):
        ...
        with patch('dheera_ai.proxy.proxy_server.llm_router') as mock_router:
            with patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.VertexPassthroughLoggingHandler.extract_model_name_from_vertex_path') as mock_extract:
    ...
    def test_get_actual_model_id_from_router_without_router(self):
        ...
        with patch('dheera_ai.proxy.proxy_server.llm_router', None):
            with patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.VertexPassthroughLoggingHandler.extract_model_name_from_vertex_path') as mock_extract:
    ...
    def test_unified_object_id_generation(self):
        ...
        unified_id_string = SpecialEnums.DHEERA_AI_MANAGED_BATCH_COMPLETE_STR.value.format(model_id, batch_id)
    ...
    def test_store_batch_managed_object(self, mock_logging_obj, mock_managed_files_hook):
        ...
        with patch('dheera_ai.proxy.proxy_server.proxy_logging_obj') as mock_proxy_logging_obj:
            with patch('dheera_ai.proxy.pass_through_endpoints.llm_provider_handlers.vertex_passthrough_logging_handler.verbose_proxy_logger') as mock_logger:
    ...
    def test_batch_cost_calculation_integration(self):
        ...
        from dheera_ai.batches.batch_utils import calculate_vertex_ai_batch_cost_and_usage
        ...
        with patch('dheera_ai.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini.VertexGeminiConfig') as mock_config:
    ...
    def test_batch_response_transformation(self):
        ...
        from dheera_ai.llms.vertex_ai.batches.transformation import VertexAIBatchTransformation
