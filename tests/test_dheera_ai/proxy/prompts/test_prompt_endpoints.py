...
class TestPromptVersioning:
    ...
    def test_get_latest_prompt_versions(self):
        ...
        """
        from dheera_ai.proxy.prompts.prompt_endpoints import get_latest_prompt_versions
        ...
        assert jack_prompt.dheera_ai_params.dotprompt_content == "v3 content"
    ...
    def test_get_version_number(self):
        ...
        """
        from dheera_ai.proxy.prompts.prompt_endpoints import get_version_number
    ...
    def test_get_base_prompt_id(self):
        ...
        """
        from dheera_ai.proxy.prompts.prompt_endpoints import get_base_prompt_id
    ...
    def test_get_latest_version_prompt_id(self):
        ...
        """
        from dheera_ai.proxy.prompts.prompt_endpoints import get_latest_version_prompt_id
    ...
    def test_construct_versioned_prompt_id(self):
        ...
        """
        from dheera_ai.proxy.prompts.prompt_endpoints import construct_versioned_prompt_id
...
class TestPromptVersionsEndpoint:
    ...
    async def test_get_prompt_versions_returns_all_versions(self):
        ...
        from dheera_ai.proxy.prompts.prompt_endpoints import get_prompt_versions
        ...
        with patch("dheera_ai.proxy.prompts.prompt_registry.IN_MEMORY_PROMPT_REGISTRY") as mock_registry:
