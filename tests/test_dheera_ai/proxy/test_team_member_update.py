...
from dheera_ai.proxy._types import TeamMemberUpdateRequest
from dheera_ai.proxy.management_endpoints.team_endpoints import team_member_update
...
async def test_ateam_member_update_admin_requires_premium(monkeypatch):
    ...
    expected_msg = (
        "Assigning team admins is a premium feature. You must be a DheeraAI Enterprise user to use this feature. "
        "If you have a license please set `DHEERA_AI_LICENSE` in your env. Get a 7 day trial key here: https://www.dheera_ai.ai/#trial. "
