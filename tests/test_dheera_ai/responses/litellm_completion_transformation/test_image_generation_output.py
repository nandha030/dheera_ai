...
https://github.com/BerriAI/dheera_ai/issues/16227
...
from dheera_ai.types.responses.main import OutputImageGenerationCall
...
class TestExtractBase64FromDataUrl:
    ...
    def test_extracts_base64_from_data_url(self):
        ...
        result = DheeraAICompletionResponsesConfig._extract_base64_from_data_url(
            data_url
        )
    ...
    def test_handles_invalid_inputs(self):
        ...
        assert DheeraAICompletionResponsesConfig._extract_base64_from_data_url("") is None
        assert DheeraAICompletionResponsesConfig._extract_base64_from_data_url(None) is None
        assert DheeraAICompletionResponsesConfig._extract_base64_from_data_url("data:image/png;base64") is None
...
class TestExtractImageGenerationOutputItems:
    ...
    def test_extracts_images_correctly(self):
        ...
        result = DheeraAICompletionResponsesConfig._extract_image_generation_output_items(
...
class TestExtractMessageOutputItemsIntegration:
    ...
    def test_detects_images_and_creates_image_generation_call(self):
        ...
        result = DheeraAICompletionResponsesConfig._extract_message_output_items(
            chat_completion_response=mock_response,
            choices=[mock_choice],
        )
    ...
    def test_creates_regular_message_when_no_images(self):
        ...
        from dheera_ai.types.responses.main import GenericResponseOutputItem
