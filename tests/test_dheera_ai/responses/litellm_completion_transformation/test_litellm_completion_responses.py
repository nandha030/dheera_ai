...
class TestDheeraAICompletionResponsesConfig:
...
class TestFunctionCallTransformation:
    ...
    def test_function_call_detection(self):
        ...
        assert DheeraAICompletionResponsesConfig._is_input_item_function_call(function_call_item)
        assert not DheeraAICompletionResponsesConfig._is_input_item_function_call(function_call_output_item)
        assert not DheeraAICompletionResponsesConfig._is_input_item_function_call(regular_message)
        
        # Test function_call_output detection (should still work)
        assert DheeraAICompletionResponsesConfig._is_input_item_tool_call_output(function_call_output_item)
        assert not DheeraAICompletionResponsesConfig._is_input_item_tool_call_output(function_call_item)
        assert not DheeraAICompletionResponsesConfig._is_input_item_tool_call_output(regular_message)
    ...
    def test_function_call_transformation(self):
        ...
        result = DheeraAICompletionResponsesConfig._transform_responses_api_function_call_to_chat_completion_message(
    ...
    def test_complete_input_transformation_with_function_calls(self):
        ...
        messages = DheeraAICompletionResponsesConfig._transform_response_input_param_to_chat_completion_message(
            input=test_input
        )
    ...
    def test_complete_request_transformation_with_function_calls(self):
        ...
        result = DheeraAICompletionResponsesConfig.transform_responses_api_request_to_chat_completion_request(
...
class TestToolChoiceTransformation:
    ...
    def test_transform_tool_choice_cursor_bug_fix(self):
        ...
        """
        result = DheeraAICompletionResponsesConfig._transform_tool_choice({"type": "tool"})
    ...
    def test_transform_tool_choice_preserves_function_with_name(self):
        ...
        result = DheeraAICompletionResponsesConfig._transform_tool_choice(tool_choice)
...
class TestContentTypeTransformation:
    ...
    def test_tool_result_content_type_transformed_to_text(self):
        ...
        """
        result = DheeraAICompletionResponsesConfig._get_chat_completion_request_content_type("tool_result")
        assert result == "text"

    def test_input_text_content_type_transformed_to_text(self):
        """Test that 'input_text' content type is transformed to 'text'"""
        result = DheeraAICompletionResponsesConfig._get_chat_completion_request_content_type("input_text")
        assert result == "text"
    ...
    def test_none_text_blocks_filtered_out(self):
        ...
        result = DheeraAICompletionResponsesConfig._transform_responses_api_content_to_chat_completion_content(content)
        assert len(result) == 2
...
class TestToolTransformation:
    ...
    def test_transform_vertex_ai_tools(self):
        ...
        from dheera_ai.types.llms.vertex_ai import VertexToolName
        ...
        # Execute
        result_tools, web_search_options = DheeraAICompletionResponsesConfig.transform_responses_api_tools_to_chat_completion_tools(
            tools=tools
        )
    ...
    def test_transform_function_tools_with_cache_control_only(self):
        ...
        # Execute
        result_tools, _ = DheeraAICompletionResponsesConfig.transform_responses_api_tools_to_chat_completion_tools(
            tools=tools
        )
...
class TestUsageTransformation:
    ...
    def test_transform_usage_with_cached_tokens_anthropic(self):
        ...
        # Execute
        response_usage = DheeraAICompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(
            chat_completion_response=chat_completion_response
        )
