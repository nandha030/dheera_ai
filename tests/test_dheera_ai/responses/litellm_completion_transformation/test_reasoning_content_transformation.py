...
class TestReasoningContentStreaming:
    ...
    def test_reasoning_content_in_delta(self):
        ...
        iterator = DheeraAICompletionStreamingIterator(
            model="test-model",
            dheera_ai_custom_stream_wrapper=mock_stream,
...
def test_streaming_chunk_id_raw():
    ...
    iterator = DheeraAICompletionStreamingIterator(
        model="test-model",
        dheera_ai_custom_stream_wrapper=AsyncMock(),
        request_input="Test input",
        responses_api_request={},
        custom_llm_provider="openai",
        dheera_ai_metadata={"model_info": {"id": "gpt-4"}},
    )
