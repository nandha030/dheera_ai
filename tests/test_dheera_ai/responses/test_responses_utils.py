...
from dheera_ai.responses.utils import ResponseAPILoggingUtils, ResponsesAPIRequestUtils
...
class TestResponsesAPIRequestUtils:
    ...
    def test_get_optional_params_responses_api_unsupported_param(self):
        ...
        # Execute and Assert
        with pytest.raises(dheera_ai.UnsupportedParamsError) as excinfo:
    ...
    def test_decode_previous_response_id_to_original_previous_response_id(self):
        """Test decoding a DheeraAI encoded previous_response_id to the original previous_response_id"""
        # Setup
    ...
    def test_update_responses_api_response_id_with_model_id_handles_dict(self):
        ...
        dheera_ai_metadata = {"model_info": {"id": "gpt-4o"}}
