...
from dheera_ai.router_utils.cooldown_cache import CooldownCache, CooldownCacheValue
...
class TestCooldownCacheExceptionMasking:
    ...
    def test_long_exception_string_masked(self, cooldown_cache):
        ...
        long_exception = (
            "dheera_ai.proxy.proxy_server._handle_llm_api_exception(): Exception occurred - "
            ...
            "'dheera_ai.RateLimitError: RateLimitError: Azure_aiException - "
        ...
        assert masked_exception.startswith(
            "dheera_ai.proxy.proxy_server._handle_llm_api_excepti"
        )
