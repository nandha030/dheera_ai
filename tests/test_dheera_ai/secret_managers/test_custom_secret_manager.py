...
def test_custom_secret_manager_integration_with_dheera_ai():
    """
    Test that the custom secret manager integrates with DheeraAI's secret management system.
    """
    # Create and set the custom secret manager
    secret_manager = TestCustomSecretManager()
    dheera_ai.secret_manager_client = secret_manager
    dheera_ai._key_management_system = KeyManagementSystem.CUSTOM
    ...
    try:
        # Test getting a secret through DheeraAI's get_secret function
        ...
        dheera_ai._key_management_system = None
        dheera_ai._key_management_settings = None
