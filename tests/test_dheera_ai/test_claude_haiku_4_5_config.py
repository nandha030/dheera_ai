...
https://github.com/BerriAI/dheera_ai/issues/15818
"""
...
def test_bedrock_haiku_4_5_configuration():
    ...
    for model in bedrock_haiku_models:
        ...
        ), f"{model} should use bedrock_converse provider, got {model_info['dheera_ai_provider']}"
...
def test_bedrock_haiku_4_5_matches_sonnet_capabilities():
    ...
    assert haiku_info["dheera_ai_provider"] == "bedrock_converse"
    assert sonnet_info["dheera_ai_provider"] == "bedrock_converse"
...
def test_anthropic_api_haiku_4_5_configuration():
    ...
    for model in anthropic_models:
        ...
        assert model_info["dheera_ai_provider"] == "anthropic", f"{model} should use anthropic provider"
