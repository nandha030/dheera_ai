...
from dheera_ai.proxy.hooks.responses_id_security import ResponsesIDSecurity
...
class TestIsEncryptedResponseId:
    ...
    def test_is_encrypted_response_id_valid(self, responses_id_security):
        ...
        with patch(
            "dheera_ai.proxy.hooks.responses_id_security.decrypt_value_helper"
        ) as mock_decrypt:
...
class TestEncryptResponseId:
    ...
    def test_encrypt_response_id_success(
        ...
        with patch(
            "dheera_ai.proxy.hooks.responses_id_security.encrypt_value_helper"
        ) as mock_encrypt:
