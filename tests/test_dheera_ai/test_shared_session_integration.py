...
# Add the dheera_ai directory to the path
...
class TestSharedSessionIntegration:
    ...
    def test_acompletion_shared_session_parameter(self):
        ...
        sig = inspect.signature(dheera_ai.acompletion)
    ...
    def test_completion_shared_session_parameter(self):
        ...
        # Get the function signature
        sig = inspect.signature(dheera_ai.completion)
        params = list(sig.parameters.keys())
    ...
    async def test_acompletion_with_shared_session_mock(self):
        ...
        with patch('dheera_ai.completion') as mock_completion:
    ...
    def test_type_annotations_consistency(self):
        ...
        acompletion_sig = inspect.signature(dheera_ai.acompletion)
        completion_sig = inspect.signature(dheera_ai.completion)
