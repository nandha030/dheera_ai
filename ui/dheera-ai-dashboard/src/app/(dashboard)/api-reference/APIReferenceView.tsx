...
interface ApiRefProps {
  proxySettings: {
    ...
    DHEERA_AI_UI_API_DOC_BASE_URL?: string | null;
  };
}

const APIReferenceView: React.FC<ApiRefProps> = ({ proxySettings }) => {
  let base_url = "<your_proxy_base_url>";
  const customDocBaseUrl = proxySettings?.DHEERA_AI_UI_API_DOC_BASE_URL;
      ...
      <Grid className="gap-2 p-8 h-[80vh] w-full mt-2">
        <div className="mb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <DocLink className="ml-3 shrink-0" href="https://docs.dheera_ai.ai/docs/proxy/user_keys" />
          </div>

          <Text className="mt-2 mb-2">
            DheeraAI is OpenAI Compatible. This means your API Key works with the OpenAI SDK. Just replace the base_url
            to point to your dheera_ai proxy. Example Below{" "}
          </Text>
...
client = openai.OpenAI(
    ...
    base_url="${base_url}" # DheeraAI Proxy is OpenAI compatible, Read More: https://docs.dheera_ai.ai/docs/proxy/user_keys
)
...
llm = AzureOpenAI(
    ...
    temperature=0.0,
    azure_endpoint="${base_url}", # dheera_ai proxy endpoint
