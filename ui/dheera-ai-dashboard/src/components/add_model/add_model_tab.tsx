            ...
            <Card>
              ...
              >
                <>
                  ...
                  <Row>
                    ...
                    <Col span={10}>
                      <Text className="mb-5 mt-1">
                        <strong>Optional</strong> - DheeraAI endpoint to use when health checking this model{" "}
                        <Link href="https://docs.dheera_ai.ai/docs/proxy/health#health" target="_blank">
                          Learn more
                        </Link>
                      </Text>
                    </Col>
                  ...
                  <Form.Item label="Existing Credentials" name="dheera_ai_credential_name" initialValue={null}>
                    <AntdSelect
                      showSearch
                  ...
                  <Form.Item
                    ...
                    shouldUpdate={(prevValues, currentValues) =>
                      prevValues.dheera_ai_credential_name !== currentValues.dheera_ai_credential_name ||
                      prevValues.provider !== currentValues.provider
                    }
                  >
                    {({ getFieldValue }) => {
                      const credentialName = getFieldValue("dheera_ai_credential_name");
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <Tooltip title="Get help on our github">
                      <Typography.Link href="https://github.com/BerriAI/dheera_ai/issues">Need Help?</Typography.Link>
                    </Tooltip>
