...
export const handleAddAutoRouterSubmit = async (values: any, accessToken: string, form: any, callback?: () => void) => {
  try {
    ...
    if (values.auto_router_embedding_model && values.auto_router_embedding_model !== "custom") {
      autoRouterConfig.dheera_ai_params.auto_router_embedding_model = values.auto_router_embedding_model;
    } else if (values.custom_embedding_model) {
      autoRouterConfig.dheera_ai_params.auto_router_embedding_model = values.custom_embedding_model;
    }
    ...
    console.log("Auto router config (stringified):", autoRouterConfig.dheera_ai_params.auto_router_config);
