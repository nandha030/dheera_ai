        ...
        <TabPanels>
          ...
          <TabPanel>
            <Descriptions bordered column={1}>
              ...
              {agent.dheera_ai_params?.model && (
                <Descriptions.Item label="Model">{agent.dheera_ai_params.model}</Descriptions.Item>
              )}
              {agent.dheera_ai_params?.make_public !== undefined && (
                <Descriptions.Item label="Make Public">{agent.dheera_ai_params.make_public ? "Yes" : "No"}</Descriptions.Item>
              )}
