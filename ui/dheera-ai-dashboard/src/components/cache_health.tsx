    ...
    if (response?.error) {
      try {
        ...
        errorDetails = {
          ...
          dheera_ai_params: errorMessage?.dheera_ai_cache_params || {},
          health_check_cache_params: errorMessage?.health_check_cache_params || {},
        };

        parsedLitellmParams = deepParse(errorDetails.dheera_ai_params) || {};
      ...
      parsedLitellmParams = deepParse(response?.dheera_ai_cache_params) || {};
              ...
              <table className="w-full border-collapse">
                <tbody>
                  ...
                  <TableClickableErrorField
                    label="dheera_ai_settings.cache_params"
              ...
              <pre className="whitespace-pre-wrap break-words overflow-auto max-h-[500px]">
                {(() => {
                  try {
                    const data = {
                      ...response,
                      dheera_ai_cache_params: parsedLitellmParams,
