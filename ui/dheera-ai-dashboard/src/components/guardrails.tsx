...
const GuardrailsPanel: React.FC<GuardrailsPanelProps> = ({ accessToken, userRole }) => {
  ...
  const providerDisplayName =
    guardrailToDelete && guardrailToDelete.dheera_ai_params
      ? getGuardrailLogoAndName(guardrailToDelete.dheera_ai_params.guardrail).displayName
      : undefined;
          ...
          <TabPanel>
            ...
            <DeleteResourceModal
              ...
              resourceInformation={[
                ...
                { label: "Mode", value: guardrailToDelete?.dheera_ai_params.mode },
                {
                  label: "Default On",
                  value: guardrailToDelete?.dheera_ai_params.default_on ? "Yes" : "No",
                },
              ]}
