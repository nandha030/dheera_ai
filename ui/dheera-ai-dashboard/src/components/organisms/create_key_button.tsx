  ...
  const handleCreate = async (formValues: Record<string, any>) => {
    try {
      ...
      if (disabledCallbacks.length > 0) {
        ...
        metadata = {
          ...metadata,
          dheera_ai_disabled_callbacks: mappedDisabledCallbacks,
        };
      }
                    ...
                    label={
                      <span>
                        ...
                        <Tooltip title="Allow this key to use specific prompt templates">
                          <a
                            href="https://docs.dheera_ai.ai/docs/proxy/prompt_management"
                            target="_blank"
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()} // Prevent accordion from collapsing when clicking link
                          >
                    ...
                    label={
                      <span>
                        ...
                        <Tooltip title="Allow this key to use specific pass through routes">
                          <a
                            href="https://docs.dheera_ai.ai/docs/proxy/pass_through"
                            target="_blank"
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()} // Prevent accordion from collapsing when clicking link
                          >
                    ...
                    <Tooltip
                      title={
                        <span>
                          ...
                          <a href="https://www.dheera_ai.ai/enterprise" target="_blank">
                            https://www.dheera_ai.ai/enterprise
                          </a>
                        </span>
                      }
                      placement="top"
          ...
          <Grid numItems={1} className="gap-2 w-full">
            ...
            <Col numColSpan={1}>
              <p>
                ...
                <b>you will not be able to view it again</b> through your DheeraAI account. If you lose this secret key,
