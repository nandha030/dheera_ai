            ...
            <Grid numItems={1} numItemsSm={2} numItemsLg={3} className="gap-6">
              ...
              <Card>
                ...
                <div className="mt-2">
                  ...
                  <Text>
                    of{" "}
                    {orgData.dheera_ai_budget_table.max_budget === null
                      ? "Unlimited"
                      : `$${formatNumberWithCommas(orgData.dheera_ai_budget_table.max_budget, 4)}`}
                  </Text>
                  {orgData.dheera_ai_budget_table.budget_duration && (
                    <Text className="text-gray-500">Reset: {orgData.dheera_ai_budget_table.budget_duration}</Text>
                  )}
                </div>
              </Card>
              ...
              <Card>
                ...
                <div className="mt-2">
                  <Text>TPM: {orgData.dheera_ai_budget_table.tpm_limit || "Unlimited"}</Text>
                  <Text>RPM: {orgData.dheera_ai_budget_table.rpm_limit || "Unlimited"}</Text>
                  {orgData.dheera_ai_budget_table.max_parallel_requests && (
                    <Text>Max Parallel Requests: {orgData.dheera_ai_budget_table.max_parallel_requests}</Text>
                  )}
                </div>
              </Card>
              ...
              {isEditing ? (
                <Form
                  ...
                  initialValues={{
                    ...
                    tpm_limit: orgData.dheera_ai_budget_table.tpm_limit,
                    rpm_limit: orgData.dheera_ai_budget_table.rpm_limit,
                    max_budget: orgData.dheera_ai_budget_table.max_budget,
                    budget_duration: orgData.dheera_ai_budget_table.budget_duration,
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div>TPM: {orgData.dheera_ai_budget_table.tpm_limit || "Unlimited"}</div>
                    <div>RPM: {orgData.dheera_ai_budget_table.rpm_limit || "Unlimited"}</div>
                  </div>
                  <div>
                    ...
                    <div>Reset: {orgData.dheera_ai_budget_table.budget_duration || "Never"}</div>
                  </div>
