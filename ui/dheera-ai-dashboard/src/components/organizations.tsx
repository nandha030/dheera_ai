...
const OrganizationsTable: React.FC<OrganizationsTableProps> = ({
  ...
  if (!premiumUser) {
    return (
      <div>
        <Text>
          This is a DheeraAI Enterprise feature, and requires a valid key to use. Get a trial key{" "}
          <a href="https://www.dheera_ai.ai/#pricing" target="_blank" rel="noopener noreferrer">
            here
          </a>
          .
        </Text>
                              ...
                              ? organizations
                                  ...
                                  .map((org: Organization) => (
                                    <TableRow key={org.organization_id}>
                                      ...
                                      <TableCell>
                                        {org.dheera_ai_budget_table?.max_budget !== null &&
                                        org.dheera_ai_budget_table?.max_budget !== undefined
                                          ? org.dheera_ai_budget_table?.max_budget
                                          : "No limit"}
                                      </TableCell>
                                      <TableCell
                                        style={{
                                      ...
                                      <TableCell>
                                        <Text>
                                          TPM:{" "}
                                          {org.dheera_ai_budget_table?.tpm_limit
                                            ? org.dheera_ai_budget_table?.tpm_limit
                                            : "Unlimited"}
                                          <br />
                                          RPM:{" "}
                                          {org.dheera_ai_budget_table?.rpm_limit
                                            ? org.dheera_ai_budget_table?.rpm_limit
                                            : "Unlimited"}
                                        </Text>
                                      </TableCell>
