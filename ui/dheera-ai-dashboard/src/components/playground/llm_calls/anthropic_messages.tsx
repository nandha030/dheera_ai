...
export async function makeAnthropicMessagesRequest(
  ...
  if (tags && tags.length > 0) {
    headers["x-dheera_ai-tags"] = tags.join(",");
  }
  ...
  try {
        ...
        ? [
            {
              ...
              headers: {
                "x-dheera_ai-api-key": `Bearer ${accessToken}`,
              },
            },
          ]
        : undefined;
    ...
    const requestBody: any = {
      ...
      stream: true,
      max_tokens: 1024,
      // @ts-ignore - dheera_ai specific parameter
      dheera_ai_trace_id: traceId,
    };
    ...
    // @ts-ignore - The SDK types might not include all dheera_ai-specific parameters
