      ...
      <TabGroup>
        ...
        <TabPanels>
          ...
          <TabPanel>
            ...
            {promptData.dheera_ai_params && Object.keys(promptData.dheera_ai_params).length > 0 && (
              <Card className="mt-6">
                <Text className="font-medium">DheeraAI Parameters</Text>
                <div className="mt-2 p-3 bg-gray-50 rounded-md">
                  <pre className="text-xs text-gray-800 whitespace-pre-wrap">
                    {JSON.stringify(promptData.dheera_ai_params, null, 2)}
                  </pre>
                </div>
              </Card>
            )}
              ...
              <Card>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="font-mono text-sm bg-gray-50 p-2 rounded">{promptTemplate.dheera_ai_prompt_id}</div>
                  </div>
