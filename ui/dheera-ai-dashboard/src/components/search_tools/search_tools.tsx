        ...
        (toolId: string) => {
          ...
          if (tool) {
            form.setFieldsValue({
              ...
              search_provider: tool.dheera_ai_params.search_provider,
              api_key: tool.dheera_ai_params.api_key,
              api_base: tool.dheera_ai_params.api_base,
              timeout: tool.dheera_ai_params.timeout,
              max_retries: tool.dheera_ai_params.max_retries,
