...
const TeamMembersComponent: React.FC<TeamMembersComponentProps> = ({
  ...
  const getUserBudget = (userId: string | null): string | null => {
    ...
    const maxBudget = membership?.dheera_ai_budget_table?.max_budget;
  ...
  const getUserRateLimits = (userId: string | null): string => {
    ...
    const membership = teamData.team_memberships.find((tm) => tm.user_id === userId);
    const rpmLimit = membership?.dheera_ai_budget_table?.rpm_limit;
    const tpmLimit = membership?.dheera_ai_budget_table?.tpm_limit;
                        ...
                        <Icon
                          ...
                          onClick={() => {
                            ...
                            const enhancedMember = {
                              ...member,
                              max_budget_in_team: membership?.dheera_ai_budget_table?.max_budget || null,
                              tpm_limit: membership?.dheera_ai_budget_table?.tpm_limit || null,
                              rpm_limit: membership?.dheera_ai_budget_table?.rpm_limit || null,
                            };
