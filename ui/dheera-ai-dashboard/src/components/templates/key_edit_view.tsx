...
export function KeyEditView({
  ...
  const [disabledCallbacks, setDisabledCallbacks] = useState<string[]>(
    Array.isArray(keyData.metadata?.dheera_ai_disabled_callbacks)
      ? mapInternalToDisplayNames(keyData.metadata.dheera_ai_disabled_callbacks)
      : [],
  );
  ...
  const initialValues = {
    ...
    disabled_callbacks: Array.isArray(keyData.metadata?.dheera_ai_disabled_callbacks)
      ? mapInternalToDisplayNames(keyData.metadata.dheera_ai_disabled_callbacks)
      : [],
