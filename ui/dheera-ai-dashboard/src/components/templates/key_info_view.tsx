        ...
        try {
          ...
          formValues.metadata = {
            ...
            ...(formValues.disabled_callbacks?.length > 0
              ? {
                  dheera_ai_disabled_callbacks: mapDisplayToInternalNames(formValues.disabled_callbacks),
                }
              : {}),
          };
        } catch (error) {
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {userRole && rolesWithWriteAccess.includes(userRole) && (
          <div className="flex gap-2">
            <Tooltip
              title={!premiumUser ? "This is a DheeraAI Enterprise feature, and requires a valid key to use." : ""}
            >
          ...
          <TabPanel>
            <Grid numItems={1} numItemsSm={2} numItemsLg={3} className="gap-6">
              ...
              <LoggingSettingsView
                ...
                disabledCallbacks={
                  Array.isArray(currentKeyData.metadata?.dheera_ai_disabled_callbacks)
                    ? mapInternalToDisplayNames(currentKeyData.metadata.dheera_ai_disabled_callbacks)
                    : []
                }
                variant="card"
              />
