...
${formattedBody}
  ...
  return (
    <div className="w-full m-2" style={{ overflow: "hidden" }}>
      ...
      <p className="text-sm text-gray-500">See how DheeraAI transforms your request for the specified provider.</p>
      <div
        style={{
          display: "flex",
          gap: "16px",
      ...
      >
        ...
        >
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ color: "#666", margin: 0 }}>
              The request you would send to DheeraAI /chat/completions endpoint.
            </p>
          </div>
        ...
        >
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ color: "#666", margin: 0 }}>How DheeraAI transforms your request for the specified provider.</p>
            <br />
  ...
  "temperature": 0.7
      ...
      <div className="mt-4 text-right w-full">
        <p className="text-sm text-gray-500">
          ...
          <a href="https://github.com/BerriAI/dheera_ai/issues" target="_blank" rel="noopener noreferrer">
            here
          </a>
          .
        </p>
