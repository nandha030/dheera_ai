      ...
      <div style={{ width: "100%" }} className="p-8">
        <Card>
          ...
          <Button className="mt-4">
            <a href="https://docs.dheera_ai.ai/docs/proxy/spending_monitoring" target="_blank">
              View Usage Guide
            </a>
          </Button>
        </Card>
        ...
        <TabPanels>
          ...
          <TabPanel>
            <p className="mb-2 text-gray-500 italic text-[12px]">
              ...
              <a className="text-blue-500" href="https://docs.dheera_ai.ai/docs/proxy/users" target="_blank">
                docs here
              </a>
            </p>
            <Grid numItems={2}>
                ...
                <Card>
                  ...
                  <Text>
                    ...
                    <a
                      ...
                      href="https://docs.dheera_ai.ai/docs/proxy/cost_tracking"
                      target="_blank"
                    >
                      here
                    </a>
